...
Contract-Revision: **13** (supersedes revision 12; 2026-09-15)
...
`a0494fdaa856f9e0579c5c5c8907c1a89b7545d60786f4a9f9ffa29d719b2d89`.
...
3. No raw host `dd`, arbitrary fastboot, partition-table actions,
   ...
   The fixed S22+ V3 storage census may read its declared GPT metadata only;
   it grants no partition-table mutation or formatting.
