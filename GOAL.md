...
P3.25 is the proportional next axis: keep the exact P324 lane/selector/guard/receipt semantics and redirect only both read-time guard probes to the selected tty class node. Its host implementation is under qualification and creates no current prepare, approval, F1 or live authority.
