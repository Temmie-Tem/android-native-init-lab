...
P3.38 is independently reviewed H0 `PASS_GO_P338_H0` plus `PASS_GO_P338_D0_BASELINE_REPAIR_H0` and ready for one new connected preparation, not F1 authority. It preserves P3.37's authenticated three-session/fixed-command success path and adds only one best-effort stage-3/type-`0x86` first-OPEN branch ordinal: header-read errno, header validation, body-read errno or CRC rejection. The original failure is returned unchanged; no retry, wait, command, reconnect, lease action, shell or gate is added. Fresh run `c338f1e0a90b5e6d7c8a9b0c1d2e3f2b` has byte-identical boot-only A/B AP `28631081B/2f6dc740`, exact rollback `23367721B/d2373bf8`, final builder `61618B/c23dd514`, static `38958B/f1c63d23` and current ready manifest `ready_2` `10246B/35287aa6`. The first D0 attempt stopped 0/0 at baseline classification even though its raw read was the exact expected `2097136B/64ac7a5b`; review found that the contract/constants existed but the P338 dispatch branch was absent. Commit `21f338f418` adds only that exact predecessor branch and a one-byte-mutation rejection test, while `24553e0c80` repins the raw-first inventory; D1 was correctly not used. P3.37 remains closed, healthy, consumed and never replayable with exact transfers 1/1 and formal `NO_PROOF_F1_V2_CANDIDATE_ROLLED_BACK` / `p337_authenticated_resident_open_read_diagnostic_unproved_rollback_verified`. The next unit is a new D0 prepare against `ready_2`. See `docs/reports/S22PLUS_FYG8_P338_OPEN_READ_BRANCH_PROCESS_V2_H0_2026-09-05.md` and `docs/reports/S22PLUS_FYG8_P337_F1_OPEN_READ_DIAGNOSTIC_NO_PROOF_2026-09-04.md`.
