...
Dormant H0 idle/reuse qualification is implemented and independently reviewed: 9/9 focused tests, existing P341 6/6 and host-first 5/5 pass, plus an actual 120.032-second local PTY rehearsal with four authenticated sessions and 12 fixed commands. This is host evidence, not new device proof. The small helper preserves P341 host-first OPEN and the fixed command tuple; it schedules two sessions, 120 seconds of same-FD idle, a third same-FD session and one close/reopen fourth session (12 fixed commands total). No device/runtime/artifact/common-runner/contract activation or later-action lease is changed. Fresh successor identity, bound timing receipt, common four-session registration, promotion and ordinary D0/F1 preparation remain unimplemented; P341 cannot be reused. P3.41 is CLOSED/19, healthy, consumed and never replayable: `PASS_F1_V2_P341_AUTHENTICATED_RESIDENT_OPEN_HEADER_CAPTURE_AND_ROLLED_BACK`. Run `p341-ready1-prepared-20260905-1` completed candidate AP `28631081B/714c6c25` and exact Magisk rollback `23367721B/d2373bf8` once each (1/1), followed by rooted FYG8 final health. Receipt `28495B/01c6663e` and RX `1983B/da3438a4` prove three authenticated sessions, nine fixed commands with exit 0, two same-FD sessions and one planned host close/reopen, per-boot identity and complete diagnostic order. Host-first OPEN avoided the earlier banner-as-header failure in this run; historical echo causality and indefinite residency remain unproved. After durable close, an obsolete P328 final-validation fallback blocked result publication; independently reviewed host-only correction published result `30726B/6fb57a4c` from unchanged state `27152B/f7ced1b8`, with recovery_required=false and no additional device effects. The same narrow guard has a regression test. No later-action lease, arbitrary shell, autonomous reboot/Download or standing authority is activated. P340 remains CLOSED/healthy/consumed with NO_PROOF and transfers1/1. Canonical timeline and evidence: `docs/reports/S22PLUS_FYG8_P341_HOST_FIRST_OPEN_PREPARATION_2026-09-05.md`.
