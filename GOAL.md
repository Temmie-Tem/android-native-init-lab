...
P3.40 is CLOSED/healthy/consumed after exact candidate AP `28631081B/114523aa` and Magisk rollback `23367721B/d2373bf8` transferred once each (1/1). Run `p340-ready1-prepared-20260905-2` resumed only recovery after the operator confirmed physical Download; rooted FYG8 final health passed without code changes or repeated effects. Journal is CLOSED/19, state `19204B/826c8958`, result `22241B/ed2d5d1d`, recovery_required=false, and formal terminal is `NO_PROOF_F1_V2_CANDIDATE_ROLLED_BACK` / `p340_authenticated_resident_open_header_capture_unproved_rollback_verified`. The collector preserved all 193 bytes (`f461d251`): banner, stage 0/code 0, stage 3/code 1, and stages 4–7. The complete rejected header is `533232504c55532d465947382d45333a`, exactly the 16-byte banner prefix `S22PLUS-FYG8-E3:`, not the host's valid `S328` OPEN. Diagnostic capture succeeded; authenticated sessions are 0, and candidate success/causality remain false. Echo is a hypothesis requiring execution-order inspection, not an attributed mechanism. The matching F1 closure row is recorded with this close; P320–P322 history remains unchanged. P3.39 remains CLOSED/healthy/consumed. P339 and P340 are never replayable; no standing device authority remains. See `docs/reports/S22PLUS_FYG8_P339_INITIAL_CAPTURE_INCIDENT_2026-09-05.md` for qualification, preparation, canonical timeline and retained evidence.
