...
P3.25 is the current H0-ready proportional successor: it keeps the exact P324 lane/selector/guard/receipt semantics, redirects only both read-time guard probes to the selected tty class node, prevents the P324 32 KiB post-close duplication, and has independent verdict `PASS_GO_P325_PROCESS_V2_H0`. Fresh boot-only AP 27279401B/486fd1f2 and ready_2 3327B/e98c3a14 are bound; no P3.25 connected prepare, approval, F1 or live authority exists, so a fresh D0 prepare is next.
