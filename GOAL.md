...
P3.37 is the active independently reviewed H0 successor to closed, healthy and consumed P3.36. It keeps the proved P3.35 wire, three fixed commands, 300-second observation, boot-only transfer and exact Magisk rollback, and adds only one best-effort type-0x86 stage-3 diagnostic when the first framed OPEN read fails; it adds no retry, wait, command, lease or general shell. Final host artifacts use fresh run ID `c337...3f3b`: candidate AP `28631081B/0c1f6f23`, builder result `58673B/8a034575`, static receipt `36651B/341e25d2`, and ready declaration `9464B/f5f80324` `ready-6`; P337 focused tests 15/15, common Process-v2 tests 131/131 and P336 regressions 20/20 pass. Independent verdicts are `PASS_GO_P337_PROCESS_V2_H0`, `PASS_GO_P337_D1_FRESH_BASELINE_H0_CAPABILITY_V1` and `PASS_GO_P337_D0_FRESH_BASELINE_H0_CAPABILITY_V1`; neither they nor the ready declaration grants F1 authority. P3.36 remains formal `NO_PROOF_F1_V2_CANDIDATE_ROLLED_BACK` with exact candidate/rollback transfers 1/1, healthy rooted return and no replay; raw `73B/19955936` proves only its native-PID1 banner plus stage-0/code-0 console-entry diagnostic. See `docs/reports/S22PLUS_FYG8_P336_F1_LONG_IDLE_NO_PROOF_2026-09-04.md`.
