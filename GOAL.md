...
P3.42 idle/reuse integration is H0 reviewed and ready for fresh attended approval: four authenticated sessions, twelve fixed commands, 120 seconds silent same-FD idle, then one planned reopen. One preapproved D1 reboot returned healthy; fresh ordinary D0 preparation uses `p342-ready1-prepared-20260905-2` after clean baseline. Prepared-1 was superseded before code issuance by a reviewed P342-only state-writer bound correction; neither run transferred a candidate. P342 device idle stability is not yet proved. P341 remains CLOSED, healthy, consumed, with three authenticated sessions/nine commands and candidate/rollback 1/1. No arbitrary shell, later-action lease, indefinite residency or autonomous mode control is activated. Current preparation, artifacts, H0 fixes and evidence: `docs/reports/S22PLUS_FYG8_P342_IDLE_REUSE_PREPARATION_2026-09-05.md`; P341 canonical close remains in `docs/reports/S22PLUS_FYG8_P341_HOST_FIRST_OPEN_PREPARATION_2026-09-05.md`.
