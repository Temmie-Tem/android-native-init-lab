...
P3.44 is ready for returned attended F1 approval: independent PASS_GO_P344_H0,32focusedtests plus actual builder/canonical prepare audit passed. Identity-only device successor retains five named read queries, host-first authentication, four-session/120s idle proof and one-hour/sixteen-action attended lease. Repaired host maps term_signal to unchanged JSON signal_number; actual arm and command-result publication/lease/summary and failure-cut tests pass. Buildresult105068B/d299eeb1, A/B AP28631081B/c0ff878f, ready14335B/53f75758. D0 directory1 stopped on retained baseline (3252B/ae669e24); conditionally approved normal-reboot D1 completed once with healthy changed-boot return (2963B/8d3664f4). Fresh p344-ready1-prepared-20260905-2 passed clean baseline2097136B/4c1313d3 and exact rooted health; prepared36826B/86ed8fc2, D0result3261B/5e598f0b, approval digest7bc260e6. No P344 F1 transaction or transfer exists yet. P343 remains CLOSED/19 and consumed, candidate/rollback1/1, healthy rooted FYG8, result37182B/edb77ee6, recovery_required=false, formal NO_PROOF unchanged despite initialUSBproof. No candidate/action replay. Current report: `docs/reports/S22PLUS_FYG8_P344_NAMED_EXPLORATION_PREPARATION_2026-09-05.md`; predecessor history: `docs/reports/S22PLUS_FYG8_P343_NAMED_EXPLORATION_PREPARATION_2026-09-05.md`.
