...
P3.44 completed PASS_F1_V2_P344_NAMED_EXPLORATION_AND_ROLLED_BACK, CLOSED/19 with candidate/rollback1/1, result38199B/aba403cc, state34217B/d9029e02 and recovery_required=false. Initial four-session/twelve-command USB authentication and120s idle reuse passed (observer35538B/b14b751a). Five later named read actions kernel/processes/mounts/memory/usb-state all passed actual execution, result publication, lease accounting and final summary (5completed/provedtrue, no failed/pending action). This proves the bounded named read-only exploration workflow, not arbitrary shell, indefinite residency, persistent installation, reboot/Download command or autonomous recovery. Exact Magisk rollback and rooted FYG8 final health passed; current device is returned Android, not an active candidate session. P344 candidate and all actions are consumed and never replayable. P343 remains CLOSED healthy NO_PROOF and is not relabeled. Next research can build on the verified five-query exploration foundation using a fresh authorized candidate/session; no standing live authority. Current result/timeline: `docs/reports/S22PLUS_FYG8_P344_NAMED_EXPLORATION_PREPARATION_2026-09-05.md`; predecessor: `docs/reports/S22PLUS_FYG8_P343_NAMED_EXPLORATION_PREPARATION_2026-09-05.md`. P345 is now consumed: exact candidate28631081B/7ee59a13 and Magisk rollback23367721B/d2373bf8 completed1/1, journal CLOSED/19 and final rooted FYG8 health verified with original boot/supporting hashes. Five-session readonly-shell qualification did not pass: first canary stopped exec-read, accepted sessions0/5. Raw670B/a8d28dc6 preserves partial UID65534/read/probe-denial/canary/EXIT evidence, not complete qualification. Observer9840B/f8ee7fcf is retained. Host generic projection raised KeyError after receipt preservation; journal-only recovery then reached healthy close but final result reopening failed. State13005B/d09dd61e is durable. Independently reviewed terminal-only metadata normalization published result15689B/039bcb3f, CLOSED, NO_PROOF_F1_V2_CANDIDATE_ROLLED_BACK, outcome p345_readonly_research_shell_unproved_rollback_verified, recovery_required=false; journal/state/raw/prepared bytes unchanged. H0 numeric-ID witness and projection repair now has independent scoped PASS: shared parent numeric validation, separate child UID/GID queries, JSON-stable metadata and P328 projection exclusion. Host P345 tests43/46 pass; three historical build reopenings correctly reject changed source identity. Fresh successor identity/source/artifact qualification and matching audit/ready bindings remain pending; no candidate/action replay or standing shell authority. Report: `docs/reports/S22PLUS_FYG8_P345_SHELL_QUALIFICATION_NO_PROOF_2026-09-06.md`.
