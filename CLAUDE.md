...
- **Active research cycle**: v830 pending after V829 service-locator success; bounded no-HAL service-notifier `REGISTER_LISTENER` proof for `msm/modem/wlan_pd` instance `180`
