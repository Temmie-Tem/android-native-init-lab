...
- current source tree: modular native init under `stage3/linux_init/`, rooted at `init_v724.c`, with current scripts under `workspace/public/src/scripts/revalidation/`
...
- boot image와 native-init 빌드 산출물은 `workspace/private/inputs/boot_images/`와 `workspace/private/builds/native-init/`에 보존하고, `stage3/`에는 소스와 호환 symlink만 남긴다.
