...
- recovery: TWRP 사용 가능
- current device build (flashed): `A90 Linux init 0.9.255 (v2182-hud-menu-cleanup)`
...
- previous verified boot image: `workspace/private/inputs/boot_images/boot_linux_v2178_wifi_profile_autoconnect.img`
- known-good fallback: `workspace/private/inputs/boot_images/boot_linux_v48.img`
- active research: native Wi-Fi/network detail hardening on top of the V2182 HUD/menu baseline
...
- verified baseline: `A90 Linux init 0.9.255 (v2182-hud-menu-cleanup)`,
  `workspace/private/inputs/boot_images/boot_linux_v2182_hud_menu_cleanup.img`
- next UI/network work should build on V2182 and keep V2178 as the immediate
  rollback image until a newer verified baseline supersedes it.
