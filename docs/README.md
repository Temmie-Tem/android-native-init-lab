...
- `reports/NATIVE_INIT_V653_SERVICE74_GATED_SERVICE_MANAGER_PREP_2026-05-23.md` – V653 prep 결과 helper v105가 service `74` gate 후 service-manager를 시작하는 새 모드를 빌드했고, 현재 live deploy preflight는 NCM prerequisite에서 mutation 없이 중단됨
