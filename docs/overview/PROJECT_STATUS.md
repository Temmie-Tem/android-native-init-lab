...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1275` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1276** — host-only PMIC GPIO9 polarity/value classifier
   (V1275에서 PMIC GPIO9가 debugfs상 `out ... high ...`로 보였는데도 GPIO142/PCI/MHI가
   0인 이유를 Android/DTS/기존 evidence와 비교 분류)
