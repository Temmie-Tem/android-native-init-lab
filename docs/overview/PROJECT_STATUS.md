...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1325 plan ready → V1326 source/build timing sampler support` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1326** — helper v276 source/build timing sampler support
   (V1325 계획 기준: compact `mdm2ap_timing` sampler로 GPIO142/MDM errfatal/PCIe/MHI/ks/WLFW/`wlan0` timing을 요약)
