...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1299 PASS → V1300 host-only late per_proxy delivery classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1300** — host-only V1295/V1299 late `per_proxy` delivery comparison
   (compact sampler는 full window를 확보했지만 V1299는 `/dev/subsys_esoc0` attempt 미재현)
