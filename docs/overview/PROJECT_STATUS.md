...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1324 plan ready → V1324 Android-vs-native provider response delta classifier implementation` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1324** — Android-vs-native provider response delta classifier
   (계획 문서: `docs/plans/NATIVE_INIT_V1324_PROVIDER_RESPONSE_DELTA_PLAN_2026-05-31.md`; V1323에서 wait cause는 public `wait_for_err_ready()`가 아니라 proprietary ext-mdm provider power-up response path로 분류됨)
