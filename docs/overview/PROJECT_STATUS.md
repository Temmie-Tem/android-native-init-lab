...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1280 HOST-ONLY PASS → V1281 PCIe/GDSC sampler support` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1281** — source/build-only PCIe/GDSC/dmesg response sampler support
   (V1280에서 line-level GPIO 값을 다음 hard gate에서 제외하고 PCIe/GDSC/RC1 response
   sampler를 다음 최단 경로로 선정)
