...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1313 PASS → V1314 classify exact safe dynamic GDSC/eSoC prerequisite` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1314** — classify exact safe dynamic GDSC/eSoC prerequisite
   (V1313에서 full summary window PASS: `81` samples, no stdout truncation, `mdm_subsys_powerup` seen, PCIe GDSC/MHI/`ks`/`wlan0` no-transition)
