...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1324 PASS → V1325 GPIO142/errfatal/PCIe timing observer design` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1325** — GPIO142/MDM errfatal/PCIe timing observer design
   (V1324에서 native는 GPIO1270/GPIO135/GPIO141 AP-side activity까지 도달하지만 GPIO142/PCIe RC1/MHI/WLFW/`wlan0`가 absent인 post-AP2MDM response gap으로 분류됨)
