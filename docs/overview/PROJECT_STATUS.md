...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1274` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1275** — bounded AP2MDM block sampler live gate
   (helper v266으로 late PM-service response window에서 새 `*_block_*` fields를
   read-only로 수집)
