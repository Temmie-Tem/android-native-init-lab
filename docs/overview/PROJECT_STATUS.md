...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1296 PASS → V1297 compact dense sampler build` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1297** — source/build-only compact dense sampler
   (V1296 기준 V1295 `14/40`은 runtime stop이 아니라 helper stdout `1 MiB` cap)
