...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1297 BUILD PASS → V1298 deploy helper v272` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1298** — deploy-only helper `a90_android_execns_probe v272`
   (compact dense sampler; no live PM/CNSS/HAL expansion)
2. **V1299** — bounded compact dense response sampler live
   (V1296 stdout cap 회피 후 full 40-sample window 확인)
