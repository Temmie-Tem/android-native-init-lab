...
> Latest post-promotion validated candidate: `A90 Linux init 0.10.10 (v2838-audio-chime-preset)`,
...
> `v2321` selftest `fail=0`. Boot autoplay remains disabled.
...
7. **오디오/ADSP 에픽 (V2324-V2815, CORE CLOSED; V2839 CHIME LIVE PASS):** 내부 스피커 재생 경로를 닫음.
   ...
   스피커별 route map, 상태 UI, 부트차임 같은 post-promotion productization이며, V2838/V2839는 첫 수동 `audio chime` preset을 build/live 검증했다.
