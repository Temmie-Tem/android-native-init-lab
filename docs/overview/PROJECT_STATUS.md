...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1295 LIVE PASS → V1296 dense-window early-exit classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1296** — host-only dense-window early-exit classifier
   (V1295 dense metadata는 active였지만 parsed sample이 `14/40`에서 멈춘 이유 분류)
