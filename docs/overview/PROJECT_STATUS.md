...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1310 PASS → V1311 stdout-reduced full-window lower-sequence sampler` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1311** — stdout-reduced full-window lower-sequence sampler
   (V1310에서 static PMIC GPIO9/TLMM shape는 닫고 active blocker를 dynamic PCIe/GDSC/eSoC lower power sequencing after `mdm_subsys_powerup`으로 분류)
