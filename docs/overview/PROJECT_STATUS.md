...
1. **V1263** — kernel-owned `AP2MDM_SOFT_RESET` / ext-mdm contract classifier
   (V1262 proves PMIC GPIO9 offset `7` is `GPIOLINE_FLAG_KERNEL` with consumer
   `AP2MDM_SOFT_RESET`; do not userspace-request/hold that line next)
