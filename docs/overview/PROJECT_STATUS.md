...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1293 BUILD PASS → V1294 helper v271 deploy-only` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1294** — helper `v271` deploy-only
   (`--pm-observer-late-per-proxy-dense-response-sampler`, sha256 `335b875516e76419933f2e0ab6e21cd7ee4d1d217b32f378f1925adc30010a24`)
2. **V1295** — bounded dense no-write response sampler live
   (`50 ms` cadence, `40` samples; no PMIC/GPIO/eSoC mutation and no Wi-Fi bring-up)
