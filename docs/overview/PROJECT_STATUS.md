...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1279 LIVE PASS → V1280 host-only classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1280** — host-only response-gap classifier
   (V1279에서 TLMM range `0-174`와 GPIO135/GPIO142 pinmux ownership은 확인됐지만
   exact line value, GPIO142 IRQ, PCIe RC1, MHI, `wlan0`는 여전히 absent)
