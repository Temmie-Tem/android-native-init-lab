...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1292 HOST PASS → V1293 dense dynamic response sampler build` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1293** — dense dynamic response sampler build
   (V1292 selected 50ms dense sampling because Android PCIe RC1 appears within the first sub-second window)
