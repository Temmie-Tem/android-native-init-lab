...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1276` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1277** — source/build-only helper v267 TLMM range-slice sampler
   (PMIC GPIO9은 Android와 같은 `out/high`로 분류됐으므로, GPIO135/GPIO142와 PCIe
   response를 read-only로 더 좁게 관찰)
