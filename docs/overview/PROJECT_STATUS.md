...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1303 PASS → V1304 AP2MDM/MDM2AP response classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1304** — AP2MDM/MDM2AP response boundary classifier
   (V1303에서 `/dev/subsys_esoc0`/`mdm_subsys_powerup` 도달은 marker로 증명됨)
