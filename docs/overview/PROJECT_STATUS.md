...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1278 DEPLOY PASS → V1279 bounded live` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1279** — bounded live TLMM range sampler
   (V1278에서 helper v267 배포 및 remote SHA 확인 완료)
