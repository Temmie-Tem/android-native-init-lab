...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1307 PASS → V1308 deploy helper v274 only` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1308** — deploy helper `v274` only
   (V1307에서 focused PMIC/GDSC transition sampler support build PASS, sha256 `eb96072631ca38c3296f5da1756a93765e198e8fdd4dc010d087bc4b3b5fc180`)
