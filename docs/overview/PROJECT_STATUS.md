...
> Latest post-promotion source-built candidate: `A90 Linux init 0.10.11 (v2840-audio-chime-screen)`,
> boot image `workspace/private/inputs/boot_images/boot_linux_v2840_audio_chime_screen.img`,
> SHA256 `57a61bf47f5da326d7faf6a9fcf1284accf6f9628b4a8bb25679a670c31dbb58`.
...
> `CHIME` surface for that preset; live screen validation is the next bounded checkpoint. Boot autoplay remains disabled.
...
7. **오디오/ADSP 에픽 (V2324-V2815, CORE CLOSED; V2839 CHIME LIVE PASS):** 내부 스피커 재생 경로를 닫음.
   ...
   스피커별 route map, 상태 UI, 부트차임 같은 post-promotion productization이며, V2838/V2839는 첫 수동 `audio chime` preset을 build/live 검증했고, V2840은 해당 preset의 display-only screen/menu surface를 source-build했다.
