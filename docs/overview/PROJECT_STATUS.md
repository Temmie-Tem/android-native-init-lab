...
> Latest post-promotion validated candidate: `A90 Linux init 0.10.12 (v2843-audio-bundled-setcal)`,
> boot image `workspace/private/inputs/boot_images/boot_linux_v2843_audio_bundled_setcal.img`,
> SHA256 `59aeac21f8ce4fb125962d34ea037d80171c8e22791ea3d584b548ea3924c646`.
...
> route apply/reset, PCM write/drain, and rollback to `v2321` selftest `fail=0`. Boot autoplay remains disabled.
