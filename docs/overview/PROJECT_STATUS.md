...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1321 PASS → V1322 SDX50M response-input classifier` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1322** — SDX50M response-input classifier
   (V1321에서 image-link gate는 V1236-V1239로 이미 covered, blocker는 post-`mdm_subsys_powerup` response로 재정의)
