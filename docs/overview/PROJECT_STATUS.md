...
- 공식 숫자 버전: `0.9.68`
- 박힌 빌드 태그: `v724`
- 현재 진행 사이클: `V1306 PASS → V1307 focused no-write PMIC/GDSC transition sampler support` (native Wi-Fi bring-up; 디바이스 재flash 없음 — `CLAUDE.md` 기준)
...
1. **V1307** — focused no-write PMIC/GDSC transition sampler support
   (V1306에서 native lower window가 PM8150L soft-reset `MUX UNCLAIMED`와 PCIe GDSC `0mV`에 머무는 것을 Android-positive PMIC/PCIe와 대조함)
