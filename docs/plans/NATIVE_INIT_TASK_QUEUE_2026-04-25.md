...
- next execution item: V425 boot-complete/settle-gated Android read-only inventory and comparator. Wait for Android `sys.boot_completed=1`, rerun V423, then compare boot-complete Android target state with native private-runtime V422/V407 behavior before any Wi-Fi bring-up.
