...
- next execution item: V426 read-only Android boot-complete service-surface mapper and native-gap extractor. Map Android service-manager/hwservice/supplicant/framework Wi-Fi state, then decide which minimal native private-runtime surface is missing before any Wi-Fi bring-up.
