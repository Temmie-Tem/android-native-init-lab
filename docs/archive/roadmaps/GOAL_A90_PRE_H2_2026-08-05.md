# Archived A90 Goal Snapshot before H2

Archived on 2026-08-05. Historical state only; grants no device authority.
...
`AGENTS.md` is the binding operating contract. At archival time, this was the
active A90 objective. `GOAL.md` is the separate S22+ objective. Target evidence,
