# INERT HISTORICAL ROADMAP - snapshot through P2.84 PM-order correction

This file is an archived snapshot. It is evidence only, is not the active
goal, and grants no device authority. The active objective is `GOAL.md`.
