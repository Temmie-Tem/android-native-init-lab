...
- Cycle: `V2167`
- Run label: `qa-hold-v24-5g`
- Decision: `v2167-connect-dhcp-ping-hold-failed`
- Label: `connect-dhcp-ping-hold-failed`
- Pass: `False`
- Reason: native wlan0 associated, DHCP and google.com ping succeeded, but hold failed: ping-timeout
- Evidence: `tmp/wifi/v2167-connect-dhcp-google-ping-handoff-qa-hold-v24-5g`
- QA hold config: sec `180` interval `30` reconnect_on_drop `True`
...
- `host_standalone_wpa_bundle` elapsed `3.024` ok `True` detail ``
- `property_stage` elapsed `2.339` ok `True` detail ``
- `host_helper_build` elapsed `7.816` ok `True` detail ``
- `helper_stage` elapsed `2.287` ok `True` detail ``
- `strace_stage` elapsed `1.09` ok `True` detail ``
- `standalone_wpa_stage` elapsed `3.002` ok `True` detail ``
- `fast_transfer_close` elapsed `0.0` ok `True` detail ``
- `prestage_total` elapsed `16.535` ok `True` detail ``
- `connect_config_stage` elapsed `2.725` ok `True` detail ``
- `connect_window` elapsed `273.127` ok `True` detail ``
- `handoff_flash_test_rollback_total` elapsed `402.038` ok `True` detail ``
- `post_rollback_artifact_upload` elapsed `25.508` ok `True` detail ``

## Step Phase Summary

- `preflight_device` elapsed `1.556` steps `3` slow `set-sibling-fwssctl-flag:0.648s, pre-status:0.467s, pre-selftest:0.441s`
- `helper_stage` elapsed `11.683` steps `10` slow `host-build-execns-helper:7.722s, property-runtime-stage-extract:0.668s, execns-helper-fast-wget:0.558s`
- `connect_config_stage` elapsed `2.177` steps `5` slow `connect-config-decode-redacted:0.548s, connect-config-clean:0.545s, connect-config-mkdir:0.544s`
- `flash_total` elapsed `54.68` steps `1` slow `test-flash-from-native:54.68s`
- `connect_window` elapsed `272.118` steps `35` slow `connect-result-wait-polls:209.226s, connect-script-touch:45.205s, connect-script-line-19:0.559s`
- `artifact_upload` elapsed `2.203` steps `17` slow `test-fast-evidence-device-stream:0.741s, test-fast-evidence-collector-fast-wget:0.551s, post-rollback-connect-ping-result:0.475s`
- `rollback_flash_total` elapsed `63.799` steps `1` slow `rollback-from-native:63.799s`
- `rollback_status` elapsed `0.219` steps `1` slow `rollback-status:0.219s`
- `selftest` elapsed `0.635` steps `2` slow `test-selftest:0.441s, rollback-selftest:0.194s`
- `other` elapsed `28.065` steps `29` slow `fast-transfer-device-host-probe:10.323s, fast-transfer-device-host-probe-after-nm-repair:10.294s, test-status:1.046s`

## Native Flash Subphases

- `test-flash-from-native.inspect_local_image` elapsed `0.06` ok `True`
- `test-flash-from-native.native_to_recovery` elapsed `0.303` ok `True`
- `test-flash-from-native.wait_recovery_adb` elapsed `18.087` ok `True`
- `test-flash-from-native.adb_push` elapsed `0.849` ok `True`
- `test-flash-from-native.remote_sha256` elapsed `0.099` ok `True`
- `test-flash-from-native.boot_dd_write` elapsed `0.437` ok `True`
- `test-flash-from-native.boot_readback_sha256` elapsed `0.349` ok `True`
- `test-flash-from-native.flash_boot_image` elapsed `1.735` ok `True`
- `test-flash-from-native.reboot_twrp_to_system` elapsed `2.519` ok `True`
- `test-flash-from-native.verify_native_init` elapsed `31.929` ok `True`
- `test-flash-from-native.total` elapsed `54.633` ok `True`
- `rollback-from-native.inspect_local_image` elapsed `0.055` ok `True`
- `rollback-from-native.native_to_recovery` elapsed `0.321` ok `True`
- `rollback-from-native.wait_recovery_adb` elapsed `27.129` ok `True`
- `rollback-from-native.adb_push` elapsed `0.824` ok `True`
- `rollback-from-native.remote_sha256` elapsed `0.097` ok `True`
- `rollback-from-native.boot_dd_write` elapsed `0.437` ok `True`
- `rollback-from-native.boot_readback_sha256` elapsed `0.341` ok `True`
- `rollback-from-native.flash_boot_image` elapsed `1.699` ok `True`
- `rollback-from-native.reboot_twrp_to_system` elapsed `2.112` ok `True`
- `rollback-from-native.verify_native_init` elapsed `32.436` ok `True`
- `rollback-from-native.total` elapsed `63.752` ok `True`

## Slowest Steps

- `connect-result-wait-polls` elapsed `209.226` ok `True` timeout `False`
- `rollback-from-native` elapsed `63.799` ok `True` timeout `False`
- `test-flash-from-native` elapsed `54.68` ok `True` timeout `False`
- `connect-script-touch` elapsed `45.205` ok `False` timeout `False`
- `fast-transfer-device-host-probe` elapsed `10.323` ok `False` timeout `False`
- `fast-transfer-device-host-probe-after-nm-repair` elapsed `10.294` ok `False` timeout `False`
- `host-build-execns-helper` elapsed `7.722` ok `True` timeout `False`
- `test-status` elapsed `1.046` ok `True` timeout `False`
- `standalone-wpa-stage-extract-verify` elapsed `0.852` ok `True` timeout `False`
- `test-fast-evidence-device-stream` elapsed `0.741` ok `True` timeout `False`
- `property-runtime-stage-extract` elapsed `0.668` ok `True` timeout `False`
- `standalone-wpa-fast-wget` elapsed `0.662` ok `True` timeout `False`
...
- `wpa_ctrl`: ready `True` surface `interface` global_path `/tmp/a90-v231-715/root/dev/socket/wpa_wlan0` abstract `False` preclean `none` preclean_errno `0` ping `pong` interface_add_rc `0` interface_add `` after_add_ready `False` after_add_surface `` after_add_global `` after_add_ping `` country_rc `0` reply `unknown` enable `ok` reassociate `ok`
...
- `supplicant_proc_start_runtime`: uid `0?0?0?0` gid `0?0?0?0` groups `` wchan `do_wait` syscall `260 0xffffffffffffffff 0x7fe9d8c124 0x40000000 0x0 0x0 0x0 0x7fe9d8c0d0 0x4e5688` stack `[<0000000000000000>] __switch_to+0x10c/0x120` fd_count `4` socket_fds `0` netlink_fds `0` generic_netlink_fds `0` netlink_miss `0` wpa_socket_fds `0` stdio_fds `1`
- `supplicant_proc_after_wait`: comm `a90_strace_v216` exe `a90_strace_v2167` has_wpa `True` has_helper `False` has_config `True`
- `supplicant_proc_after_wait_runtime`: uid `0?0?0?0` gid `0?0?0?0` groups `` wchan `do_wait` syscall `260 0xffffffffffffffff 0x7fe9d8c124 0x40000000 0x0 0x0 0x0 0x7fe9d8c0d0 0x4e5688` stack `[<0000000000000000>] __switch_to+0x10c/0x120` fd_count `4` socket_fds `0` netlink_fds `0` generic_netlink_fds `0` netlink_miss `0` wpa_socket_fds `0` stdio_fds `1`
...
- `supplicant_stdio`: present `True` size `72474` lines `890` ctrl `8` ctrl_err `0` config_err `1` nl80211 `295` scan `40` auth `17` assoc `22` connected `4` disconnected `3` fail `2` usage `0` interface `16` socket `9` terminate `0` permission `0` avc `0` samples `24` tail_samples `24` nonproperty_samples `24` sensitive_skipped `95`
...
- `kmsg_stream`: started `True` start_errno `0` present `True` size `120995` lines `1579` permission `0` avc `0` nl80211 `0` auth `3` assoc `6` fail `499` sensitive_skipped `18` cleanup_exit `-1` signal `15` timeout `False`
...
- `hold`: enabled `True` executed `True` requested_sec `180` interval_sec `30` pass `False` reason `ping-timeout` samples `5` carrier_up `5` carrier_down `0` ping_success `1` ping_fail `4` reconnect_on_drop `True` reconnect_attempts `0` reconnect_success `0` first_fail_sample `1` first_fail_errno `0` first_fail_ping_rc `-1`
...
- `tail_00`: `1518764208.618806: nl80211: Associated on 5745 MHz`
- `tail_01`: `1518764208.621229: nl80211: Operating frequency for the associated BSS from scan results: 5745 MHz`
- `tail_02`: `1518764208.624806: nl80211: Associated on 5745 MHz`
- `tail_03`: `1518764208.630763: nl80211: Set wlan0 operstate 0->0 (DORMANT)`
- `tail_04`: `1518764208.638238: WPA: Update cipher suite selection based on IEs in driver-generated WPA/RSNE in AssocReq - hexdump(len=91): 30 16 01 00 00 0f ac 04 01 00 00 0f ac 04 01 00 00 0f ac 02 0c 00 00 00 3b 16 80 51 53 54 73 74 75 76 77 78 79 7a 7b 7c 7d 7e 7f`
- `tail_05`: `1518764208.645864: EAPOL: SUPP_PAE entering state CONNECTING`
- `tail_06`: `1518764208.649088: wlan0: CTRL-EVENT-SUBNET-STATUS-UPDATE status=0`
- `tail_07`: `1518764208.677898: wlan0: WPA: Installing PTK to the driver`
- `tail_08`: `1518764208.679085: nl80211: NEW_KEY`
- `tail_09`: `1518764208.679267: nl80211: KEY_DATA - hexdump(len=16): [REMOVED]`
- `tail_10`: `1518764208.679521: nl80211: KEY_SEQ - hexdump(len=6): 00 00 00 00 00 00`
- `tail_11`: `1518764208.690848: wlan0: WPA: Installing GTK to the driver (keyidx=1 tx=0 len=16)`
- `tail_12`: `1518764208.692196: nl80211: NEW_KEY`
- `tail_13`: `1518764208.692373: nl80211: KEY_DATA - hexdump(len=16): [REMOVED]`
- `tail_14`: `1518764208.692548: nl80211: KEY_SEQ - hexdump(len=6): 4c fc 08 00 00 00`
- `tail_15`: `1518764208.696255: wlan0: Radio work 'connect'@0x557dfbf610 done in 0.198251 seconds`
- `tail_16`: `1518764208.696703: wlan0: radio_work_free('connect'@0x557dfbf610): num_active_works --> 0`
- `tail_17`: `1518764208.698361: nl80211: Set wlan0 operstate 0->1 (UP)`
- `tail_18`: `1518764208.709971: nl80211: Set rekey offload`
- `tail_19`: `1518764208.713100: nl80211: Event message available`
- `tail_20`: `1518764208.717121: nl80211: Drv Event 103 (NL80211_CMD_VENDOR) received for wlan0`
- `tail_21`: `1518764208.717310: nl80211: Vendor event: wiphy=0 vendor_id=0x1374 subcmd=165`
- `tail_22`: `1518764208.717487: nl80211: Vendor data - hexdump(len=48): 30 00 01 00 2c 00 00 00 08 00 01 00 00 00 00 00 08 00 02 00 02 00 00 00 18 00 03 00 14 00 00 00 08 00 01 00 09 00 00 00 08 00 02 00 71 16 00 00`
- `tail_23`: `1518764208.720351: nl80211: Ignore unsupported QCA vendor event 165`
...
- `logdw_sample_00`: `Z _ cnss-daemon nl80211 response handler invoked`
- `logdw_sample_01`: `Z S` cnss-daemon nl80211_response_handler: cmd 103, vendorID 4980, subcmd 106  received`
- `logdw_sample_02`: `Z2 CNSS failed to open file a+ mode or file size 0 is less than max_file_size 31457280`
- `logdw_sample_03`: `Z CNSS Failed to open file /data/vendor/log/wifi/host_driver_logs_current.txt: 2`
- `logdw_sample_04`: `Z=R cnss-daemon nl80211 response handler invoked`
...
- `logdw_sample_11`: `ZXg CNSS Failed to open file /data/vendor/log/wifi/host_driver_logs_current.txt: 2`
- `kmsg_sample_00`: `4,4200,90360691,-; scheduler_thread+0x1b4/0x5a8`
- `kmsg_sample_01`: `4,4201,90360704,-; kthread+0x120/0x138`
- `kmsg_sample_02`: `4,4268,90361581,-; scheduler_thread+0x1b4/0x5a8`
- `kmsg_sample_03`: `4,4269,90361592,-; kthread+0x120/0x138`
- `kmsg_sample_04`: `4,4280,90361758,-;WARNING: CPU: 3 PID: 656 at drivers/net/wireless/qualcomm/wcn39xx/qcacld-3.0/components/ipa/core/src/wlan_ipa_core.c:1493 wlan_ipa_cleanup_iface+0x2e8/0x4a8`
- `kmsg_sample_05`: `4,4336,90362464,-; scheduler_thread+0x1b4/0x5a8`
- `kmsg_sample_06`: `4,4337,90362475,-; kthread+0x120/0x138`
- `kmsg_sample_07`: `3,4340,90362518,-;[schedu][0x7c523a7e][06:56:48.610208] wlan: [656:E:IPA] __wlan_ipa_wlan_evt: 2236: wlan_ipa_setup_iface failed 4294967282`
- `kmsg_sample_08`: `6,4363,90451123,-;IPv6: ADDRCONF(NETDEV_CHANGE): wlan0: link becomes ready`
- `kmsg_sample_09`: `6,4368,91527976,-;max77705_fg_periodic_read: skip old(1) current(91)`
- `kmsg_sample_10`: `6,4369,91529371,-;max77705_fg_read_qh : QH(4777000)`
- `kmsg_sample_11`: `7,4371,91529632,-;max77705_fg_read_current: current=7mA`
- `kmsg_sample_12`: `7,4372,91530106,-;max77705_fg_read_avg_current: avg_current=0mA`
- `kmsg_sample_13`: `6,4373,91530352,-;max77705_fg_read_isys_avg: isys_avg_current=619mA`
- `kmsg_sample_14`: `6,4374,91530598,-;max77705_fg_read_isys: isys_current=956mA`
- `kmsg_sample_15`: `6,4376,91545631,-;max77705_fg_read_vcell: VCELL(4327)mV, data(0xd85e)`
- `kmsg_sample_16`: `7,4377,91546102,-;max77705_fg_read_avg_current: avg_current=0mA`
- `kmsg_sample_17`: `6,4394,91550908,-;sec_bat_get_property: input current(1500mA), cable type(5), slow-charging mode(1)`
- `kmsg_sample_18`: `6,4395,91550926,-;sec_bat_get_property cable type = 5 sleep_mode = 0`
- `kmsg_sample_19`: `7,4396,91551176,-;max77705_fg_read_current: current=7mA`
- `kmsg_sample_20`: `7,4397,91551640,-;max77705_fg_read_avg_current: avg_current=0mA`
- `kmsg_sample_21`: `14,4428,97097069,-;rmt_storage:INFO:rmt_storage_client_thread: Calling Write [offset=0, size=2097152, req_h 0x9, wr_count 1] for /boot/modem_fs1!`
- `kmsg_sample_22`: `14,4429,97132835,-;rmt_storage:INFO:rmt_storage_client_thread: Done Write (bytes = 2097152, req_h 0x9, wr_count 1) for /boot/modem_fs1!`
- `kmsg_sample_23`: `6,4474,121551897,-;max77705_fg_periodic_read: skip old(1) current(121)`
- `kmsg_tail_00`: `6,5559,274124007,-;failed to send QMI message -104`
- `kmsg_tail_01`: `3,5560,274124020,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa_1 ret:-104`
- `kmsg_tail_02`: `6,5561,274225668,-;failed to send QMI message -104`
- `kmsg_tail_03`: `3,5562,274225681,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa ret:-104`
- `kmsg_tail_04`: `6,5563,274323124,-;failed to send QMI message -104`
- `kmsg_tail_05`: `3,5564,274323137,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa_1 ret:-104`
- `kmsg_tail_06`: `6,5565,274425590,-;failed to send QMI message -104`
- `kmsg_tail_07`: `3,5566,274425603,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa ret:-104`
- `kmsg_tail_08`: `6,5570,276533980,-;failed to send QMI message -104`
- `kmsg_tail_09`: `3,5571,276533994,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa_1 ret:-104`
- `kmsg_tail_10`: `6,5572,276635849,-;failed to send QMI message -104`
- `kmsg_tail_11`: `3,5573,276635862,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa ret:-104`
- `kmsg_tail_12`: `6,5576,276733275,-;failed to send QMI message -104`
- `kmsg_tail_13`: `3,5577,276733289,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa_1 ret:-104`
- `kmsg_tail_14`: `6,5578,276835597,-;failed to send QMI message -104`
- `kmsg_tail_15`: `3,5579,276835610,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa ret:-104`
- `kmsg_tail_16`: `6,5585,278944178,-;failed to send QMI message -104`
- `kmsg_tail_17`: `3,5586,278944192,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa_1 ret:-104`
- `kmsg_tail_18`: `6,5587,279045947,-;failed to send QMI message -104`
- `kmsg_tail_19`: `3,5588,279045960,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa ret:-104`
- `kmsg_tail_20`: `6,5589,279143322,-;failed to send QMI message -104`
- `kmsg_tail_21`: `3,5590,279143336,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa_1 ret:-104`
- `kmsg_tail_22`: `6,5591,279245685,-;failed to send QMI message -104`
- `kmsg_tail_23`: `3,5592,279245698,-;qmi_sensors:qmi_ts_request qmi txn send failed for pa ret:-104`
...
- `property_archive`: `tmp/wifi/v2167-connect-dhcp-google-ping-handoff-qa-hold-v24-5g/property-runtime-v2167.tgz` bytes `12740` chunks `12` staged `1` method `ncm-wget` fast `1` elapsed `1.118`
- `helper_sha256`: `a26b21135cf9ecfecf624e3e04c5e33a707a95487646ab4118ad9dd88c93a75a` gzip_len `608721` chunks `529` method `ncm-wget` fast `1` elapsed `0.559`
- `strace_stage`: ok `1` reason `already-present` fast `` elapsed ``
- `standalone_wpa_archive`: ok `True` bytes `8179706` sha `00cc353a8a49d4df7d46124d23686d648a9e21b508c670acc7a38f024e5a635d` packages `17` staged `1` fast `1` elapsed `0.662`
