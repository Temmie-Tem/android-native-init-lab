...
but the narrow Native ramdisk loads no external module. None of these findings
retires the need to inspect them if an RTIC-consistent kernel still fails.
