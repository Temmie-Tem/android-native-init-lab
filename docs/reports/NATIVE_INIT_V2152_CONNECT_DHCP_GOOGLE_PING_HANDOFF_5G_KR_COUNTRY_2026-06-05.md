...
- Evidence: `tmp/wifi/v2152-connect-dhcp-google-ping-handoff-5g-kr-country`
...
- `connect_config`: path `/cache/a90-wifi/v2152.conf` size `234` mode `600` security `wpa-psk` disabled_initially `0` raw_values_logged `0`
