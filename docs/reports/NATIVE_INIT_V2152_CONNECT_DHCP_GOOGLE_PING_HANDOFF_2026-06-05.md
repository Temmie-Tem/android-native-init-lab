...
- Evidence: `tmp/wifi/v2152-connect-dhcp-google-ping-handoff`
...
- `helper_sha256`: `96278c6197195db47fc6bfbd6d92da93872b40abcb6df31ddcb6c18fbd5d2314` gzip_len `592587` chunks `1544`
- `connect_config`: path `/cache/a90-wifi/v2152.conf` size `270` mode `600` raw_values_logged `0`
