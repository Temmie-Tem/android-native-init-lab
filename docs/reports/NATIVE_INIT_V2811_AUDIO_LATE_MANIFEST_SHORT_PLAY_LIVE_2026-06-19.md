# Native Init V2811 Audio Late Manifest Wait Live Handoff

## Summary

- Cycle: `V2811`
- Track: audio core closure gate.
- Decision: `v2811-late-manifest-play-pass-before-rollback`
- Result directory: `workspace/private/runs/audio/v2811-audio-late-manifest-wait-20260619-111641`
...
- Card poll last summary: `{"dev_snd_line": "audio.dev_snd.count=61 control_like=1 pcm_like=59", "has_adsp_rpmsg": true, "has_sound_card": true, "has_sound_control": true, "no_soundcards": false, "proc_asound_cards_line": "audio.proc_asound_cards= 0 [sm8150tavilsndc]: sm8150-tavil-sn - sm8150-tavil-snd-card sm8150-tavil-snd-card", "rpmsg_line": "audio.rpmsg.count=7 adsp_like=7 cdsp_like=0", "sound_class_line": "audio.sound_class.count=128 card_like=1 control_like=1"}`
- Card/control after late deploy before worker done: `1 / 1`
- Manifest wait started/ready/timeout: `1 / 1 / 0`

## Playback Evidence

- Worker status done/attempts: `1` / `5`
- Worker status stdout: `workspace/private/runs/audio/v2811-audio-late-manifest-wait-20260619-111641/41_candidate-audio-play-status-05.txt`
- Worker log stdout: `workspace/private/runs/audio/v2811-audio-late-manifest-wait-20260619-111641/42_candidate-audio-late-manifest-play-log.txt`
