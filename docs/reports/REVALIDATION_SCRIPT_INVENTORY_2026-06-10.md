...
- Generated at: `2026-06-12T06:23:44.172206+00:00`
...
| `inventory_revalidation_scripts.py` | `active` | `none` | no | no | no | no | 13 | operator utility or inventory/cleanup utility |
...
- Active live scripts without explicit phase timer markers: `4` (`local_security_rescan.py, native_kernel_fwclass_boundary_stack_handoff_v2253.py, native_kernel_static_tracepoint_object_chain_audit_v2238.py, native_kernel_wlan_tracepoint_catalog_v2218.py`).
- Phase-timer-exempt live utilities: `2` (`ncm_host_setup.py, netservice_reconnect_soak.py`).
- Active live scripts without residual-state metadata: `4` (`local_security_rescan.py, native_kernel_fwclass_boundary_stack_handoff_v2253.py, native_kernel_static_tracepoint_object_chain_audit_v2238.py, native_kernel_wlan_tracepoint_catalog_v2218.py`).
