...
| `native_kernel_file_ops_anchor_v2204.py` | `active` | `a90ctl-subprocess,bridge-wrapper` | yes | no | no | no | 2 | kernel-observation runner or postprocessor |
| `native_kernel_fops_member_anchor_v2206.py` | `active` | `bridge-wrapper` | yes | no | no | no | 2 | kernel-observation runner or postprocessor |
...
| `native_kernel_perf_regs_codeword_sample_ring_v2216.py` | `active` | `bridge-wrapper` | yes | no | no | no | 4 | kernel-observation runner or postprocessor |
| `native_kernel_perf_regs_frame_sample_ring_v2214.py` | `active` | `bridge-wrapper` | yes | no | no | no | 2 | kernel-observation runner or postprocessor |
...
| `native_wifi_detail_surface_handoff_v2255.py` | `active` | `a90ctl-subprocess` | yes | no | no | yes | 2 | scripted live-device workflow |
