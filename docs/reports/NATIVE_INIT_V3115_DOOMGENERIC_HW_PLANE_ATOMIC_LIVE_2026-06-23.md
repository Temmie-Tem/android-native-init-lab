...
- Decision: `v3115-doomgeneric-hw-plane-atomic-loop-summary-missing`
- Result before rollback: `0`
- Loop classification: `loop-summary-missing`
- Track: DOOM large-frame scale-path optimization.
- Candidate: `A90 Linux init 0.10.112 (v3114-doomgeneric-hw-plane-atomic)`
- Candidate image: `workspace/private/inputs/boot_images/boot_linux_v3114_doomgeneric_hw_plane_atomic.img`
- Candidate SHA256: `c25090ecefe790ab680320a0cedebaa6b937155437dc37e52ca2485ffb8485c4`
- Private run dir: `workspace/private/runs/video/v3115-doomgeneric-hw-plane-atomic-live-20260623-112855`
- Live execution: `1`
...
- Display presented logs / max dashboard seq: `83` / `179`
...
- HW plane stage counts setplane/fetch-resources/scan-planes/presented: `94` / `0` / `0` / `0`
- HW plane crtc_index/cached-last/cached-count/reuse-evidence/fetch_resources_rc: `0` / `1` / `86` / `1` / `0`
- HW plane counts plane/compatible/idle_xbgr: `16` / `2` / `1`
- HW plane EINVAL count: `85`
...
- Flip events: `180` delta avg/max us: `None` / `33261` stable=`0`
- Shared seq missed/max-gap: `None` / `None` clean=`0`
- Candidate post-loop selftest fail=0: `1`

## Atomic Plane Evidence

- Atomic attempted count: `94`
- Atomic props rc/count: `0` / `34`
- Atomic commit rc/success/EINVAL count: `-22` / `0` / `87`
- Legacy SETPLANE rc/EINVAL count: `-22` / `82`
...
- `video.demo.doom.dashboard.hw_plane.atomic_commit_rc=`: `1`
- `video.demo.doom.dashboard.hw_plane.atomic_props_rc=`: `1`
- `video.demo.doom.dashboard.hw_plane.cached_crtc_index=`: `1`
- `video.demo.doom.dashboard.hw_plane.legacy_setplane_rc=`: `1`
...
- `cached_crtc_index=1` means V3114 bypassed the legacy `GETRESOURCES` hot path and used the KMS init CRTC index for plane enumeration.
