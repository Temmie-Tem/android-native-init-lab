...
- Cycle: `V2019`
- Decision: `v2019-tftp-result-mcfg-request-no-response-rollback-pass`
...
- Evidence: `tmp/wifi/v2019-tftp-sendmsg-result-handoff`
- Inner handoff: `tmp/wifi/v2019-tftp-sendmsg-result-handoff/v2018-handoff/manifest.json`

## Matrix

| area | value | detail |
| --- | --- | --- |
| label | tftp-result-mcfg-request-no-response | native modem repeatedly requests mcfg.tmp, but no compact ACK/DATA/ERROR or focused filesystem result was captured even with sendmsg decoding |
| helper | True | a90_android_execns_probe v378 |
| route | True | service74=True service180=True holder=True |
| bridges | True | readonly=True readwrite=True |
| cascade |  | wlan_pd=1 icnss_qmi=1 wlfw69=0 fw_ready=0 wlan0=0 hold=127.29338800000001 |
| tftp_trace | True | compiled=1 attach_rc=0 detach_rc=0 records=28 packet=28 fs=0 stops=1784 ms=45005 truncated=0 |
