...
- Decision: `v1671-clock-vote-surface-failed`
- Result: REVIEW
- Label: `clock-vote-surface-failed`
- Reason: rollback and cleanup succeeded, but no clock enable write succeeded; target enable leaves were not observed before the bounded wait expired (ready_count=0, wait_elapsed_ms=45032, async_begin_rc=-2)
- Evidence: `tmp/wifi/v1671-pcie1-clock-vote-readiness-retry-handoff`
...
- `pcie1_clock_vote.wait_begin=1 async=1 wait_ms=45000 result_path=/cache/native-init-wifi-test-boot-v1670-pcie1-clock-vote-readiness.result elapsed_ms=0`
- `pcie1_clock_vote.wait_end=1 ready_count=0 sample_count=897 elapsed_ms=45032`
- `pcie1_clock_vote.async_begin_rc=-2 hold_ms=30000`
- `pcie1_clock_vote.cleanup_begin=1 elapsed_ms=45032`
...
- `A90_V1664_CLOCK_VOTE_SNAPSHOT phase=post_cleanup elapsed_ms=45032`
