...
- Boot SHA256: `3f16c77cd6bf43e47bfd4767bf212da1981dda2e3d585d7f68678894a549c888`
...
- Reload mode defers the early selftest/pid1guard until service adoption is complete, and the KMS selftest accepts the adopted HUD child as the display liveness proof.
- Bright line retained: no panel re-init, no backlight/PMIC/regulator/GDSC/GPIO writes, no reload SETCRTC retry.

## Validation Contract

- Static PASS requires the V3368 version strings, reload markers, retained storage/tcpctl markers, and H5 markers (`reload: preserving autohud`, `Hot-reload: autohud adopted`, `hotreload-autohud`, `Hot-reload: rshell ready`, `hotreload-rshell`, `Hot-reload: selftest/guard refreshed`, `display: adopted-autohud`).
