# Native Init V1517 Wi-Fi Test Boot Handoff

## Summary

- Cycle: `V1517`
- Type: bounded live test-boot handoff with rollback
- Decision: `v1517-test-boot-downstream-progress-rollback-pass`
- Result: PASS
...
- `pid1_rc1_watcher_result_file`: `state=triggered source=/proc/kmsg write_rc=0 errno=0 detect_elapsed_ms=7384 write_elapsed_ms=8806 delay_ms=0 retry_count=0 retry_delay_ms=0 line=<3>[    9.137403]  [0:    cnss-daemon:  603] __netlink_sendskb(1245) skb:00000000a6dbc236 queued sk: 0000000018d2091b`
- `pid1_rc1_window_sampler_requested`: `None`
- `pid1_rc1_window_result_summary`: `None`
- `pid1_rc1_window_result_file`: `state=armed sampler=auto-v1485-wifi-readiness-test detect_elapsed_ms=7384 delay_ms=0 exact_provider_line=0 long_provider_window=0 tracepoint_sampler=0 pil_tracepoint_sampler=0 line=<3>[ 9.137403] [0: cnss-daemon: 603] __netlink_sendskb(1245) skb:00000000a6dbc236 queued sk: 0000000018d2091b <3>[ 9.137428] [0: cnss-daemon: 60`
...
- Test image: `tmp/wifi/v1515-wifi-critical-source-pre-l0-test-boot/boot_linux_v1515_wifi_test.img`
- Rollback image: `stage3/boot_linux_v724.img`

## Next

Treat `rc1-ltssm-link-failed-no-l0` as the current blocker. V1518 should
classify the critical-source pre-L0 evidence before any new live gate. Do not
