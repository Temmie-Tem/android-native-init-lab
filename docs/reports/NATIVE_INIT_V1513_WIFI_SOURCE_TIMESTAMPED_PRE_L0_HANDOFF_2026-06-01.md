# Native Init V1513 Wi-Fi Test Boot Handoff

## Summary

- Cycle: `V1513`
- Type: bounded live test-boot handoff with rollback
- Decision: `v1513-test-boot-downstream-progress-rollback-pass`
- Result: PASS
...
- `pid1_rc1_watcher_result_file`: `state=triggered source=/proc/kmsg write_rc=0 errno=0 detect_elapsed_ms=7366 write_elapsed_ms=9848 delay_ms=0 retry_count=0 retry_delay_ms=0 line=<3>[    9.040358]  [3:    cnss-daemon:  598] __netlink_sendskb(1245) skb:00000000644217a2 queued sk: 0000000069bad0f5`
- `pid1_rc1_window_sampler_requested`: `None`
- `pid1_rc1_window_result_summary`: `None`
- `pid1_rc1_window_result_file`: `state=armed sampler=auto-v1485-wifi-readiness-test detect_elapsed_ms=7366 delay_ms=0 exact_provider_line=0 long_provider_window=0 tracepoint_sampler=0 pil_tracepoint_sampler=0 line=<3>[ 9.040358] [3: cnss-daemon: 598] __netlink_sendskb(1245) skb:00000000644217a2 queued sk: 0000000069bad0f5 <3>[ 9.040384] [3: cnss-daemon: 59`
...
- Test image: `tmp/wifi/v1511-wifi-source-timestamped-pre-l0-test-boot/boot_linux_v1511_wifi_test.img`
- Rollback image: `stage3/boot_linux_v724.img`

## Next

Treat `rc1-ltssm-link-failed-no-l0` as the current blocker. V1514 should
classify the source-timestamped pre-L0 evidence before any new live gate. Do
not proceed to firmware/MHI/WLFW/scan/connect, credentials, DHCP/routes, or
external ping until RC1 reaches L0 and PCI enumeration exists.
