...
- Cycle: `V2091`
- Decision: `v2091-macloader-no-mac-addr-write-rollback-pass`
...
- Evidence: `tmp/wifi/v2091-macloader-property-service-handoff`
- Inner handoff: `tmp/wifi/v2091-macloader-property-service-handoff/v2090-handoff/manifest.json`
...
| property_shim | 1 | child=missing macloader_ack_enabled=missing requests=missing macloader_ack=0 |
...
- `006:connect:ret=3:err=0:path=/tmp/a90-v231-547/root/dev/null`
- `007:socket:ret=3:err=0:path=`
- `008:connect:ret=3:err=0:path=/tmp/a90-v231-547/root/dev/null`
...
| started | 1 |
| pid | 551 |
| child_started | missing |
| macloader_interface_props_allowed | missing |
| request_count | missing |
| macloader_ack_count | 0 |
| postflight_safe | missing |
