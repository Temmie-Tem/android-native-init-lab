...
- Evidence: `tmp/wifi/v1888-pm-msgid-capture-diff-classifier-v1913`

## Android Capture Parse

- Evidence dir: `tmp/wifi/v1913-android-pm-service-qmi-msgid-uprobe-handoff-live-20260603-221820/android-postfs-evidence/a90-v1913-pm-msgid-uprobe`
- logcat/dmesg/request lines: `284` / `72` / `0`
- PM register/vote count/time: `2` / `2` / `22:20:30.658`
- WLFW request count/time: `1` / `22:20:30.696`
- wlan_pd indication/ack/time: `2` / `1` / `9.727775`
- wlanmdsp count/time: `10` / `22:20:31.459`
- wlan0 time and contamination counts: `15.010257` / PCIe-MHI `0` / esoc-boot-failed `0` / degraded257 `False`
- pm msg20/msg21/msg22 hits: `0` / `0` / `0`
- first msg22 line: ``
- first wlan_pd line: `[    9.727775]  [6:  kworker/u16:6:  250] service-notifier: root_service_service_ind_cb: Indication received from msm/modem/wlan_pd, state: 0x1fffffff, trans-id: 1`
- first wlanmdsp line: `06-03 22:20:31.459   977  1478 I tftp_server: pid=977 tid=1478 tftp-server : INF :[tftp_server_utils.c, 113] file [readonly/vendor/firmware_mnt/image/wlanmdsp.mbn] : [/vendor/rfs/msm/mpss/readonly/vendor`
