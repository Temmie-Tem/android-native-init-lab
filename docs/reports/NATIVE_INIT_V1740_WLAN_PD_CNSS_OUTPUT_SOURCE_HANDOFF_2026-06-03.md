# Native Init V1740 WLAN-PD cnss-daemon Output Visibility Handoff
...
- Evidence: `tmp/wifi/v1740-wlan-pd-cnss-output-source-handoff`
...
- Remote root: `/mnt/sdext/a90/private-property-v317/v1739/dev/__properties__`
- Uploaded files: `22`
...
- `Failed to init nl_loop` stdout/stderr/kmsg: `0` / `0` / `0`
- `Failed to init netlink common` stdout/stderr/kmsg: `0` / `0` / `0`
- `Failed to start wlan service` stdout/stderr/kmsg: `0` / `0` / `0`
- `Failed to start wlan datapath service` stdout/stderr/kmsg: `0` / `0` / `0`
