# Native Init V3004 DOOM Input Keyboard State Live Handoff Dry Run
...
- Private run dir: `workspace/private/runs/input/v3004-doominput-keyboard-live-gate-20260620-195135`
- Live execution: `0`
...
- V3004 gates the USB-keyboard/OTG fallback on the current V2989 `doominput.state` candidate after both built-in touch nodes produced zero events.
...
- `python3 -m py_compile workspace/public/src/scripts/revalidation/native_doominput_keyboard_live_gate_v3004.py tests/test_native_doominput_keyboard_live_gate_v3004.py`: PASS
- `PYTHONPATH=workspace/public/src/scripts/revalidation:workspace/public/src/harness python3 -m unittest tests.test_native_doominput_keyboard_live_gate_v3004`: PASS
- `PYTHONPATH=workspace/public/src/scripts/revalidation:workspace/public/src/harness python3 workspace/public/src/scripts/revalidation/native_doominput_keyboard_live_gate_v3004.py --count 32 --timeout-ms 60000`: PASS (dry-run preflight/report)
- `git diff --check`: PASS
