...
- Boot image: `workspace/private/inputs/boot_images/boot_linux_v2777_audio_profile_module.img`
- Boot SHA256: `f4c3efc553f79d16f28d5de09edd971bff95dd192718ac8083cdf8b6c7fa7f95`
- Init: `A90 Linux init 0.9.297 (v2777-audio-profile-module)`
...
- V2777 is source/link validation for the module split; V2776 remains the latest device proof for the read-only prereq API.

## Validation

- Focused unittest set passed: `test_native_audio_profile_module_v2777`, profile/route/app-type/setcal contract tests, and `test_native_audio_prereq_api_v2775`.
- `python3 workspace/public/src/scripts/revalidation/build_native_init_boot_v2777_audio_profile_module.py` passed and linked `workspace/public/src/native-init/a90_audio_profile.c` into the native-init binary.
- Boot image SHA256: `f4c3efc553f79d16f28d5de09edd971bff95dd192718ac8083cdf8b6c7fa7f95`.
