...
- Generated at: `2026-06-08T22:45:50.823396+00:00`
...
| `a90_ncm_transport_smoke.py` | `active` | `shared` | 11 | active NCM transport smoke |
| `a90_serial_lock.py` | `module` | `none` | 3 | serial bridge lock helper |
| `a90_transport.py` | `module` | `bridge-wrapper` | 8 | shared bridge/transport selector |
| `a90_v725_fasttransport_baseline_validation.py` | `active` | `shared` | 6 | fast transport baseline validator |
| `a90_wifi_profile_stage.py` | `active` | `none` | 9 | active Wi-Fi profile staging helper |
| `a90ctl.py` | `active` | `a90ctl-subprocess` | 355 | cmdv1 operator/client entrypoint |
...
| `build_native_init_boot_v2174_wifi_urandom_connect.py` | `active` | `none` | 5 | Wi-Fi carrier boot builder |
| `build_native_init_boot_v2176_wifi_dhcp.py` | `active` | `none` | 5 | Wi-Fi DHCP boot builder |
| `build_native_init_boot_v2178_wifi_profile_autoconnect.py` | `active` | `none` | 10 | Wi-Fi profile/autoconnect boot builder |
...
| `native_wifi_connect_carrier_handoff_v2174.py` | `active` | `shared` | 7 | active Wi-Fi carrier validation |
| `native_wifi_dhcp_ping_handoff_v2176.py` | `active` | `shared` | 8 | active Wi-Fi DHCP/ping validation |
| `native_wifi_hold_reconnect_handoff_v2177.py` | `active` | `shared` | 5 | active Wi-Fi hold/reconnect validation |
| `native_wifi_supplicant_dependency_probe.py` | `active` | `shared` | 6 | current Wi-Fi dependency probe |
| `native_wifi_v2178_autoconnect_phase_validation.py` | `active` | `shared` | 5 | active V2178 Wi-Fi autoconnect phase validation |
