...
The S22+ row was checked on 2026-09-09; the other rows retain their 2026-09-05 snapshot. Follow each GOAL for later changes.
...
| [Galaxy S22+](S22PLUS.md) (`SM-S906N`, FYG8)<br>[display visual evidence](S22PLUS_DISPLAY_VISUAL_EVIDENCE.md)<br>[boot HUD visual evidence](S22PLUS_BOOT_HUD_VISUAL_EVIDENCE.md) | Qualcomm SM8450 / vendor Linux 5.10.226 | **PROVED:** rebuilt-kernel Android boot, native-PID1 ACM, authenticated bounded read-only shell and healthy rollback through P348; P353-P361 **PROVED** display dispatch/rollback and **OBSERVED** clean cached-buffer output, including repeated framebuffer selection; P375-P376 **PROVED** an authenticated root command console and a minimal boot HUD with **OBSERVED** on-panel text and increasing uptime, the completed scope labelled functional version `v0.1.0` | v0.1.0 completed at P376: authenticated root command console plus minimal boot HUD, exact rollback and final health; no native session or replay authority remains, and the next bounded unit requires its own selection and authority | device-backed P349 hour witness, standing/unrestricted root shell, pixel readback, the WC/CACHED corruption cause, native normal reboot, machine-proved Download arrival, unattended operation, and PID1/kernel-stall recovery |
