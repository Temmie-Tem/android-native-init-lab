#!/usr/bin/env python3
"""V1580 rollbackable live handoff for the V1579 service-window PM proxy contract devnode firmware-mounted test boot."""
...
DEFAULT_ARGS = [
    ...
    "V1580",
    "--out-dir",
    str(base.REPO_ROOT / "tmp" / "wifi" / "v1580-service-window-pm-proxy-contract-devnode-fw-handoff"),
    "--report-path",
    str(
        base.REPO_ROOT
        / "docs"
        / "reports"
        / "NATIVE_INIT_V1580_SERVICE_WINDOW_PM_PROXY_CONTRACT_DEVNODE_FW_HANDOFF_2026-06-02.md"
    ),
    "--v1394-manifest",
    str(
        base.REPO_ROOT
        / "tmp"
        / "wifi"
        / "v1579-service-window-pm-proxy-contract-devnode-fw-artifact-sanity"
        / "manifest.json"
    ),
    "--test-image",
    str(
    ...
    "--dmesg-grep-pattern",
    (
        "A90v1579|A90v641|firmware mounts|firmware_mnt|firmware-modem|android_wifi_service_window|pm_proxy|pm-service|pm_proxy_helper|mdm_helper_launch_contract|"
