#!/usr/bin/env python3
"""V1705 one-run CNSS WLFW downstream uprobe handoff."""
...
CYCLE = "V1705"
V1704_OUT = REPO_ROOT / "tmp" / "wifi" / "v1704-cnss-wlfw-downstream-uprobe-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v1704/dev/__properties__"
DEFAULT_OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v1705-cnss-wlfw-downstream-uprobe-handoff"
DEFAULT_REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1705_CNSS_WLFW_DOWNSTREAM_UPROBE_HANDOFF_2026-06-02.md"
)
TEST_EXPECT_VERSION = "A90 Linux init 0.9.129 (v1704-cnss-wlfw-downstream-uprobe)"
TEST_LOG_PATH = "/cache/native-init-wifi-test-boot-v1704.log"
TEST_SUMMARY_PATH = "/cache/native-init-wifi-test-boot-v1704.summary"
TEST_HELPER_RESULT_PATH = "/cache/native-init-wifi-test-boot-v1704-helper.result"
DMESG_PATTERN = (
    base.DMESG_PATTERN.replace("A90v1699", "A90v1704")
    + "|wlfw_ind_register_qmi|wlfw_cap_qmi|dms_service_request"
)
VALID_DOWNSTREAM_LABELS = {
...
def configure_base() -> None:
    ...
    base.VALID_NONLOG_LABELS = set(VALID_DOWNSTREAM_LABELS)
    base.base.CYCLE = CYCLE
    base.base.V1690_OUT = V1704_OUT
    base.base.base.V1687_OUT = V1704_OUT
    base.base.base.DEFAULT_SOURCE_MANIFEST = V1704_OUT / "manifest.json"
    base.base.base.DEFAULT_TEST_IMAGE = V1704_OUT / "boot_linux_v1704_cnss_wlfw_downstream_uprobe.img"
    base.base.base.LOCAL_PROPERTY_ROOT = V1704_OUT / "property-runtime" / "layout" / "dev" / "__properties__"
...
def render_report(result: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- downstream non-log label: `{gate.get('nonlog_label')}`",
