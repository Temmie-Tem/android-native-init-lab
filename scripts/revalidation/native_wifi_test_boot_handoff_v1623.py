#!/usr/bin/env python3
"""V1623 rollbackable live handoff for the V1621 pm-service property-root boot."""
...
DEFAULT_ARGS = [
    ...
    "V1623",
    "--out-dir",
    str(base.REPO_ROOT / "tmp" / "wifi" / "v1623-pm-service-property-root-handoff"),
    "--report-path",
    str(
        base.REPO_ROOT
        / "docs"
        / "reports"
        / "NATIVE_INIT_V1623_PM_SERVICE_PROPERTY_ROOT_HANDOFF_2026-06-02.md"
    ),
    "--v1394-manifest",
    str(
        base.REPO_ROOT
        / "tmp"
        / "wifi"
        / "v1622-pm-service-property-root-artifact-sanity"
        / "manifest.json"
    ),
    "--test-image",
    str(
        ...
        / "tmp"
        / "wifi"
        / "v1621-pm-service-property-root-test-boot"
        / "boot_linux_v1621_wifi_test.img"
    ),
    "--expect-test-version",
    ...
    "--dmesg-grep-pattern",
    (
        "A90v1621|firmware mounts|firmware_mnt|firmware-modem|"
