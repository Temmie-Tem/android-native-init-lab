#!/usr/bin/env python3
"""Build V2131 native ICNSS register-probe stack sampler test boot."""

from __future__ import annotations

from pathlib import Path

import build_native_init_wifi_test_boot_v2129 as prev2129


REPO_ROOT = Path(__file__).resolve().parents[2]
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2131-icnss-register-probe-stack-test-boot"
...
REPORT_PATH = (
    ...
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2131_ICNSS_REGISTER_PROBE_STACK_SOURCE_BUILD_2026-06-05.md"
)
HELPER_FLAGS = (
    *prev2129.HELPER_FLAGS,
    "-DA90_WIFI_TEST_BOOT_ICNSS_REGISTER_PROBE_STACK_SAMPLER=1",
)


def configure_base() -> None:
    prev2129.OUT_DIR = OUT_DIR
    prev2129.REMOTE_PROPERTY_ROOT = REMOTE_PROPERTY_ROOT
    prev2129.REPORT_PATH = REPORT_PATH
    prev2129.EXPECTED_HELPER_MARKER = EXPECTED_HELPER_MARKER
    prev2129.EXPECTED_HELPER_SHA256 = EXPECTED_HELPER_SHA256
    prev2129.HELPER_FLAGS = HELPER_FLAGS
    prev2129.configure_base()

    base = prev2129.prev2127.prev2120.prev2112.prev2108.prev2106.prev2102.prev2100.prev2097.prev2095.prev2082.prev2080.prev2058.prev2038.prev2008.prev2006.build_base_module()
    args = list(base.DEFAULT_ARGS)
    replacements = {
        "--cycle": "V2131",
        "--decision": "v2131-icnss-register-probe-stack-source-build-pass",
        "--cycle-label": "v2131",
        "--init-version": "0.9.240",
        "--init-build": "v2131-icnss-register-probe-stack",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2131_icnss_register_probe_stack"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v424_icnss_register_probe_stack"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2131_icnss_register_probe_stack.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2131_icnss_register_probe_stack.img"),
        "--wifi-test-klog-prefix": "A90v2131",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2131.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2131.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2131.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2131-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2131.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2131-supervisor.pid",
        "--wifi-test-property-root": REMOTE_PROPERTY_ROOT,
    }
    for key, value in replacements.items():
        prev2129.prev2127.prev2120.prev2112.prev2108.prev2106.prev2102.prev2100.prev2097.prev2095.prev2082.prev2080.prev2058.prev2038.prev2008.prev2006.set_arg(args, key, value)
...
def main() -> int:
    ...
    prev2129.prev2127.prev2120.prev2112.prev2108.prev2106.prev2102.prev2100.prev2097.prev2095.prev2082.prev2080.prev2058.prev2038.patch_helper_builder(base)
