#!/usr/bin/env python3
"""Build V2016 native tftp result full-chain test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2016-tftp-result-full-chain-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2016/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v377"
EXPECTED_HELPER_SHA256 = "e8b230ec6b1d6b45d5b5a85ee1a960dd92e7120cfb1cd51c3e46ee7ca2194879"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2016_TFTP_RESULT_FULL_CHAIN_SOURCE_BUILD_2026-06-04.md"
)
TFTP_HELPER_FLAGS = (
    "-DA90_WIFI_TEST_BOOT_WLAN_PD_PRODUCER_TFTP_SERVER_TRACE=1",
    "-DA90_WIFI_TEST_BOOT_WLAN_PD_PRODUCER_TFTP_SERVER_TRACE_COMPACT=1",
    "-DTFTP_SERVER_SYSCALL_RECORD_LIMIT=768U",
    "-DTFTP_SERVER_SYSCALL_STOP_LIMIT=15000U",
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2016",
        "--init-version": "0.9.190",
        "--init-build": "v2016-tftp-result-full-chain",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2016_tftp_result_full_chain"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v377"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2016_tftp_result_full_chain.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2016_tftp_result_full_chain.img"),
        "--wifi-test-klog-prefix": "A90v2016",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2016.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2016.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2016.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2016-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2016.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2016-supervisor.pid",
