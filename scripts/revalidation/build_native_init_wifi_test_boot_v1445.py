#!/usr/bin/env python3
"""Build the V1445 Wi-Fi test boot artifact with case-aligned RC1 micro endpoint sampling."""
...
OUT_DIR = base.REPO_ROOT / "tmp" / "wifi" / "v1445-wifi-test-boot-case-aligned-micro-endpoint-sampler"

DEFAULT_ARGS = [
    "--cycle",
    "V1445",
    "--decision",
    "v1445-wifi-test-boot-case-aligned-micro-endpoint-source-build-pass",
    "--cycle-label",
    "v1445",
    "--init-version",
    "0.9.82",
    ...
    str(OUT_DIR),
    "--init-binary",
    str(OUT_DIR / "init_v1445_wifi_test"),
    "--ramdisk-cpio",
    str(OUT_DIR / "ramdisk_v1445_wifi_test.cpio"),
    "--boot-image",
    str(OUT_DIR / "boot_linux_v1445_wifi_test.img"),
    "--wifi-test-klog-prefix",
    "A90v1445",
    "--wifi-test-disable",
    "/cache/native-init-wifi-test-boot-v1445.disable",
    "--wifi-test-log",
