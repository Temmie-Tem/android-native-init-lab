#!/usr/bin/env python3
"""Build the V1597 PM-first late-per-proxy lower-marker Wi-Fi test boot artifact."""
...
OUT_DIR = base.REPO_ROOT / "tmp" / "wifi" / "v1597-pm-first-late-per-proxy-lower-marker-test-boot"
REPORT_PATH = (
    base.REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1597_PM_FIRST_LATE_PER_PROXY_LOWER_MARKER_SOURCE_BUILD_2026-06-02.md"
)
...
DEFAULT_ARGS = [
    ...
    "0.9.104",
    "--init-build",
    "v1597-pm-first-late-per-proxy-lower-marker",
    "--out-dir",
    str(OUT_DIR),
    "--init-binary",
    str(OUT_DIR / "init_v1597_wifi_test"),
    "--helper-binary",
    str(OUT_DIR / "a90_android_execns_probe_v296"),
    "--ramdisk-cpio",
    str(OUT_DIR / "ramdisk_v1597_wifi_test.cpio"),
    "--boot-image",
    str(OUT_DIR / "boot_linux_v1597_wifi_test.img"),
    "--wifi-test-klog-prefix",
    "A90v1597",
    "--wifi-test-disable",
    "/cache/native-init-wifi-test-boot-v1597.disable",
    "--wifi-test-log",
    ...
    "--wifi-test-pid",
    "/cache/native-init-wifi-test-boot-v1597.pid",
    "--wifi-test-watcher-pid",
    "/cache/native-init-wifi-test-boot-v1597-supervisor.pid",
    "--wifi-test-watch-sec",
    "120",
