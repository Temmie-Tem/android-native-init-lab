#!/usr/bin/env python3
"""Compatibility wrapper for the workspace current V725 fasttransport builder."""
...
CANONICAL_RELATIVE_PATH = "workspace/public/src/scripts/revalidation/build_native_init_boot_v725_fasttransport.py"
