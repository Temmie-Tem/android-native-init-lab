...
USERLAND_BIN = REPO_ROOT / "external_tools" / "userland" / "bin"
DEFAULT_BASE_BOOT = REPO_ROOT / "stage3" / "boot_linux_v724.img"
DEFAULT_INIT_SOURCE = LINUX_INIT / "init_v725_fasttransport.c"
DEFAULT_INIT_BINARY = LINUX_INIT / "init_v725_fasttransport"
DEFAULT_RAMDISK_DIR = REPO_ROOT / "stage3" / "ramdisk_v725_fasttransport"
DEFAULT_RAMDISK_CPIO = REPO_ROOT / "stage3" / "ramdisk_v725_fasttransport.cpio"
DEFAULT_BOOT_IMAGE = REPO_ROOT / "stage3" / "boot_linux_v725_fasttransport.img"
