#!/usr/bin/env python3
"""Build the V1664 native pcie1 clock vote proof test boot artifact."""
...
OUT_DIR = base.REPO_ROOT / "tmp" / "wifi" / "v1664-pcie1-clock-vote-test-boot"
REPORT_PATH = (
    base.REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1664_PCIE1_CLOCK_VOTE_SOURCE_BUILD_2026-06-02.md"
)
...
DEFAULT_ARGS = [
    ...
    "0.9.116",
    "--init-build",
    "v1664-pcie1-clock-vote",
    "--out-dir",
    str(OUT_DIR),
    "--init-binary",
    str(OUT_DIR / "init_v1664_pcie1_clock_vote"),
    "--ramdisk-cpio",
    str(OUT_DIR / "ramdisk_v1664_pcie1_clock_vote.cpio"),
    "--boot-image",
    str(OUT_DIR / "boot_linux_v1664_pcie1_clock_vote.img"),
    "--wifi-test-klog-prefix",
    "A90v1664",
    "--wifi-test-disable",
    "/cache/native-init-wifi-test-boot-v1664.disable",
    "--wifi-test-log",
    "/cache/native-init-wifi-test-boot-v1664.log",
    "--wifi-test-summary",
    "/cache/native-init-wifi-test-boot-v1664.summary",
    "--wifi-test-helper-result",
    "/cache/native-init-wifi-test-boot-v1664-helper.result",
    "--wifi-test-pid",
    "/cache/native-init-wifi-test-boot-v1664.pid",
    "--wifi-test-watcher-pid",
    "/cache/native-init-wifi-test-boot-v1664-supervisor.pid",
    "--wifi-test-rc1-watcher-result",
    "/cache/native-init-wifi-test-boot-v1664-natural-watcher.result",
    "--wifi-test-rc1-window-result",
    "/cache/native-init-wifi-test-boot-v1664-clock-vote-window.result",
    "--wifi-test-watch-sec",
    "55",
