#!/usr/bin/env python3
"""Build V2012 native tftp data-window test boot."""
...
import build_native_init_wifi_test_boot_v2010 as prev2010


REPO_ROOT = Path(__file__).resolve().parents[2]
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2012-tftp-data-window-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2012/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v375"
EXPECTED_HELPER_SHA256 = "16d1e4488ad30314b28b4ad66dbf1c5c62f99238345f38b41a74e09eb7755227"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2012_TFTP_DATA_WINDOW_SOURCE_BUILD_2026-06-04.md"
)
TFTP_HELPER_FLAGS = (
    "-DA90_WIFI_TEST_BOOT_WLAN_PD_PRODUCER_TFTP_SERVER_TRACE=1",
    "-DTFTP_SERVER_SYSCALL_RECORD_LIMIT=2048U",
    "-DTFTP_SERVER_SYSCALL_STOP_LIMIT=6000U",
    "-DTFTP_SERVER_SYSCALL_TRACE_TIMEOUT_MS=45000U",
)


def configure_base() -> None:
    prev2010.OUT_DIR = OUT_DIR
    prev2010.REMOTE_PROPERTY_ROOT = REMOTE_PROPERTY_ROOT
    prev2010.REPORT_PATH = REPORT_PATH
    prev2010.EXPECTED_HELPER_MARKER = EXPECTED_HELPER_MARKER
    prev2010.EXPECTED_HELPER_SHA256 = EXPECTED_HELPER_SHA256
    prev2010.configure_base()

    base = prev2010.prev2008.prev2006.build_base_module()
    args = list(base.DEFAULT_ARGS)
    replacements = {
        "--cycle": "V2012",
        "--decision": "v2012-tftp-data-window-source-build-pass",
        "--cycle-label": "v2012",
        "--init-version": "0.9.188",
        "--init-build": "v2012-tftp-data-window",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2012_tftp_data_window"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v375"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2012_tftp_data_window.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2012_tftp_data_window.img"),
        "--wifi-test-klog-prefix": "A90v2012",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2012.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2012.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2012.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2012-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2012.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2012-supervisor.pid",
        "--wifi-test-property-root": REMOTE_PROPERTY_ROOT,
    }
    for key, value in replacements.items():
        prev2010.prev2008.prev2006.set_arg(args, key, value)
