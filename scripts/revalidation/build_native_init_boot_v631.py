#!/usr/bin/env python3
"""Build the V631 native init boot image.

This builder recompiles the V631 PID1 binary, repacks a ramdisk with the same
...
DEFAULT_INIT_SOURCE = LINUX_INIT / "init_v631.c"
DEFAULT_INIT_BINARY = LINUX_INIT / "init_v631"
DEFAULT_RAMDISK_DIR = REPO_ROOT / "stage3" / "ramdisk_v631"
DEFAULT_RAMDISK_CPIO = REPO_ROOT / "stage3" / "ramdisk_v631.cpio"
DEFAULT_BOOT_IMAGE = REPO_ROOT / "stage3" / "boot_linux_v631.img"
...
def build_boot_image(args: argparse.Namespace) -> None:
    with tempfile.TemporaryDirectory(prefix="a90-v631-unpack-") as temp_name:
