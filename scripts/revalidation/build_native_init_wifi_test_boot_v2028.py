#!/usr/bin/env python3
"""Build V2028 native dual RFS wlanmdsp serve-path + early TFTP trace test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2028-dual-rfs-wlanmdsp-tftp-test-boot"
...
EXPECTED_HELPER_SHA256 = "c4b425112bd6c6defd0cf2d5a01949c69e81dd61a1af2c6117e2f3aa1531c4b7"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2028_DUAL_RFS_WLANMDSP_TFTP_SOURCE_BUILD_2026-06-04.md"
)
TFTP_HELPER_FLAGS = (
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2028",
        "--init-version": "0.9.196",
        "--init-build": "v2028-dual-rfs-wlanmdsp-tftp",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2028_dual_rfs_wlanmdsp_tftp"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v382_dual_rfs_tftp"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2028_dual_rfs_wlanmdsp_tftp.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2028_dual_rfs_wlanmdsp_tftp.img"),
        "--wifi-test-klog-prefix": "A90v2028",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2028.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2028.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2028.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2028-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2028.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2028-supervisor.pid",
