...
BOOT_IMAGE = REPO_ROOT / "stage3" / "boot_linux_v726_wifi_lifecycle.img"
INIT_BINARY = REPO_ROOT / "stage3" / "linux_init" / "init_v726_wifi_lifecycle"
RAMDISK_CPIO = REPO_ROOT / "stage3" / "ramdisk_v726_wifi_lifecycle.cpio"
