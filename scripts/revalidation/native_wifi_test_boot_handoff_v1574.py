#!/usr/bin/env python3
"""V1574 rollbackable live handoff for the V1573 mdm_helper launch-contract test boot."""
...
DEFAULT_ARGS = [
    ...
    "V1574",
    "--out-dir",
    str(base.REPO_ROOT / "tmp" / "wifi" / "v1574-mdm-helper-launch-contract-crashfix-handoff"),
    "--report-path",
    str(
        base.REPO_ROOT
        / "docs"
        / "reports"
        / "NATIVE_INIT_V1574_MDM_HELPER_LAUNCH_CONTRACT_CRASHFIX_HANDOFF_2026-06-02.md"
    ),
    "--v1394-manifest",
    str(
        base.REPO_ROOT
        / "tmp"
        / "wifi"
        / "v1573-mdm-helper-launch-contract-crashfix-artifact-sanity"
        / "manifest.json"
    ),
    "--test-image",
    str(
    ...
    "--dmesg-grep-pattern",
    (
        "A90v1573|android_wifi_service_window|mdm_helper_launch_contract|"
