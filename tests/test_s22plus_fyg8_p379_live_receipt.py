...
_source=_source.replace('p375','p379').replace('P375','P379').replace('test_s22plus_fyg8_p379_console_integration','test_s22plus_fyg8_p379_hud_integration')
...
P379LiveReceiptTests.setUpClass=setup
...
P379LiveReceiptTests.test_changed_hud_claim_cannot_replace_raw_frames=changed_hud_claim
