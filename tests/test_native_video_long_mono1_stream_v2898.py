...
import native_video_long_mono1_stream_live_handoff_v2898 as long_live


class NativeVideoLongMono1StreamV2898(unittest.TestCase):
    ...
    def test_wrapper_defaults_to_first_over_old_limit_mono1_fixture(self) -> None:
        with mock.patch.object(sys, "argv", ["native_video_long_mono1_stream_live_handoff_v2898.py"]):
    ...
    def test_prepare_stream_writes_mono1_manifest_and_header(self) -> None:
        out_dir = ROOT / "workspace/private/test-runs/v2898-long-mono1-unit"
