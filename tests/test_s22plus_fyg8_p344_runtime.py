...
class P344RuntimeTests(unittest.TestCase):
    def setUp(self) -> None:
        self.source = (
            ROOT
    ...
    def test_fresh_identity_and_preserved_named_read_geometry(self) -> None:
    ...
    def test_transform_changes_only_the_run_marker(self) -> None:
        ...
        self.assertEqual(receipt["changed_anchors"], [
            "p344_fixed_command_identity_only",
        ])
        ...
        self.assertEqual(transformed.count(runtime._c_string(runtime.P344_COMMAND)), 1)
        self.assertEqual(transformed.count(runtime._c_string(runtime.P343_COMMAND)), 0)
    ...
    def test_transform_artifacts_changes_only_runtime_key(self) -> None:
        ...
        self.assertEqual(
            runtime.validate_p344_runtime(result[runtime.RUNTIME_KEY])["run_id_hex"],
            runtime.P344_RUN_ID_HEX,
        )
