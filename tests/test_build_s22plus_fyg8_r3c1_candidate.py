...
SCRIPT = ROOT / "workspace/public/src/scripts/revalidation/build_s22plus_fyg8_r3c1_candidate.py"
...
class S22PlusFyg8R3C1CandidateBuilderTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.builder = load(SCRIPT, "build_s22plus_fyg8_r3c1_candidate_tested")
        cls.checker = load(CHECKER, "s22plus_fyg8_r3_checker_for_r3c1_builder_test")
    ...
    def test_candidate_replaces_only_kernel_region(self):
        ...
        try:
            ...
            rebuilt_kernel = arm64_kernel(0x22)
    ...
    def test_deterministic_ap_is_one_canonical_member(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            payload.write_bytes(b"r3c1-frame")
