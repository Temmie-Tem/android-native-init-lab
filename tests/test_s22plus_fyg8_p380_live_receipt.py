...
_source=_source.replace('p375','p380').replace('P375','P380').replace('test_s22plus_fyg8_p380_console_integration','test_s22plus_fyg8_p380_hud_integration')
...
P380LiveReceiptTests.setUpClass=setup
...
P380LiveReceiptTests.test_changed_hud_claim_cannot_replace_raw_frames=changed_hud_claim
