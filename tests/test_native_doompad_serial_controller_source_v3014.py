...
class TestNativeDoompadSerialControllerSourceV3014(unittest.TestCase):
    ...
    def test_video_status_reports_serial_controller_frontier(self) -> None:
        ...
        self.assertIn('a90_console_printf("video.demo.input.next=scripted-doompad-serial-validation\\r\\n");', text)
