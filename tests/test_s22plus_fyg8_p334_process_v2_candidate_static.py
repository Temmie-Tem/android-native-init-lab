...
import s22plus_fyg8_p334_process_v2_candidate_static as static  # noqa: E402


class P334CandidateStaticTests(unittest.TestCase):
    @classmethod
    ...
    def test_exact_candidate_and_single_runtime_delta(self) -> None:
        ...
        self.assertEqual(
            value["candidate"]["a"]["ap_tar_md5"], static.P334_AP_IDENTITY
        )
        self.assertNotEqual(
            value["candidate"]["a"]["ap_tar_md5"], static.P333_AP_IDENTITY
        )
        self.assertEqual(
            value["runtime_repair"]["changed_anchors"],
            ["p333_publisher_entry", "stock_terminal_detail"],
        )
        self.assertTrue(value["runtime_repair"]["entry_diagnostic_before_console"])
        self.assertTrue(value["runtime_repair"]["first_console_return_checkpoint_only"])
        self.assertFalse(value["runtime_repair"]["console_body_changed"])

    def test_observer_and_source_closure_are_p334(self) -> None:
        ...
        self.assertEqual(
            {
                ...
                "p334_stock_candidate_build",
                "p334_stock_process_v2_adapter",
            }
