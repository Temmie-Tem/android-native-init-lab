...
class NativeAudioProfileScreenV2831Test(unittest.TestCase):
    ...
    def test_menu_and_screenapp_expose_profile_surface(self) -> None:
        ...
        for marker in [
            ...
            "screenapp [network|wifi-status|wifi-profiles|wifi-scan|wifi-ping|wsta|audio-status|audio-profile|audio-stages|audio-map|audio-chime|about-version|about-changelog]",
        ]:
            with self.subTest(marker=marker):
