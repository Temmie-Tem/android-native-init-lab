#!/usr/bin/env python3
"""Focused tests for the P2.94 Process-v2 ready-manifest adapter."""
...
import prepare_s22plus_fyg8_p294_ready_manifest as builder  # noqa: E402
import s22plus_fyg8_p294_telemetry_decoder as decoder  # noqa: E402
import s22plus_fyg8_p294_telemetry_model as model  # noqa: E402


class P294ReadyManifestBuilderTest(unittest.TestCase):
    def fixture(self):
        builder._configure()
        run_id = "12" * 16
        run_manifest = {
            ...
            "records": {
                ...
                "terminal_stage": evidence._latest_stage_terminal(
                    decoder, "E2"
                ),
            },
    ...
    def test_derives_exact_p294_acceptance_and_observer(self) -> None:
        ...
        self.assertEqual(
            acceptance["source_contract_id"], builder.SOURCE_CONTRACT_ID
        )
    ...
    def test_defaults_are_p294_scoped_and_verify_only_is_preserved(self) -> None:
        ...
        for value in (
            ...
            self.assertIn("p294", value.as_posix())
