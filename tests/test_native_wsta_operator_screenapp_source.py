...
class NativeWstaOperatorScreenappSourceTests(unittest.TestCase):
    ...
    def test_wsta_screen_content_points_to_host_runner_not_native_public_action(self) -> None:
        ...
        self.assertIn("FLOW WSTA45 -> WSTA43 -> WSTA42", block)
        self.assertIn("PUBLISH: HOST RUNBOOK ONLY", block)
        self.assertIn("NATIVE MENU: DISPLAY-ONLY NO CONNECT", block)
        self.assertIn("AGGREGATE: WSTA48 REDACTED RESULT", block)
        ...
        self.assertNotIn("tunnel", block.lower())
