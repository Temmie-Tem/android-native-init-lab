"""Tests for the V2780 audio stage module live validation runner."""
...
RUNNER = REPO / "workspace/public/src/scripts/revalidation/native_audio_stage_module_device_validation_handoff_v2780.py"
...
class NativeAudioStageModuleDeviceValidationV2780(unittest.TestCase):
    ...
    def test_runner_validates_prereq_markers(self) -> None:
        ...
        for marker in [
            ...
            "v2780-audio-stage-module-device-pass",
        ]:
