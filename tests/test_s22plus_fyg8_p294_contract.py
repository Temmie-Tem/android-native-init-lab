...
class P294ContractTest(unittest.TestCase):
    def test_selector_and_retirement(self) -> None:
        ...
        reachable = selected.validate_reachable_records(bytes.fromhex("22" * 16))
        self.assertEqual(reachable["telemetry_reachable_variants"], 165)
        self.assertEqual(reachable["reachable_slot_variants"], p294.REACHABLE_VARIANTS)
