...
int main(int argc,char **argv) {
 ...
 if(!child){close(pair[0]);assert(dup2(pair[1],1)==1);close(pair[1]);_exit(status_collect("c379f1e0a90b5e6d7c8a9b0c1d2e3f0b"));}
...
class StatusMetricsV3(unittest.TestCase):
