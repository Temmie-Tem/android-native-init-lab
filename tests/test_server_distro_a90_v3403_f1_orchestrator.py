...
class DisplayObservationTests(unittest.TestCase):
    ...
    def test_h4_first_boot_contract_binds_new_markers_and_rootfs(self) -> None:
        binding = {
            "schema": "a90-compiled-auto-handoff-binding-v1",
            "candidate_version": "0.11.172",
            "candidate_build": "phase3-minimal-h4-observer-complete-auto-benchmark",
            "image_path": "/mnt/sdext/a90/runtime/rootfs-11.img",
            "image_sha256": "c" * 64,
        ...
        changed = copy.deepcopy(contract)
        changed["latch_path"] = "/cache/a90-auto-handoff-phase3-minimal-h3.done"
        with self.assertRaisesRegex(
            f1.ContractError,
            "compiled candidate/rootfs binding",
        ):
    ...
    def test_h5_first_boot_contract_binds_fresh_markers_and_rootfs(self) -> None:
        binding = {
            "schema": "a90-compiled-auto-handoff-binding-v1",
            "candidate_version": "0.11.173",
            "candidate_build": "phase3-minimal-h5-fresh-campaign-auto-benchmark",
            "image_path": "/mnt/sdext/a90/runtime/rootfs-12.img",
            "image_sha256": "d" * 64,
        ...
        changed = copy.deepcopy(contract)
        changed["latch_path"] = "/cache/a90-auto-handoff-phase3-minimal-h4.done"
        with self.assertRaisesRegex(
            f1.ContractError,
            "compiled candidate/rootfs binding",
        ):
    ...
    def test_h6_first_boot_contract_binds_fresh_markers_and_rootfs(self) -> None:
        binding = {
            "schema": "a90-compiled-auto-handoff-binding-v1",
            ...
            "image_path": "/mnt/sdext/a90/runtime/rootfs-14.img",
            "image_sha256": "e" * 64,
    ...
    def test_h7_first_boot_contract_binds_fresh_markers_and_rootfs(self) -> None:
        binding = {
            "schema": "a90-compiled-auto-handoff-binding-v1",
            ...
            "image_path": "/mnt/sdext/a90/runtime/rootfs-15.img",
            "image_sha256": "f" * 64,
    ...
    def test_fast_receipt_first_boot_contract_binds_exact_namespace(self) -> None:
        for version, build in f1.FAST_SOURCE_RECEIPT_IDENTITIES:
            ...
            generation = {
                ...
                f1.H13_FAST_SOURCE_RECEIPT_IDENTITY: "h13",
            }[identity]
            binding = {
