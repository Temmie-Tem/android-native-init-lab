"""Regression tests for V3371 server-distro D3B switch_root source build."""
...
builder = load_script(
    "workspace/public/src/scripts/revalidation/build_native_init_boot_v3371_server_distro_switchroot_devprep.py"
)


class BuildNativeInitBootV3371ServerDistroSwitchrootTests(unittest.TestCase):
    def test_builder_identity_and_required_markers(self) -> None:
        self.assertEqual(builder.CYCLE, "V3371")
        self.assertEqual(builder.INIT_VERSION, "0.11.132")
        self.assertEqual(builder.INIT_BUILD, "v3371-server-distro-switchroot-devprep")
