...
class P298ReadyManifestBuilderTest(unittest.TestCase):
    ...
    def test_configuration_is_restored_after_success_and_exception(self) -> None:
        original = builder.base.SOURCE_CONTRACT_ID
        with builder._configuration_context():
            self.assertEqual(
                builder.base.SOURCE_CONTRACT_ID, builder.SOURCE_CONTRACT_ID
            )
        self.assertEqual(builder.base.SOURCE_CONTRACT_ID, original)
