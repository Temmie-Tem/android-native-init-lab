...
class CampaignLedgerTaxonomyTest(unittest.TestCase):
    ...
    def test_review_label_counts_are_not_unresolved_review_debt(self):
        ...
        # pending topics are 33, 35 and 36; the inactive pre-F1 policy is
        # independently reviewed while its coordinator remains review-pending;
        ...
        self.assertEqual(
            ...
            [
                ...
                "h0-pref1-autonomous-coordinator-1",
        ...
        self.assertEqual(current["total"], 63)
        self.assertEqual(current["resolved_count"], 45)
        self.assertEqual(current["unresolved_count"], 18)
        self.assertEqual(
            [item["review_topic"] for item in current["resolved"][-3:]],
            [
                "d1-fresh-baseline-raw-first-successor",
                "d0-fresh-baseline-v2-repin",
                "pref1-autonomous-policy",
            ],
        )
        self.assertEqual(
            [
    ...
    def _assert_topic_29_resolution_is_scoped(self):
        ...
        self.assertEqual(len(all_rows), 388)
