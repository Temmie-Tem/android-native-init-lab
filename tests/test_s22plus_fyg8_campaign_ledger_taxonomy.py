...
class CampaignLedgerTaxonomyTest(unittest.TestCase):
    ...
    def test_review_label_counts_are_not_unresolved_review_debt(self):
        ...
        self.assertEqual(
            current["resolved"][-1],
            {
                ...
                "review_topic": "process-v2-prepared-runtime-bound-repair",
                "pending_ordinal": "h0-process-v2-prepared-runtime-bound-repair-53",
                "pending_action": (
                    "P319_PREPARED_RUNTIME_BOUND_REPAIR_"
                    "IMPLEMENTED_REVIEW_PENDING"
                ),
                "resolution_ordinal": (
                    "h0-process-v2-prepared-runtime-bound-repair-review-53"
                ),
                "resolution_action": (
                    "PASS_GO_P319_PREPARED_RUNTIME_BOUND_REPAIR_"
                    "H0_CAPABILITY_V1"
                ),
            },
        )
    ...
    def _assert_topic_29_resolution_is_scoped(self):
        ...
        self.assertEqual(len(all_rows), 445)
