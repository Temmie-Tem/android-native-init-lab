...
class CampaignLedgerTaxonomyTest(unittest.TestCase):
    ...
    def test_review_label_counts_are_not_unresolved_review_debt(self):
        ...
        # V2 successor are independently reviewed; older pending topics remain
        # explicit rather than inferred from labels.
        self.assertEqual(
        ...
        self.assertEqual(current["total"], 68)
    ...
    def _assert_topic_29_resolution_is_scoped(self):
        ...
        self.assertEqual(len(all_rows), 406)
