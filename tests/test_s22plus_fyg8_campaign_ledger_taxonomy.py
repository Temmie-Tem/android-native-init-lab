...
class CampaignLedgerTaxonomyTest(unittest.TestCase):
    ...
    def test_review_label_counts_are_not_unresolved_review_debt(self):
        ...
        # pending topics are 33, 35 and 36; the inactive pre-F1 policy and its
        # coordinator are independently reviewed without activation;
        ...
        self.assertEqual(
            ...
            [
                ...
                "h0-d1-fresh-baseline-canonical-arm-v3-1",
        ...
        self.assertEqual(current["total"], 64)
        self.assertEqual(current["resolved_count"], 46)
    ...
    def _assert_topic_29_resolution_is_scoped(self):
        ...
        self.assertEqual(len(all_rows), 391)
