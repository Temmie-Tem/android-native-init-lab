...
class CampaignLedgerTaxonomyTest(unittest.TestCase):
    ...
    def test_review_label_counts_are_not_unresolved_review_debt(self):
        ...
        # registration, and the post-registration prerequisite/integration
        # repin are independently reviewed; the P319 candidate-static unit is
        # pending review; older pending topics remain explicit rather than
        # inferred from prose.
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            [
                ...
                "h0-process-v2-candidate-static-50",
        ...
        self.assertEqual(current["total"], 73)
        self.assertEqual(current["resolved_count"], 55)
        ...
        self.assertEqual(
            current["resolved"][-1],
            {
                ...
                "review_topic": "process-v2-post-registration-repin",
                "pending_ordinal": "h0-process-v2-post-registration-repin-49",
                "pending_action": (
                    "P319_PROCESS_V2_POST_REGISTRATION_REPIN_"
                    "IMPLEMENTED_REVIEW_PENDING"
                ),
                "resolution_ordinal": (
                    "h0-process-v2-post-registration-repin-review-49"
                ),
                "resolution_action": (
                    "PASS_GO_P319_PROCESS_V2_POST_REGISTRATION_REPIN_"
                    "H0_CAPABILITY_V1"
                ),
            },
        )
    ...
    def _assert_topic_29_resolution_is_scoped(self):
        ...
        self.assertEqual(len(all_rows), 418)
