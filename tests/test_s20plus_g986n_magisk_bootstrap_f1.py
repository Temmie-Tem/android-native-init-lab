...
class S20BootstrapF1Tests(unittest.TestCase):
    ...
    def test_documents_activate_f1_after_endpoint_session_review(self):
        ...
        row = "| Samsung Galaxy S20+ 5G (`SM-G986N` / `y2q` / `G986NKSS8IYC2`) | `GOAL_S20PLUS.md` | `docs/operations/targets/S20PLUS_G986N_TARGET_CONTRACT.md` | Active exact-target routine D0/D1 including payload-free Download return; attended fixed root-health D0 active; attended boot-only bootstrap and resident Magisk F1 active; reviewed attended native-canary R1 active |"
