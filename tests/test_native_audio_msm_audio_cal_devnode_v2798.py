"""Tests for the V2798 audio msm_audio_cal devnode fix."""
...
LIVE = REPO / "workspace/public/src/scripts/revalidation/native_audio_msm_audio_cal_devnode_live_handoff_v2798.py"


def load_live_module():
    sys.path.insert(0, str(LIVE.parent))
    spec = importlib.util.spec_from_file_location("v2798_live", LIVE)
...
class NativeAudioMsmAudioCalDevnodeV2798(unittest.TestCase):
    @classmethod
    ...
    def test_builder_uses_v2798_patch_artifact_identity(self) -> None:
        ...
        self.assertIn('"msm_audio_cal_devnode_compiled": True', text)
