"""Real authenticated prefix/replay and durable P354 dispatch-only evidence."""
import copy
import hashlib
import io
import json
...
class Fixture(_ReceiptFixture):
    def __init__(self, run_dir):
        super().__init__(run_dir, variant='p354')
    ...
    def _session(self, ordinal):
        ...
        rx.extend(self._frame(r.FRAME_BOOT_ID,r.P335_BOOT_ID_SEQUENCE,BOOT_ID+self.codec.compute_boot_id_tag(KEY,r.P354_RUN_ID,nonce,BOOT_ID)))
        ...
        tx=bytearray(self._frame(r.FRAME_OPEN,0,r.P354_RUN_ID))
    ...
    def _receipt_value(self):
        ...
        v.pop('p354_readonly_research_shell_qualification')
        ...
        path=self.run_dir/'p354-candidate-end.raw.json'
        ...
        v['p354_closure_snapshot']=dict(path=str(path),**receipt,capture_complete=True,
...
class DispatchTests(unittest.TestCase):
    ...
    def test_host_close_error_does_not_lose_written_dispatch(self):
        ...
        session.namespace='p354';session.auth_runtime=self.f.runtime
    ...
    def test_closure_snapshot_is_required_and_hash_bound(self):
        ...
        value['p354_closure_snapshot']['sha256']='0'*64
    ...
    def test_snapshot_failure_is_recorded_without_fake_continuity(self):
        ...
        snapshot=value['p354_closure_snapshot']
        self.assertTrue(value['display_request_dispatched'])
    ...
    def test_real_preparation_entry_applies_settings_before_main(self):
        ...
        import prepare_s22plus_fyg8_p354_process_v2 as preparation
        static_path=root/'workspace/private/outputs/s22plus_fyg8_p354/process-v2-candidate-static-20260907-01.json'
