...
class DpublicSmokeHelperTests(unittest.TestCase):
    ...
    def test_wifi_sta_helper_is_opt_in_and_redacted(self) -> None:
        ...
        self.assertIn("sample_regulatory_state \"immediate_before_link_up\"", source)
        self.assertIn("sample_regulatory_state \"immediate_after_link_up\"", source)
        ...
        self.assertIn("wifi-sta-immediate-snapshot-scan-failed", source)
