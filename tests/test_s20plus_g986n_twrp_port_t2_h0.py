...
SPEC = importlib.util.spec_from_file_location(
    "s20plus_g986n_twrp_port_t2_h0_tested", SCRIPT
)
...
EXPECTED = {
    "builder": "505f4fabc5e9684464b3c266453734db9e5f089507576df5dac00785683e635d",
    "candidate/AP.tar.md5": "6d10b3154f2e899ee64305f3f3279d7d5243eb917f1fedb413b8f88d22ec88cb",
    "candidate/recovery.img": "d46a1f72743a28acc4c820184d7318df9801ee43d425c22d092778e4b63d1f89",
    "candidate/recovery.img.lz4": "6fed66d26ff7cc75899c4471ab60eefb49bccff052de37043bced65719b65936",
    ...
    "manifest.json": "80622cf532e0a846c1825a847449d5bdc7a9226bb1b61e068046ecb5851d1d48",
}
...
class S20PlusTwrpPortT2H0Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        ...
        cls._temporary = tempfile.TemporaryDirectory(
            prefix="s20plus-twrp-port-t2-tests-", dir=private_test_root
        )
    ...
    def test_stock_avb_passes_and_port_hash_failure_is_explicit(self) -> None:
        ...
        self.assertEqual(
            avb["candidate_runtime_acceptance"], "UNKNOWN_REQUIRES_T2_FIRST_ATTEMPT"
        )
