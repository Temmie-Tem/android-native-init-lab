...
_source=_source.replace('p375','p377').replace('P375','P377').replace('test_s22plus_fyg8_p377_console_integration','test_s22plus_fyg8_p377_hud_integration')
...
P377LiveReceiptTests.setUpClass=setup
...
P377LiveReceiptTests.test_changed_hud_claim_cannot_replace_raw_frames=changed_hud_claim
