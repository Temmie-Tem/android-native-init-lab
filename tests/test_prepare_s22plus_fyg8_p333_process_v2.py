...
import prepare_s22plus_fyg8_p333_process_v2 as prepare  # noqa: E402


class P333PrepareTests(unittest.TestCase):
    @classmethod
    ...
    def test_manifest_binds_existing_logical_role_and_stage_zero(self) -> None:
        ...
        self.assertEqual(
            ...
            evidence.P333_STOCK_OVERLAY_CONTRACT_ID,
        )
    ...
    def test_promotion_and_offline_verification_are_p333(self) -> None:
        self.assertEqual(
        ...
        self.assertEqual(run_manifest["schema"], evidence.P333_RUN_MANIFEST_SCHEMA)
        self.assertEqual(
            run_manifest["observation_contract"]["accepted_identity"],
            "P333_STOCK_OBSERVER_V4_RETAINED",
        )
        self.assertEqual(static_check["schema"], evidence.P333_STATIC_RESULT_SCHEMA)
        self.assertEqual(static_check["verdict"], evidence.P333_STATIC_RESULT_VERDICT)
        self.assertEqual(
            self.verification["schema"],
            "device_action_f1_p333_stock_offline_contract_v1",
        )
    ...
    def test_defaults_are_one_exact_host_only_package(self) -> None:
        ...
        self.assertEqual(
            ...
            "s22plus-fyg8-p333-process-v2-ready-1",
        )
        self.assertEqual(
            prepare.DEFAULT_LIVE_RUN_ID,
            "s22plus-fyg8-p333-live-1",
        )
        self.assertEqual(
    ...
    def test_execution_source_round_trip_and_cross_wire_reject(self) -> None:
        ...
        changed["p333_open_entry_diag_runtime"]["sha256"] = "0" * 64
