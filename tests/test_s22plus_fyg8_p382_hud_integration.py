"""P382 uses the unchanged P381 hud integration corpus with fresh identity."""
from pathlib import Path
import ast
_source=Path(__file__).with_name('test_s22plus_fyg8_p381_hud_integration.py').read_text()
