...
SCRIPT = Path("workspace/public/src/scripts/revalidation/analyze_s22plus_m34_s9_result.py")
...
def load_module():
    ...
    spec = importlib.util.spec_from_file_location("analyze_s22plus_m34_s9_result", SCRIPT)
...
class AnalyzeS22PlusM34S9ResultTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_cli_write_report_writes_analysis_json(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            report = json.loads((run_dir / "s22plus_m34_s9_result_analysis.json").read_text(encoding="utf-8"))
