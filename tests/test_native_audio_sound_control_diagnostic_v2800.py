"""Tests for the V2800 audio sound-control diagnostic runner."""
...
LIVE = REPO / "workspace/public/src/scripts/revalidation/native_audio_sound_control_diagnostic_live_handoff_v2800.py"


def load_live_module():
    sys.path.insert(0, str(LIVE.parent))
    spec = importlib.util.spec_from_file_location("v2800_live", LIVE)
...
class NativeAudioSoundControlDiagnosticV2800(unittest.TestCase):
    @classmethod
    ...
    def test_live_runner_targets_v2799_and_allowed_manifest_path(self) -> None:
        ...
        self.assertEqual(module.CYCLE, "V2800")
        ...
        self.assertIn("NATIVE_INIT_V2800_AUDIO_SOUND_CONTROL_DIAGNOSTIC_LIVE_2026-06-19.md", str(module.REPORT_PATH))
        self.assertEqual(
