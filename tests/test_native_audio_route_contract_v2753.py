...
class NativeAudioRouteContractV2753(unittest.TestCase):
    def test_route_command_is_exposed_as_named_audio_api(self) -> None:
        ...
        self.assertIn('usage: audio route [profile] [--dry-run|--apply|--reset] [--layer all|core|feedback|endpoint|playback|blocked]', text)
        self.assertIn('route [profile] [--dry-run|--apply|--reset] [--layer all|core|feedback|endpoint|playback|blocked]', text)
