"""Real P357-bound Carrier encoder and decoder; supplemental evidence only."""
import copy
import json
...
import s22plus_fyg8_p357_stock_process_v2_adapter as adapter
...
class CarrierTests(unittest.TestCase):
    def test_all_terminal_states_roundtrip_without_visual_promotion(self):
        ...
        for state in ('COMPLETE','INCOMPLETE','AMBIGUOUS'):
            ...
            self.assertEqual(value['p357_stock'][0]['state'],state)
    ...
    def test_wrong_run_corrupt_carrier_and_detail_state_are_rejected(self):
        ...
        mismatch=parser._carrier_record_from_envelope(envelope,detail=parser.STOCK_DETAIL_INCOMPLETE,run_id=adapter.P357_RUN_ID)
