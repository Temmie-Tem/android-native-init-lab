...
_source=_source.replace('p375','p381').replace('P375','P381').replace('test_s22plus_fyg8_p381_console_integration','test_s22plus_fyg8_p381_hud_integration')
...
P381LiveReceiptTests.setUpClass=setup
...
P381LiveReceiptTests.test_changed_hud_claim_cannot_replace_raw_frames=changed_hud_claim
