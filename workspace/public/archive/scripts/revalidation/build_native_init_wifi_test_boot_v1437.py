#!/usr/bin/env python3
"""Build the V1437 Wi-Fi test boot artifact with immediate endpoint sampling."""
...
OUT_DIR = base.REPO_ROOT / "tmp" / "wifi" / "v1437-wifi-test-boot-immediate-endpoint-sampler"

DEFAULT_ARGS = [
    "--cycle",
    "V1437",
    "--decision",
    "v1437-wifi-test-boot-immediate-endpoint-source-build-pass",
    "--cycle-label",
    "v1437",
    "--init-version",
    "0.9.80",
    ...
    str(OUT_DIR),
    "--init-binary",
    str(OUT_DIR / "init_v1437_wifi_test"),
    "--ramdisk-cpio",
    str(OUT_DIR / "ramdisk_v1437_wifi_test.cpio"),
    "--boot-image",
    str(OUT_DIR / "boot_linux_v1437_wifi_test.img"),
    "--wifi-test-klog-prefix",
    "A90v1437",
    "--wifi-test-disable",
    "/cache/native-init-wifi-test-boot-v1437.disable",
    "--wifi-test-log",
