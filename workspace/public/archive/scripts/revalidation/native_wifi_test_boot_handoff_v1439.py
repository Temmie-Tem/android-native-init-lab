#!/usr/bin/env python3
"""V1439 bounded live handoff for the V1437 immediate endpoint-sampler Wi-Fi test boot."""
...
DEFAULT_ARGS = [
    ...
    "V1439",
    "--out-dir",
    str(base.REPO_ROOT / "tmp" / "wifi" / "v1439-wifi-test-boot-immediate-endpoint-handoff"),
    "--report-path",
    str(
        base.REPO_ROOT
        / "docs"
        / "reports"
        / "NATIVE_INIT_V1439_WIFI_TEST_BOOT_IMMEDIATE_ENDPOINT_HANDOFF_2026-06-01.md"
    ),
    "--v1394-manifest",
    str(
        base.REPO_ROOT
        / "tmp"
        / "wifi"
        / "v1438-wifi-test-boot-immediate-endpoint-artifact-sanity"
        / "manifest.json"
    ),
    "--test-image",
    str(
        ...
        / "boot_linux_v1437_wifi_test.img"
    ),
    "--expect-test-version",
    ...
    "--dmesg-grep-pattern",
    (
        "A90v1437|TEST: 11|Assert the reset|Release the reset|PCIE20_PARF_INT_ALL_MASK|"
