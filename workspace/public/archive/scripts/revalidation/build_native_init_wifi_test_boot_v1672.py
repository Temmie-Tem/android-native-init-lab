#!/usr/bin/env python3
"""Build the V1672 native pcie1 clock vote direct-attempt repair test boot artifact."""
...
OUT_DIR = base.REPO_ROOT / "tmp" / "wifi" / "v1672-pcie1-clock-vote-direct-attempt-test-boot"
REPORT_PATH = (
    base.REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1672_PCIE1_CLOCK_VOTE_DIRECT_ATTEMPT_SOURCE_BUILD_2026-06-02.md"
)
...
DEFAULT_ARGS = [
    ...
    "0.9.120",
    "--init-build",
    "v1672-pcie1-clock-vote-direct",
    "--out-dir",
    str(OUT_DIR),
    "--init-binary",
    str(OUT_DIR / "init_v1672_pcie1_clock_vote_direct"),
    "--ramdisk-cpio",
    str(OUT_DIR / "ramdisk_v1672_pcie1_clock_vote_direct.cpio"),
    "--boot-image",
    str(OUT_DIR / "boot_linux_v1672_pcie1_clock_vote_direct.img"),
    "--wifi-test-klog-prefix",
    "A90v1672",
    "--wifi-test-disable",
    "/cache/native-init-wifi-test-boot-v1672.disable",
    "--wifi-test-log",
    "/cache/native-init-wifi-test-boot-v1672.log",
    "--wifi-test-summary",
    "/cache/native-init-wifi-test-boot-v1672.summary",
    "--wifi-test-helper-result",
    "/cache/native-init-wifi-test-boot-v1672-helper.result",
    "--wifi-test-pid",
    "/cache/native-init-wifi-test-boot-v1672.pid",
    "--wifi-test-watcher-pid",
    "/cache/native-init-wifi-test-boot-v1672-supervisor.pid",
    "--wifi-test-rc1-watcher-result",
    "/cache/native-init-wifi-test-boot-v1672-natural-watcher.result",
    "--wifi-test-rc1-window-result",
    "/cache/native-init-wifi-test-boot-v1672-clock-vote-window.result",
    "--wifi-test-watch-sec",
    "55",
    ...
    "/cache/native-init-wifi-test-boot-v1672-pcie1-clock-vote-direct.result",
