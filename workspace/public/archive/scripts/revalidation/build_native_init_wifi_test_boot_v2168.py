#!/usr/bin/env python3
"""Compatibility wrapper for the workspace current V2168 Wi-Fi test-boot builder."""
...
CANONICAL_RELATIVE_PATH = "workspace/public/src/scripts/revalidation/build_native_init_wifi_test_boot_v2168.py"
