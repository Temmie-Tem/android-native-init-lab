#!/usr/bin/env python3
"""V1496 short-hold handoff for V1493 RC1-window Wi-Fi test boot communication isolation."""
...
DEFAULT_ARGS = [
    ...
    "V1496",
    "--out-dir",
    str(base.REPO_ROOT / "tmp" / "wifi" / "v1496-wifi-rc1-window-short-hold-handoff"),
    "--report-path",
    str(
        base.REPO_ROOT
        / "docs"
        / "reports"
        / "NATIVE_INIT_V1496_WIFI_RC1_WINDOW_SHORT_HOLD_HANDOFF_2026-06-01.md"
    ),
    "--v1394-manifest",
    str(
        base.REPO_ROOT
