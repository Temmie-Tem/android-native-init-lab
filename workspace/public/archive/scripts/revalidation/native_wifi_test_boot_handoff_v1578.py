#!/usr/bin/env python3
"""V1578 rollbackable live handoff for the V1577 service-window PM proxy contract devnode test boot."""
...
DEFAULT_ARGS = [
    ...
    "V1578",
    "--out-dir",
    str(base.REPO_ROOT / "tmp" / "wifi" / "v1578-service-window-pm-proxy-contract-devnode-handoff"),
    "--report-path",
    str(
        base.REPO_ROOT
        / "docs"
        / "reports"
        / "NATIVE_INIT_V1578_SERVICE_WINDOW_PM_PROXY_CONTRACT_DEVNODE_HANDOFF_2026-06-02.md"
    ),
    "--v1394-manifest",
    str(
        base.REPO_ROOT
        / "tmp"
        / "wifi"
        / "v1577-service-window-pm-proxy-contract-devnode-artifact-sanity"
        / "manifest.json"
    ),
    "--test-image",
    str(
    ...
    "--dmesg-grep-pattern",
    (
        "A90v1577|android_wifi_service_window|pm_proxy|pm-service|pm_proxy_helper|mdm_helper_launch_contract|"
