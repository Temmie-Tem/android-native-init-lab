#!/usr/bin/env python3
"""Build the V1429 Wi-Fi test boot artifact with endpoint prerequisite sampling."""
...
OUT_DIR = base.REPO_ROOT / "tmp" / "wifi" / "v1429-wifi-test-boot-endpoint-prereq-sampler"

DEFAULT_ARGS = [
    "--cycle",
    "V1429",
    "--decision",
    "v1429-wifi-test-boot-endpoint-prereq-source-build-pass",
    "--cycle-label",
    "v1429",
    "--init-version",
    "0.9.78",
    ...
    str(OUT_DIR),
    "--init-binary",
    str(OUT_DIR / "init_v1429_wifi_test"),
    "--ramdisk-cpio",
    str(OUT_DIR / "ramdisk_v1429_wifi_test.cpio"),
    "--boot-image",
    str(OUT_DIR / "boot_linux_v1429_wifi_test.img"),
    "--wifi-test-klog-prefix",
    "A90v1429",
    "--wifi-test-disable",
    "/cache/native-init-wifi-test-boot-v1429.disable",
    "--wifi-test-log",
