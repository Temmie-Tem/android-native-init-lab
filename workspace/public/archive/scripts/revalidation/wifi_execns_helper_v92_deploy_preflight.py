#!/usr/bin/env python3
"""V567 execns helper v92 deploy/preflight wrapper."""

from __future__ import annotations

import wifi_execns_helper_v91_deploy_preflight as v91


deploy = v91.deploy
deploy.__doc__ = __doc__
deploy.DEFAULT_OUT_DIR = deploy.Path("tmp/wifi/v567-execns-helper-v92-deploy-preflight")
deploy.DEFAULT_LOCAL_HELPER = deploy.Path("tmp/wifi/v567-a90_android_execns_probe-v92/a90_android_execns_probe")
deploy.DEFAULT_HELPER_SHA256 = "e7bf6dade5f5f34c0a7489c7490bf11e0534fb1a4afff66134958f1091b89880"
deploy.DEFAULT_SERIAL_CHUNK_SIZE = 3000
deploy.HELPER_MARKER = "a90_android_execns_probe v92"
deploy.SERVICE_MODE_TOKEN = "wifi-companion-dual-hal-wificond-lshal-then-iwifi-start"
deploy.DEPLOY_LABEL = "v92"
deploy.DEPLOY_NAME = "execns-helper-v92"
deploy.DEPLOY_PLAN_VERSION = "V567"
deploy.DEPLOY_LOG_PREFIX = "v567"
deploy.SUMMARY_TITLE = "v567 Execns Helper v92 Deploy Preflight"
deploy.APPROVAL_PHRASE = (
    "approve v567 deploy execns helper v92 only; "
    "no daemon start and no Wi-Fi bring-up"
)

v91.v90.v89.v88.v87.v86.v85.v84.v83.v82.v81.v80.v79.v78.v77.v76.v66.v62.v61.v60.v59.v58.v57.v56.v33.V33_TOKENS = (
    "a90_android_execns_probe v92",
...
def decide(args: deploy.argparse.Namespace,
    ...
    if args.command == "preflight":
        ...
        next_step = "deploy helper v92, then run V567 hwbinder handle-retain proof" if deploy_needed else "run V567 hwbinder handle-retain proof"
        return f"{deploy.DEPLOY_NAME}-deploy-preflight-ready", True, "preflight complete; helper v92 deploy still requires exact approval", next_step
    if not deploy.approved(args):
        return f"{deploy.DEPLOY_NAME}-deploy-approval-required", True, "exact approval phrase required; no mutation executed", "rerun with exact V567 deploy phrase"
    ...
    return f"{deploy.DEPLOY_NAME}-deploy-pass", True, "helper v92 deployed or already current; V500 preflight was rerun", "run V567 hwbinder handle-retain proof"
