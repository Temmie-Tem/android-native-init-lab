#!/usr/bin/env python3
"""Build V2075 native remote-MDM DIAG bridge query test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2075-remote-mdm-diag-bridge-query-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2075/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v401"
EXPECTED_HELPER_SHA256 = "056f0d21b08384a8278d828723c8efd9ead2365f355185c1365ba046ecd0a130"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2075_REMOTE_MDM_DIAG_BRIDGE_QUERY_SOURCE_BUILD_2026-06-05.md"
)
HELPER_FLAGS = (
    *prev2073.HELPER_FLAGS,
    "-DA90_WIFI_TEST_BOOT_DIAG_REMOTE_DEV_QUERY_PROBE=1",
)
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2075",
        "--init-version": "0.9.216",
        "--init-build": "v2075-remote-mdm-diag-bridge-query",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2075_remote_mdm_diag_bridge_query"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v401_remote_mdm_diag_bridge_query"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2075_remote_mdm_diag_bridge_query.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2075_remote_mdm_diag_bridge_query.img"),
        "--wifi-test-klog-prefix": "A90v2075",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2075.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2075.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2075.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2075-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2075.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2075-supervisor.pid",
