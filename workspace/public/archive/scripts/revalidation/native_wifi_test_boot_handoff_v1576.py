#!/usr/bin/env python3
"""V1576 rollbackable live handoff for the V1575 service-window PM proxy contract test boot."""
...
DEFAULT_ARGS = [
    ...
    "V1576",
    "--out-dir",
    str(base.REPO_ROOT / "tmp" / "wifi" / "v1576-service-window-pm-proxy-contract-handoff"),
    "--report-path",
    str(
        base.REPO_ROOT
        / "docs"
        / "reports"
        / "NATIVE_INIT_V1576_SERVICE_WINDOW_PM_PROXY_CONTRACT_HANDOFF_2026-06-02.md"
    ),
    "--v1394-manifest",
    str(
        base.REPO_ROOT
        / "tmp"
        / "wifi"
        / "v1575-service-window-pm-proxy-contract-artifact-sanity"
        / "manifest.json"
    ),
    "--test-image",
    str(
    ...
    "--dmesg-grep-pattern",
    (
        "A90v1575|android_wifi_service_window|pm_proxy|pm-service|pm_proxy_helper|mdm_helper_launch_contract|"
