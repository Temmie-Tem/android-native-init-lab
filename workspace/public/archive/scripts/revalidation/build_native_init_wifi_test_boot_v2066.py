#!/usr/bin/env python3
"""Build V2066 native query-only WLAN-PD DIAG support test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2066-diag-pd-query-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2066/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v397"
EXPECTED_HELPER_SHA256 = "d2ffd130eca69c11e733ce78306ebcf028fd4a6537b297539847c56588579755"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2066_DIAG_PD_QUERY_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = (
    ...
    "-DA90_WIFI_TEST_BOOT_DIAG_PD_QUERY_PROBE=1",
)
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2066",
        "--init-version": "0.9.212",
        "--init-build": "v2066-diag-pd-query",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2066_diag_pd_query"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v397_diag_pd_query"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2066_diag_pd_query.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2066_diag_pd_query.img"),
        "--wifi-test-klog-prefix": "A90v2066",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2066.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2066.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2066.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2066-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2066.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2066-supervisor.pid",
