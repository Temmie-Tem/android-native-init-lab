#!/usr/bin/env python3
"""Build V2045 native fallback-RFS + persist-RFS + mcfg readback test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2045-fallback-persist-rfs-mcfg-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2045/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v388"
EXPECTED_HELPER_SHA256 = "9a91ef4c6d1fbda9f7ecd73ddd711547a913689c68d6c0e722479f52bee963ea"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2045_FALLBACK_PERSIST_RFS_MCFG_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = (
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2045",
        "--init-version": "0.9.203",
        "--init-build": "v2045-fallback-persist-rfs-mcfg",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2045_fallback_persist_rfs_mcfg"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v388_fallback_persist_rfs_mcfg"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2045_fallback_persist_rfs_mcfg.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2045_fallback_persist_rfs_mcfg.img"),
        "--wifi-test-klog-prefix": "A90v2045",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2045.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2045.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2045.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2045-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2045.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2045-supervisor.pid",
