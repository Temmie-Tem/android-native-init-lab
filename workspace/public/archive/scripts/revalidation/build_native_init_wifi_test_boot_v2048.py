#!/usr/bin/env python3
"""Build V2048 native pre-wlanmdsp RRQ ordering test boot."""
...
OUT_DIR = REPO_ROOT / "tmp" / "wifi" / "v2048-pre-rrq-order-test-boot"
REMOTE_PROPERTY_ROOT = "/mnt/sdext/a90/private-property-v317/v2048/dev/__properties__"
EXPECTED_HELPER_MARKER = "a90_android_execns_probe v389"
EXPECTED_HELPER_SHA256 = "53bad6084b405a2f9ede9ffa9992ae60d18758e637a5741a5b72d6a9fcc1d8b9"
REPORT_PATH = (
    REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2048_PRE_WLANMDSP_RRQ_ORDER_SOURCE_BUILD_2026-06-04.md"
)
HELPER_FLAGS = (
...
def configure_base() -> None:
    ...
    replacements = {
        ...
        "--cycle-label": "v2048",
        "--init-version": "0.9.204",
        "--init-build": "v2048-pre-wlanmdsp-rrq-order",
        "--out-dir": str(OUT_DIR),
        "--init-binary": str(OUT_DIR / "init_v2048_pre_wlanmdsp_rrq_order"),
        "--helper-binary": str(OUT_DIR / "a90_android_execns_probe_v389_pre_rrq_order"),
        "--ramdisk-cpio": str(OUT_DIR / "ramdisk_v2048_pre_wlanmdsp_rrq_order.cpio"),
        "--boot-image": str(OUT_DIR / "boot_linux_v2048_pre_wlanmdsp_rrq_order.img"),
        "--wifi-test-klog-prefix": "A90v2048",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2048.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2048.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2048.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2048-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2048.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2048-supervisor.pid",
