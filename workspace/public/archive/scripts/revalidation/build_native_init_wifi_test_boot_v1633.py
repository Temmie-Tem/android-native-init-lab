#!/usr/bin/env python3
"""Build the V1633 natural-path MDM2AP PID1 IRQ-delta test boot artifact."""
...
OUT_DIR = base.REPO_ROOT / "tmp" / "wifi" / "v1633-natural-path-mdm2ap-irq-summary-test-boot"
REPORT_PATH = (
    base.REPO_ROOT
    / "docs"
    / "reports"
    / "NATIVE_INIT_V1633_NATURAL_PATH_MDM2AP_IRQ_SUMMARY_SOURCE_BUILD_2026-06-02.md"
)
...
DEFAULT_ARGS = [
    ...
    "0.9.113",
    "--init-build",
    "v1633-natural-mdm2ap-irq-summary",
    "--out-dir",
    str(OUT_DIR),
    "--init-binary",
    str(OUT_DIR / "init_v1633_natural_mdm2ap_irq_summary"),
    "--ramdisk-cpio",
    str(OUT_DIR / "ramdisk_v1633_natural_mdm2ap_irq_summary.cpio"),
    "--boot-image",
    str(OUT_DIR / "boot_linux_v1633_natural_mdm2ap_irq_summary.img"),
    "--wifi-test-klog-prefix",
    "A90v1633",
    "--wifi-test-disable",
    "/cache/native-init-wifi-test-boot-v1633.disable",
    "--wifi-test-log",
    "/cache/native-init-wifi-test-boot-v1633.log",
    "--wifi-test-summary",
    "/cache/native-init-wifi-test-boot-v1633.summary",
    "--wifi-test-helper-result",
    "/cache/native-init-wifi-test-boot-v1633-helper.result",
    "--wifi-test-pid",
