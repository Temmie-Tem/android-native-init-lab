...
static const struct shell_command command_table[] = {
    ...
    { "helpers", handle_helpers, "helpers [status|verbose|path <name>|verify [name]]", CMD_NONE },
...
static void shell_loop(void) {
    ...
    while (1) {
        ...
        if (auto_menu_is_active() && a90_controller_is_hide_word(argv[0])) {
