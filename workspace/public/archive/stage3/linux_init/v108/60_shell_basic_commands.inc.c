...
static void cmd_help(void) {
    ...
    a90_console_printf("wifiinv [summary|full|paths]\r\n");
    a90_console_printf("wififeas [summary|full|gate|paths]\r\n");
    ...
    a90_console_printf("helpers [status|verbose|path <name>|verify [name]]\r\n");
    ...
    a90_console_printf("rshell [status|start|stop|enable|disable|token [show]|rotate-token [value]]\r\n");
