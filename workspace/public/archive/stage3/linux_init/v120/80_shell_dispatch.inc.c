...
static const struct shell_command command_table[] = {
    ...
    { "wifiinv", handle_wifiinv, "wifiinv [summary|full|paths]", CMD_NONE, A90_CMD_GROUP_NETWORK },
    { "wififeas", handle_wififeas, "wififeas [summary|full|gate|paths]", CMD_NONE, A90_CMD_GROUP_NETWORK },
    ...
    { "netservice", handle_netservice, "netservice [status|start|stop|enable|disable]", CMD_DANGEROUS, A90_CMD_GROUP_NETWORK },
    ...
    { "service", handle_service, "service [list|status|start|stop|enable|disable] [name]", CMD_NONE, A90_CMD_GROUP_SERVICE },
