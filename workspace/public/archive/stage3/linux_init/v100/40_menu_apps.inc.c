/* Included by stage3/linux_init/init_v100.c. Do not compile standalone. */
...
static void boot_auto_frame(void) {
    if (a90_kms_begin_frame(0x000000) == 0) {
        ...
        if (a90_kms_present("bootframe", true) == 0) {
            klogf("<6>A90v100: boot splash applied\n");
        ...
        klogf("<6>A90v100: boot splash skipped (%d)\n", saved_errno);
        if (!boot_splash_recorded) {
            boot_splash_recorded = true;
...
static int draw_screen_display_test_page(unsigned int page_index) {
    ...
    if (page_index == 0) {
        ...
        for (index = 1; index <= 8; ++index) {
            ...
            snprintf(line, sizeof(line), "SCALE %u ABC123 0.9.0", row_scale);
...
static int draw_screen_changelog_v0830(void) {
    const char *lines[] = {
        "0.9.0 v100 REMOTE SHELL",
        "Adds /bin/a90_rshell helper",
        "Adds rshell shell command",
        "Token auth required by default",
        "Runs only over USB NCM path",
        "Serial ACM remains rescue path",
    };

    return draw_screen_about_lines("CHANGELOG / 0.9.0", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0829(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.29", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0828(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.28", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0827(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.27", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0826(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.26", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0825(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.25", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0824(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.24", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0823(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.23", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0822(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.22", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0821(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.21", lines, SCREEN_MENU_COUNT(lines));
}
...
static int draw_screen_changelog_v0820(void) {
    ...
    return draw_screen_about_lines("CHANGELOG / 0.8.20", lines, SCREEN_MENU_COUNT(lines));
}
