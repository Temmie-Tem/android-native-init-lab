/*
 * P3.45 H0 fixed read-only ash child boundary.
 *
 ...
 * It is H0 design/validation material, not an F1 or device authority.
 */
...
static long p345_setup_view(void) {
    ...
    /* The only executable in the view is the fixed static BusyBox bind. */
    return sys_mount(
        NULL,
        P345_ROOT_TMPFS,
        NULL,
...
#define P345_O_WRITE_MASK \
    (P345_O_WRONLY | P345_O_RDWR | P345_O_CREAT | P345_O_TRUNC | \
     P345_O_APPEND | P345_O_TMPFILE)
...
static struct p345_sock_filter p345_filter[] = {
    ...
    /* Read-only openat: reject write/create/truncate/append/tmpfile flags. */
    {P345_BPF_JMP_JEQ_K, 0, 3, P345_NR_OPENAT},
    {P345_BPF_LD_W_ABS, 0, 0, P345_SECCOMP_ARG2_OFFSET},
    {P345_BPF_JMP_JSET_K, 1, 0, P345_O_WRITE_MASK},
    {P345_BPF_RET_K, 0, 0, P345_SECCOMP_RET_ALLOW},
    {P345_BPF_LD_W_ABS, 0, 0, P345_SECCOMP_NR_OFFSET},
