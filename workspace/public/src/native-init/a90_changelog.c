...
static const struct a90_changelog_entry changelog_entries[] = {
    ENTRY("0.10.19 v2859", "AUDIO CHANGELOG LATEST REFRESH",
          "0.10.19 v2859 AUDIO CHANGELOG LATEST REFRESH",
          "Adds 0.10.16 through 0.10.19 audio productization entries",
          "Refreshes audio status latest-evidence markers for V2860 validation",
          "Keeps ABOUT changelog aligned with the device-visible audio surface",
          "Adds no mixer, PCM, SET-cal, route, or smart-amp writes"),
    ENTRY("0.10.18 v2857", "AUDIO LATEST MARKER REFRESH",
          "0.10.18 v2857 AUDIO LATEST MARKER REFRESH",
          "Refreshes audio status latest evidence to V2855 and V2856",
          "Reports latest chime and stop-execute validation provenance",
          "Revalidates audio status, selftest, and screenapp markers in V2858",
          "Keeps playback behavior unchanged"),
    ENTRY("0.10.17 v2853", "AUDIO MARKER REFRESH",
          "0.10.17 v2853 AUDIO MARKER REFRESH",
          "Refreshes productization and changelog status markers",
          "Carries the V2851 changelog/about display validation evidence",
          "Revalidates latest-candidate chime and stop-execute behavior",
          "Keeps bundled SET-cal and route behavior unchanged"),
    ENTRY("0.10.16 v2851", "AUDIO CHANGELOG PRODUCTIZATION",
          "0.10.16 v2851 AUDIO CHANGELOG PRODUCTIZATION",
          "Adds latest audio changelog entries and direct ABOUT screenapps",
          "Exposes screenapp about-version and about-changelog",
          "Keeps productization status markers read-only",
          "Performs no ADSP, route, SET-cal, PCM, or smart-amp write"),
