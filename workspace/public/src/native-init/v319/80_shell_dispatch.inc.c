...
static const struct shell_command command_table[] = {
    ...
    { "video", handle_video, "video [status|frame [bars|checker|mono|0xRRGGBB]|anim [bars|checker|pulse] [frames] [delay_ms]|blitbench [frames]]", CMD_NONE, A90_CMD_GROUP_DISPLAY },
