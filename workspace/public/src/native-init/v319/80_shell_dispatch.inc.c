...
static const struct shell_command command_table[] = {
    ...
    { "video", handle_video, "video [status|frame [bars|checker|mono|0xRRGGBB]|anim [bars|checker|pulse] [frames] [delay_ms]|blitbench [frames]|flipprobe [frames]|stream --manifest PATH --video-only [--frames N] [--present setcrtc|pageflip] [--sync-audio-status PATH]|cache [status|verify|play] SHA256]", CMD_NONE, A90_CMD_GROUP_DISPLAY },
