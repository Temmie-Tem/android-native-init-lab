...
static void cmd_help(void) {
    ...
    a90_console_printf("video [status|frame|demo badapple|demo nyan|demo doom [status|verify|play|engine-probe] [frames] [--wad runtime-private --sha256 EXPECTED]|anim|blitbench|stream --manifest PATH --video-only|cache [status|verify|play] SHA256 [--trust-cache] [--layout full|player-hud]|cache preset [badapple|badapple-scale|nyan] [status|verify|play]]\r\n");
    ...
    a90_console_printf("doompad [status|reset|key <role> <0|1>|tap <role>]\r\n");
