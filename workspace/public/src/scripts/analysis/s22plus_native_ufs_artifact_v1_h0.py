"""Qualify the fixed UFS profile while preserving the historical V3 exporter."""
...
def qualify(namespace,output,*,key_path,build_directory=None):
    ...
    require(catalog.research_profile(selected)=='thermal-v3-reconnect-ufs-v1','runtime is outside UFS scope')
    ...
    image=dict(schema='s22plus-native-image-v3',namespace=namespace,run_id_hex=selected.IDENTITY.run_id_hex,
        profile='thermal-v3-reconnect-ufs-v1',version=selected.IDENTITY.display_version,
