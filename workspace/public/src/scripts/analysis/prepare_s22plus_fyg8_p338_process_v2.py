...
DEFAULT_PROMOTION = ROOT / (
    "workspace/private/outputs/s22plus_fyg8_p338/process-v2-promotion-20260905-03"
)
DEFAULT_MANIFEST = ROOT / (
    "workspace/public/src/device-action/manifests/s22plus_fyg8_p338_process_v2_ready_3.json"
)
DEFAULT_TARGET_PROFILE = ROOT / "workspace/public/src/device-action/profiles/s22plus_fyg8.json"
DEFAULT_MANIFEST_ID = "s22plus-fyg8-p338-process-v2-ready-3"
DEFAULT_LIVE_RUN_ID = "s22plus-fyg8-p338-live-3"
