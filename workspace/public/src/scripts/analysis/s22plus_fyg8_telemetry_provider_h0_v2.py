...
SOURCE=ROOT/'workspace/public/src/kernel-modules/s22plus_max77705_telemetry_v2'
...
IMAGE=ROOT/'workspace/private/outputs/s22plus-fyg8-v0.1.2-rc.1/candidate-build-final2/inputs/fixed-Image'
IMAGE_SHA='45ca04ed855b767085f2ea813216e2a9f0b593d79fd065469f0c1a6e5831dcbd'
DEFAULT=ROOT/'workspace/private/outputs/s22plus-telemetry-provider-qualified-v5-diagnostic'
...
def build(out):
    ...
    inputs=source_paths+[PREPARED/'.config',PREPARED/'Module.symvers',COMMAND,
        kernel/'include/linux/mfd/max77705-private.h',kernel/'kernel/params.c',Path(linkage.__file__),Path(__file__)]
