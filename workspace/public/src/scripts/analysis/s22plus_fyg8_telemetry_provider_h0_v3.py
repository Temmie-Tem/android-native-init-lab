...
SOURCE=ROOT/'workspace/public/src/kernel-modules/s22plus_max77705_telemetry_v3'
...
DEFAULT=ROOT/'workspace/private/outputs/s22plus-telemetry-provider-qualified-v6-model'
