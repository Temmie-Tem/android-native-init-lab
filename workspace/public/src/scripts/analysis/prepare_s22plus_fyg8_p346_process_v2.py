#!/usr/bin/env python3
"""P346 promotion and ready-manifest preparation; no connected action."""
...
_template = _template.replace(b"p346_process_v2_ready_2", b"p346_process_v2_ready_1")
_template = _template.replace(b"p346-process-v2-ready-2", b"p346-process-v2-ready-1")
_template = _template.replace(b"p346-live-2", b"p346-live-1")
