...
_progress_base_sources=source_files

def source_files():
    value=_progress_base_sources()
    for p in (runtime.DIAGNOSTIC_SOURCE,ROOT/'workspace/public/src/scripts/revalidation/s22plus_fyg8_p364_progress.py'):
