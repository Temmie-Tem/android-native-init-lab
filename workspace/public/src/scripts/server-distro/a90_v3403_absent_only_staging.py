...
EXPECTED_MINIMAL_F_RESIDENT_VERSION = "0.11.167"
EXPECTED_MINIMAL_F_RESIDENT_BUILD = "phase3-minimal-f-power-recovery-ui"
EXPECTED_MINIMAL_G_RESIDENT_VERSION = "0.11.168"
EXPECTED_MINIMAL_G_RESIDENT_BUILD = "phase3-minimal-g-server-core"
EXPECTED_MINIMAL_H2_RESIDENT_VERSION = "0.11.170"
EXPECTED_MINIMAL_H2_RESIDENT_BUILD = "phase3-minimal-h2-two-phase-auto-benchmark"
EXPECTED_MINIMAL_H3_RESIDENT_VERSION = "0.11.171"
EXPECTED_MINIMAL_H3_RESIDENT_BUILD = (
    "phase3-minimal-h3-exact-binding-auto-benchmark"
)
EXPECTED_MINIMAL_H4_RESIDENT_VERSION = "0.11.172"
EXPECTED_MINIMAL_H4_RESIDENT_BUILD = (
    "phase3-minimal-h4-observer-complete-auto-benchmark"
)
EXPECTED_MINIMAL_H5_RESIDENT_VERSION = "0.11.173"
EXPECTED_MINIMAL_H5_RESIDENT_BUILD = (
    "phase3-minimal-h5-fresh-campaign-auto-benchmark"
)
EXPECTED_MINIMAL_H6_RESIDENT_VERSION = "0.11.174"
EXPECTED_MINIMAL_H6_RESIDENT_BUILD = (
    "phase3-minimal-h6-observer-complete-baseline-auto-benchmark"
)
EXPECTED_MINIMAL_H7_RESIDENT_VERSION = "0.11.175"
EXPECTED_MINIMAL_H7_RESIDENT_BUILD = (
    "phase3-minimal-h7-readonly-source-ondevice-evidence-auto-benchmark"
)
EXPECTED_MINIMAL_H8_RESIDENT_VERSION = "0.11.176"
EXPECTED_MINIMAL_H8_RESIDENT_BUILD = (
    "phase3-minimal-h8-dev-tmpfs-handoff-repair-auto-benchmark"
)
EXPECTED_MINIMAL_H9_RESIDENT_VERSION = "0.11.177"
EXPECTED_MINIMAL_H9_RESIDENT_BUILD = (
    "phase3-minimal-h9-fast-source-receipt-auto-benchmark"
)
EXPECTED_MINIMAL_H10_RESIDENT_VERSION = "0.11.178"
EXPECTED_MINIMAL_H10_RESIDENT_BUILD = (
    "phase3-minimal-h10-fast-source-receipt-auto-benchmark"
)
EXPECTED_MINIMAL_H11_RESIDENT_VERSION = "0.11.179"
EXPECTED_MINIMAL_H11_RESIDENT_BUILD = (
    "phase3-minimal-h11-direct-debian-boot-auto-benchmark"
)
EXPECTED_MINIMAL_H12_RESIDENT_VERSION = "0.11.180"
EXPECTED_MINIMAL_H12_RESIDENT_BUILD = (
    "phase3-minimal-h12-direct-min-network-wifi-auto-benchmark"
)
EXPECTED_MINIMAL_H13_RESIDENT_VERSION = "0.11.181"
EXPECTED_MINIMAL_H13_RESIDENT_BUILD = (
    "phase3-minimal-h13-direct-min-network-wifi-auto-benchmark"
)
EXPECTED_MINIMAL_H15_RESIDENT_VERSION = "0.11.183"
EXPECTED_MINIMAL_H15_RESIDENT_BUILD = (
...
ALLOWED_STARTING_IDENTITIES = {
    ...
    (EXPECTED_MINIMAL_F_RESIDENT_VERSION, EXPECTED_MINIMAL_F_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_G_RESIDENT_VERSION, EXPECTED_MINIMAL_G_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H2_RESIDENT_VERSION, EXPECTED_MINIMAL_H2_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H3_RESIDENT_VERSION, EXPECTED_MINIMAL_H3_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H4_RESIDENT_VERSION, EXPECTED_MINIMAL_H4_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H5_RESIDENT_VERSION, EXPECTED_MINIMAL_H5_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H6_RESIDENT_VERSION, EXPECTED_MINIMAL_H6_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H7_RESIDENT_VERSION, EXPECTED_MINIMAL_H7_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H8_RESIDENT_VERSION, EXPECTED_MINIMAL_H8_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H9_RESIDENT_VERSION, EXPECTED_MINIMAL_H9_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H10_RESIDENT_VERSION, EXPECTED_MINIMAL_H10_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H11_RESIDENT_VERSION, EXPECTED_MINIMAL_H11_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H12_RESIDENT_VERSION, EXPECTED_MINIMAL_H12_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H13_RESIDENT_VERSION, EXPECTED_MINIMAL_H13_RESIDENT_BUILD),
    (EXPECTED_MINIMAL_H15_RESIDENT_VERSION, EXPECTED_MINIMAL_H15_RESIDENT_BUILD),
}
