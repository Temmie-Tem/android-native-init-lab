...
H4_AUTO_BENCHMARK_RESIDENT_IDENTITY = (
    "0.11.172",
    "phase3-minimal-h4-observer-complete-auto-benchmark",
)
H5_AUTO_BENCHMARK_RESIDENT_IDENTITY = (
    "0.11.173",
