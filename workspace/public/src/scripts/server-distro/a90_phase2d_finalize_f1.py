...
MINIMAL_H7_CANDIDATE = CandidateSpec(
    ...
    copy_name="candidate-boot-phase3-minimal-h7.img",
    source=(
        staging.PRIVATE_ROOT
        / "outputs"
...
MINIMAL_H8_CANDIDATE = CandidateSpec(
    ...
    copy_name="candidate-boot-phase3-minimal-h8.img",
    source=(
        staging.PRIVATE_ROOT
        / "outputs"
...
MINIMAL_H9_CANDIDATE = CandidateSpec(
    ...
    copy_name="candidate-boot-phase3-minimal-h9.img",
    source=(
        staging.PRIVATE_ROOT
        / "outputs"
...
MINIMAL_H12_CANDIDATE = CandidateSpec(
    ...
    copy_name="candidate-boot-phase3-minimal-h12.img",
    source=(
        staging.PRIVATE_ROOT
        / "outputs"
    ...
    dict.fromkeys(
        (
            *staging.required_support_files(staging.PHASE3_PROFILE),
            ...
            REVAL_DIR
            / "a90_flat_builder/versions/phase3-minimal-h7/manifest.toml",
            REVAL_DIR
