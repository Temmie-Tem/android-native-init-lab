...
CANDIDATE_INIT_SHA256 = (
    "c53db468893bf9001e907ae6c35c8bbb7db82e260484b20abc4d146b64eca4fc"
)
CANDIDATE_RAMDISK_SIZE = 8537600
CANDIDATE_RAMDISK_SHA256 = (
    "280cd922c9a516a188683835f8d072736df5c13628c835bd38bf570875ea0601"
)
...
ENABLE_PATH = "/cache/a90-auto-handoff-phase3-minimal-h24.enable"
LATCH_PATH = "/cache/a90-auto-handoff-phase3-minimal-h24.done"
CONTENT_REL = (
...
HOST_QUALIFICATION_REL = (
    "workspace/public/src/scripts/revalidation/a90_flat_builder/versions/"
    "phase3-minimal-h24/capability-qualification.json"
)
HOST_REVIEW_REPORT_REL = (
    "docs/reports/A90_H24_MINIMAL_DEBIAN_DEV_INDEPENDENT_REVIEW_2026-08-12.json"
)
HOST_CAPABILITY_REVIEWER = (
    "/root/a90_h23_dev_isolation_review/a90_h24_clean_capability_review"
)
HOST_CAPABILITY_SCOPE = "h24-private-card-root-minimal-debian-dev-capability"
HOST_CAPABILITY_INCIDENT = "H23_DEBIAN_DEVTMPFS_EXPOSURE"
HOST_CAPABILITY_REQUIRED_INVARIANTS = (
    "automatic and manual UFS paths create a fresh minimal tmpfs Debian dev and never move native devtmpfs",
    "mandatory devpts and every minimal dev failure path restore mounts fail closed",
...
EXECUTION_REVIEW_SCOPE = (
    "h24-private-card-root-boot-only-f1-and-persistent-ufs-d1-execution-critical-closure"
)
EXECUTION_REVIEW_INCIDENT = "H23_DEBIAN_DEVTMPFS_EXPOSURE"
EXECUTION_REVIEW_REQUIRED_INVARIANTS = (
    "exact terminal H18 resident and D1 HEALTHY predecessor plus exact reviewed H24 A/B artifacts",
    "one boot-only H24 candidate or exact V2321 rollback transfer with no replay",
    ...
    "persistent result requires Debian PID1 authenticated SSH minimal Debian dev exact private-card-root HUD and final Wi-Fi",
    "immutable UFS firstboot pre-intent legacy HUD markers remain zero while exact post-intent status proves success",
