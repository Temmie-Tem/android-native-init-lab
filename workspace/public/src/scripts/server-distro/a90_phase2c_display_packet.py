...
from a90_observation_pipeline import (  # noqa: E402
...
def validate_machinery(contract: dict[str, Any]) -> dict[str, Any]:
    ...
    current_display_observation = (
        ...
        and "display.classify_phase2_display_facts(" in orchestrator
        and 'result["facts"] = display.facts_to_dict(facts)' in orchestrator
        and 'result["native_release_proven"]' in orchestrator
        and 'result["debian_pid1_proven"]' in orchestrator
