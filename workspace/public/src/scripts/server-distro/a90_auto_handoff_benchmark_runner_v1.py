...
The runner consumes an installed-resident D1 manifest.  It proves the H5
...
EXPECTED_VERSION = "0.11.173"
EXPECTED_BUILD = "phase3-minimal-h5-fresh-campaign-auto-benchmark"
