#!/usr/bin/env python3
"""Decode P2.90 adjacent-corridor pair-indexed retained positions."""
...
import s22plus_fyg8_p290_latest_stage_model as model


SCHEMA = "s22plus_fyg8_p290_e3_decoder_v1"
DECODER_ID = "s22plus_fyg8_p290_park_repair_positions_v1"
