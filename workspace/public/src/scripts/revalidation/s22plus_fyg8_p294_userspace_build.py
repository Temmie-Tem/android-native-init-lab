#!/usr/bin/env python3
"""Build the exact P2.94 userspace reproducibly."""
...
SCHEMA = "s22plus_fyg8_p294_userspace_build_v1"
VERDICT = p294.USERSPACE_VERDICT
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p294/userspace")
