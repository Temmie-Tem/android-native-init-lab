#!/usr/bin/env python3
"""Build one candidate-bound P2.98 FYG8 kernel host-only."""
...
SCHEMA = "s22plus_fyg8_p298_build_v1"
DEFAULT_RESULT_DIR = Path("workspace/private/outputs/s22plus_fyg8_p298/build-a")
...
P298_KERNEL_DEBUG_PATH_REPRODUCIBLE = base.P286_KERNEL_DEBUG_PATH_REPRODUCIBLE
P286_KERNEL_DEBUG_PATH_REPRODUCIBLE = P298_KERNEL_DEBUG_PATH_REPRODUCIBLE
...
def _configure() -> None:
    ...
    base.P286_KERNEL_DEBUG_PATH_REPRODUCIBLE = P298_KERNEL_DEBUG_PATH_REPRODUCIBLE
