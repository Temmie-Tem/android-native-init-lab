#!/usr/bin/env python3
"""Build V2939 native-init candidate with audible-safe playback route."""
...
CYCLE = "V2939"
INIT_VERSION = "0.10.46"
INIT_BUILD = "v2939-badapple-playback-route"
BUILD_TAG = INIT_BUILD
DECISION = "v2939-badapple-playback-route-source-build-pass"

OUT_DIR = workspace_private_build_path("native-init", BUILD_TAG)
REPORT_PATH = REPO_ROOT / "docs/reports/NATIVE_INIT_V2939_BADAPPLE_PLAYBACK_ROUTE_SOURCE_BUILD_2026-06-20.md"
BOOT_IMAGE = workspace_private_input_path("boot_images", "boot_linux_v2939_badapple_playback_route.img", legacy_fallback=False)
INIT_BINARY = OUT_DIR / "init_v2939_badapple_playback_route"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2939_badapple_playback_route.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v476_badapple_playback_route"

REQUIRED_STRINGS = (
    b"A90 Linux init 0.10.46 (v2939-badapple-playback-route)",
...
def require_strings(path: Path) -> list[str]:
    ...
    if missing:
        raise RuntimeError(f"missing V2939 boot-image markers: {missing}")
...
def main() -> int:
    ...
    manifest.update({
        ...
        "candidate_type": "badapple-playback-route-candidate",
        "parent_test_artifact": "v2938-audibility-route-snapshot",
        "badapple_player_hud": {
            "version": 1,
            "source_unit": "V2939",
            "parent_unit": "V2925",
    ...
    (OUT_DIR / "badapple-playback-route-candidate.json").write_text(json.dumps({
        "candidate_tag": INIT_BUILD,
        "candidate_type": "badapple-playback-route-candidate",
