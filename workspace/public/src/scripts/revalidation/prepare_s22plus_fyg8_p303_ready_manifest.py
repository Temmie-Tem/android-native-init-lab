#!/usr/bin/env python3
"""Create one verified Process-v2 ready manifest for P3.03."""
...
SCHEMA = "s22plus_fyg8_p303_ready_manifest_builder_v1"
VERDICT = "PASS_P303_PROCESS_V2_READY_MANIFEST_HOST_ONLY"
REHEARSAL_VERDICT = "PASS_P303_PROCESS_V2_READY_MANIFEST_REHEARSAL_HOST_ONLY"
...
DEFAULT_CANDIDATE_STATIC = Path(
    "workspace/private/device-action/s22plus_fyg8_p303_ready_1/"
...
DEFAULT_OUT = Path(
    ...
    "s22plus_fyg8_p303_process_v2_ready_1.json"
)
DEFAULT_TARGET_PROFILE = base.DEFAULT_TARGET_PROFILE
DEFAULT_MANIFEST_ID = "s22plus-fyg8-p303-campaign-1"
DEFAULT_LIVE_RUN_ID = "s22plus-fyg8-p303-attempt-1"
