#!/usr/bin/env python3
"""Decode P2.52 E2 records with exact SSUSB classifier semantics."""
...
import s22plus_fyg8_p248_e1_decoder as p248
import s22plus_fyg8_p252_contract_spec as spec


SCHEMA = "s22plus_fyg8_p252_e2_decoder_v1"
DECODER_ID = "s22plus_fyg8_p252_e2_ssusb_classifier_v1"
PROFILE = spec.PROFILE
STAGE_SEQUENCE = spec.STAGE_SEQUENCE
TERMINAL_STAGE = spec.TERMINAL_STAGE
POLICY_PREIMAGE = (
    "S22PLUS_FYG8_P252_E2_DECODER_V1|"
    "layout=S22E1L1-45-ab-crc32|"
    "unsat=S22E1U1-24|"
    "baseline=all-related-families-absent|"
    "accept=one-or-more-p252-e2-terminal-success|"
