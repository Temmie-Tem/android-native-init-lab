#!/usr/bin/env python3
"""Build one candidate-bound P2.96 FYG8 kernel host-only."""
...
SCHEMA = "s22plus_fyg8_p296_build_v1"
DEFAULT_RESULT_DIR = Path("workspace/private/outputs/s22plus_fyg8_p296/build-a")
...
P296_KERNEL_DEBUG_PATH_REPRODUCIBLE = base.P286_KERNEL_DEBUG_PATH_REPRODUCIBLE
P286_KERNEL_DEBUG_PATH_REPRODUCIBLE = P296_KERNEL_DEBUG_PATH_REPRODUCIBLE
QUALIFICATION_MODULES = {
    P296_SOURCE_CONTRACT_ID: (
        "s22plus_fyg8_p296_pre_lto_qualification",
        "p296_pre_lto_qualification",
        "P2.96",
    ),
}
...
def _configure() -> None:
    ...
    base.P286_KERNEL_DEBUG_PATH_REPRODUCIBLE = P296_KERNEL_DEBUG_PATH_REPRODUCIBLE
