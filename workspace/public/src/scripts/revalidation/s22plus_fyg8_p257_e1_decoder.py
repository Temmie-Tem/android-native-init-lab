#!/usr/bin/env python3
"""Decode P2.57 E2 records with display-closure classifier semantics."""
...
SCHEMA = "s22plus_fyg8_p257_e2_decoder_v1"
DECODER_ID = "s22plus_fyg8_p257_e2_display_closure_v1"
PROFILE = spec.PROFILE
STAGE_SEQUENCE = spec.STAGE_SEQUENCE
TERMINAL_STAGE = spec.TERMINAL_STAGE
POLICY_PREIMAGE = (
    "S22PLUS_FYG8_P257_E2_DECODER_V1|"
    "layout=S22E1L1-45-ab-crc32|"
    "unsat=S22E1U1-24|"
    "baseline=all-related-families-absent|"
    "accept=one-or-more-p257-e2-terminal-success|"
