#!/usr/bin/env python3
"""V2980 bounded live handoff for a human touch sample via readinput.

This runner reuses the V2977 inputscan candidate image. It flashes the candidate,
revalidates the selected event from the full ``inputscan`` output, runs one bounded
...
RUN_ID = "V2980"
BUILD_TAG = "v2980-readinput-touch-fullscan"
DECISION_PREFIX = "v2980-readinput"
REPORT_PATH = ROOT / "docs/reports/NATIVE_INIT_V2980_READINPUT_TOUCH_FULLSCAN_2026-06-20.md"
...
def run_cancellable_readinput(host: str,
    ...
    with SerialBridgeLock(timeout_sec=sample_timeout + cancel_timeout + connect_timeout, purpose="v2980-readinput"):
...
def render_report(result: dict[str, Any]) -> str:
    ...
    return "\n".join([
        "# Native Init V2980 Readinput Touch Fullscan Handoff",
        "",
        "## Summary",
        "",
