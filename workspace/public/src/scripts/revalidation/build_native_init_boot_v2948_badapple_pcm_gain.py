#!/usr/bin/env python3
"""Build V2948 native-init candidate with attenuation-only Bad Apple PCM gain."""
...
CYCLE = "V2948"
INIT_VERSION = "0.10.50"
INIT_BUILD = "v2948-badapple-pcm-gain"
BUILD_TAG = INIT_BUILD
DECISION = "v2948-badapple-pcm-gain-source-build-pass"

OUT_DIR = workspace_private_build_path("native-init", BUILD_TAG)
REPORT_PATH = REPO_ROOT / "docs/reports/NATIVE_INIT_V2948_BADAPPLE_PCM_GAIN_SOURCE_BUILD_2026-06-20.md"
BOOT_IMAGE = workspace_private_input_path("boot_images", "boot_linux_v2948_badapple_pcm_gain.img", legacy_fallback=False)
INIT_BINARY = OUT_DIR / "init_v2948_badapple_pcm_gain"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2948_badapple_pcm_gain.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v477_badapple_pcm_gain"

REQUIRED_STRINGS = (
    b"A90 Linux init 0.10.50 (v2948-badapple-pcm-gain)",
...
def require_strings(path: Path) -> list[str]:
    ...
    if missing:
        raise RuntimeError(f"missing V2948 boot-image markers: {missing}")
...
def main() -> int:
    ...
    manifest.update({
        ...
        "candidate_type": "badapple-pcm-gain-candidate",
        "parent_test_artifact": "v2947-badapple-fullsong-pcm64-live-pass",
        "badapple_player_hud": {
            "version": 1,
            "source_unit": "V2948",
            "parent_unit": "V2925",
    ...
    (OUT_DIR / "badapple-pcm-gain-candidate.json").write_text(json.dumps({
        "candidate_tag": INIT_BUILD,
        "candidate_type": "badapple-pcm-gain-candidate",
