#!/usr/bin/env python3
"""Promote one independently checked P3.02-M0 carrier into offline evidence."""
...
import s22plus_fyg8_p302_candidate_static_checker as static_checker


SCHEMA = "s22plus_fyg8_p302_process_v2_promotion_v1"
...
DEFAULT_CANDIDATE_AP = Path(
    "workspace/private/outputs/s22plus_fyg8_p302/"
    "candidate-a/odin4/AP.tar.md5"
)
DEFAULT_OUT = Path(
    "workspace/private/outputs/s22plus_fyg8_p302/process-v2"
)
