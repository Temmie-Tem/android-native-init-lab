#!/usr/bin/env python3
"""Build a P3.05 fixed-Image candidate with generic folded module tail."""
...
SCHEMA = "s22plus_fyg8_p305_candidate_artifact_result_v1"
VERDICT = "PASS_P305_DETERMINISTIC_BOOT_ONLY_CANDIDATE_HOST_ONLY"
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p305/candidate-a")
...
def verify_repro_result(*args, **kwargs):  # noqa: ANN002, ANN003, ANN201
    ...
    value["kernel_rebuilt_for_p305"] = False
    return value
...
def artifact_safety(exact_contract: dict) -> dict:
    ...
    result.update({
        "p305_kernel_rebuild": False,
        "p305_full_lto_ab": False,
        "folded_tail": exact_contract["folded_tail"],
    })
    return result
