#!/usr/bin/env python3
"""Promote one checked P3.03 HS-PHY candidate into offline Process-v2 evidence."""
...
import s22plus_fyg8_p303_candidate_static_checker as static_checker


SCHEMA = "s22plus_fyg8_p303_process_v2_promotion_v1"
...
DEFAULT_CANDIDATE_AP = Path(
    "workspace/private/outputs/s22plus_fyg8_p303/"
    "candidate-a/odin4/AP.tar.md5"
)
DEFAULT_OUT = Path(
    "workspace/private/outputs/s22plus_fyg8_p303/process-v2"
)
