#!/usr/bin/env python3
"""Build one candidate-bound P2.92 FYG8 kernel host-only."""
...
SCHEMA = "s22plus_fyg8_p292_build_v1"
DEFAULT_RESULT_DIR = Path(
    "workspace/private/outputs/s22plus_fyg8_p292/build-a"
)
...
P292_KERNEL_DEBUG_PATH_REPRODUCIBLE = (
...
QUALIFICATION_MODULES = {
    P292_SOURCE_CONTRACT_ID: (
        "s22plus_fyg8_p292_pre_lto_qualification",
        "p292_pre_lto_qualification",
        "P2.92",
    ),
}
