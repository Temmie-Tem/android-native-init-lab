#!/usr/bin/env python3
"""Build one candidate-bound P2.94 FYG8 kernel host-only."""
...
SCHEMA = "s22plus_fyg8_p294_build_v1"
DEFAULT_RESULT_DIR = Path("workspace/private/outputs/s22plus_fyg8_p294/build-a")
...
P294_KERNEL_DEBUG_PATH_REPRODUCIBLE = base.P286_KERNEL_DEBUG_PATH_REPRODUCIBLE
P286_KERNEL_DEBUG_PATH_REPRODUCIBLE = P294_KERNEL_DEBUG_PATH_REPRODUCIBLE
QUALIFICATION_MODULES = {
    P294_SOURCE_CONTRACT_ID: (
        "s22plus_fyg8_p294_pre_lto_qualification",
        "p294_pre_lto_qualification",
        "P2.94",
    ),
}
...
def _configure() -> None:
    ...
    base.P286_KERNEL_DEBUG_PATH_REPRODUCIBLE = P294_KERNEL_DEBUG_PATH_REPRODUCIBLE
