...
DEFAULT_RAMDISK_DIR = workspace_private_build_path("native-init", "v724", "ramdisk")
DEFAULT_RAMDISK_CPIO = workspace_private_build_path("native-init", "v724", "ramdisk.cpio")
DEFAULT_BOOT_IMAGE = workspace_private_input_path(
    "boot_images", "boot_linux_v724.img", legacy_fallback=False
)
