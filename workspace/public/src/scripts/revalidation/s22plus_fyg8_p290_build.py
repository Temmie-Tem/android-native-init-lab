#!/usr/bin/env python3
"""Build one candidate-bound P2.90 FYG8 kernel host-only."""
...
SCHEMA = "s22plus_fyg8_p290_build_v1"
DEFAULT_RESULT_DIR = Path(
    "workspace/private/outputs/s22plus_fyg8_p290/build-a"
)
...
P290_KERNEL_DEBUG_PATH_REPRODUCIBLE = (
    base.P286_KERNEL_DEBUG_PATH_REPRODUCIBLE
)
...
QUALIFICATION_MODULES = {
    P290_SOURCE_CONTRACT_ID: (
        "s22plus_fyg8_p290_pre_lto_qualification",
        "p290_pre_lto_qualification",
        "P2.90",
    ),
}
