#!/usr/bin/env python3
"""Promote one checked P3.04 notifier-bridge candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p304_candidate_static_checker as static_checker
import s22plus_fyg8_p304_e2_stock_closure as e2_closure_selector


SCHEMA = "s22plus_fyg8_p304_process_v2_promotion_v1"
VERDICT = base.VERDICT
TARGET = static_checker.TARGET
DEFAULT_STATIC = Path("workspace/private/outputs/s22plus_fyg8_p304/static-check-result.json")
DEFAULT_CANDIDATE_AP = Path(
    "workspace/private/outputs/s22plus_fyg8_p304/candidate-a/odin4/AP.tar.md5"
)
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p304/process-v2")
