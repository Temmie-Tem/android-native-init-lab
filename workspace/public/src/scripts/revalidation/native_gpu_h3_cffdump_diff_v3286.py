...
def current_h3_registers(dispatch: Path = DISPATCH) -> dict[str, int]:
    ...
    regs = {
        ...
        "VFD_FETCH_INSTR[0].INSTR": _vfd_fetch_instr(
            0,
            0,
            m("GPU_H3_A6XX_FMT6_32_32_FLOAT"),
            m("GPU_G4_A3XX_COLOR_SWAP_WZYX"),
        ),
        "VFD_FETCH_INSTR[0].STEP_RATE": 1,
        "VFD_DEST_CNTL[0].INSTR": _vfd_dest_instr(0, 0x3),
