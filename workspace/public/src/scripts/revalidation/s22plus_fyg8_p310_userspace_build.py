#!/usr/bin/env python3
"""Build the exact P3.10 userspace reproducibly."""
...
SCHEMA = "s22plus_fyg8_p310_userspace_build_v1"
VERDICT = p310.USERSPACE_VERDICT
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p310/userspace")
