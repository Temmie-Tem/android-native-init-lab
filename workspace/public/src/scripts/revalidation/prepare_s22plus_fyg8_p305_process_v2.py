#!/usr/bin/env python3
"""Promote one checked P3.05 folded-tail candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p305_candidate_static_checker as static_checker


SCHEMA = "s22plus_fyg8_p305_process_v2_promotion_v1"
VERDICT = base.VERDICT
TARGET = static_checker.TARGET
DEFAULT_STATIC = Path("workspace/private/outputs/s22plus_fyg8_p305/static-check-result-v2.json")
DEFAULT_CANDIDATE_AP = Path(
    "workspace/private/outputs/s22plus_fyg8_p305/candidate-a/odin4/AP.tar.md5"
)
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p305/process-v2")
...
_INDIRECT_MODULE_NAMES = (
    ...
    "build_s22plus_fyg8_p305_candidate",
