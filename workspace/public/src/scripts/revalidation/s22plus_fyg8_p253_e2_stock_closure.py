...
P258_CONTRACT_ID = "s22plus-fyg8-p258a-e2-exact-udc-membership-v1"
...
def select(source_contract_id: str | None):
    ...
    if source_contract_id == P257_CONTRACT_ID:
        ...
        return p257
    if source_contract_id == P258_CONTRACT_ID:
        import s22plus_fyg8_p258_e2_stock_closure as p258

        return p258
    if source_contract_id == P260_CONTRACT_ID:
        import s22plus_fyg8_p260_e2_stock_closure as p260

        return p260
    if source_contract_id == P280_CONTRACT_ID:
        import s22plus_fyg8_p280_e2_stock_closure as p280

        return p280
    if source_contract_id == P282_CONTRACT_ID:
