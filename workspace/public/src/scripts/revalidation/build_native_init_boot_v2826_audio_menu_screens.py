#!/usr/bin/env python3
"""Build V2826 native-init audio menu screens candidate."""
...
CYCLE = "V2826"
INIT_VERSION = "0.10.5"
INIT_BUILD = "v2826-audio-menu-screens"
...
REPORT_PATH = (
    ...
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2826_AUDIO_MENU_SCREENS_SOURCE_BUILD_2026-06-19.md"
)
BOOT_IMAGE = workspace_private_input_path(
    "boot_images", "boot_linux_v2826_audio_menu_screens.img", legacy_fallback=False
)
BASE_BOOT = v2807.BASE_BOOT
INIT_BINARY = OUT_DIR / "init_v2826_audio_menu_screens"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2826_audio_menu_screens.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v446_audio_menu_screens"


def configure_v2807_for_v2826() -> None:
    v2807.CYCLE = CYCLE
...
def rewrite_candidate_metadata() -> None:
    ...
    manifest.update({
        ...
        "parent_test_artifact": "v2824-audio-screenapp-map",
    ...
    (OUT_DIR / "audio-observability-candidate.json").write_text(json.dumps({
        ...
        "rollback_baseline": "v2321-usb-clean-identity-rodata",
        "adoption_state": "pending-live-validation",
        "note": "V2826 carries V2825 audio observability plus an APPS/AUDIO touch-menu page on a 0.10.5 candidate; live validation is required before adoption.",
    }, indent=2, sort_keys=True) + "\n", encoding="utf-8")


def main() -> int:
    configure_v2807_for_v2826()
