#!/usr/bin/env python3
"""Bounded P3.19 D0 V2 fresh-baseline producer.

The default mode is a zero-device H0 rehearsal.  The live branch is fixed to
one reviewed binding and one approval string; callers cannot select a target,
...
D1_SOURCE = SCRIPT_DIR / "s22plus_fyg8_p319_d1_fresh_baseline_v2.py"
D1_BINDING = ROOT / (
    "workspace/public/src/device-action/bindings/"
...
RUN_DIR = RUN_PARENT / "d0-p319-fresh-baseline-2"
...
D1_RUN_DIR = RUN_PARENT / "p319-fresh-baseline-2"
D1_RUN_ARM = RUN_PARENT / "p319-fresh-baseline-2.arm.json"
D1_RESULT = D1_RUN_DIR / "result.json"
D1_START = D1_RUN_DIR / "start.json"
USB_ROOT = Path("/sys/bus/usb/devices")

SCHEMA = "s22plus_fyg8_p319_d0_fresh_baseline_v2_result"
VERSION = "device-action-d0-p319-v2"
VERDICT = "PASS_P319_D0_FRESH_BASELINE_RAW_V2"
STOP_SCHEMA = "s22plus_fyg8_p319_d0_fresh_baseline_stop_v2"
STOP_VERDICT = "STOP_P319_D0_FRESH_BASELINE_V2_CONSUMED_NO_REPLAY"
...
BINDING_SCHEMA = "s22plus_fyg8_p319_d0_fresh_baseline_execution_binding_v2"
BINDING_ID = "s22plus-fyg8-p319-d0-fresh-baseline-v2"
AUTHORITY_PREFIX = "DEVICE-ACTION-D0-P319-FRESH-BASELINE-V2-APPROVE:"
REVIEW_VERDICT = "PASS_GO_P319_D0_FRESH_BASELINE_V2_H0_CAPABILITY_V1"
D1_BINDING_SUPERSEDED_SHA256 = (
...
def _baseline_design(
    ...
    return {
        "schema": "s22plus_fyg8_p319_fresh_baseline_design_v2",
        "design_id": "s22plus-fyg8-p319-fresh-baseline-design-v2",
        "target": TARGET,
...
def _arm_value(inputs: Mapping[str, Any]) -> dict[str, Any]:
    return {
        "schema": "s22plus_fyg8_p319_d0_fresh_baseline_arm_v2",
...
def _result_binding(inputs: Mapping[str, Any], d1: Mapping[str, Any], journal: Mapping[str, Any]) -> dict[str, Any]:
    return {
        "schema": "s22plus_fyg8_p319_d0_fresh_baseline_binding_v2",
        "action": inputs["manifest"]["action"],
...
def self_test() -> dict[str, Any]:
    ...
    return {
        "schema": "s22plus_fyg8_p319_d0_fresh_baseline_fixture_v2",
        ...
        "raw_bytes": RAW_SIZE,
        "d1_v2_result_present": D1_RESULT.exists() or D1_RESULT.is_symlink(),
