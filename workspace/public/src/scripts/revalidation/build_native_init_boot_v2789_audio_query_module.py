#!/usr/bin/env python3
"""Build V2789 native-init audio query module boot image.

V2789 splits read-only audio query commands into a dedicated module.
...
CYCLE = "V2789"
INIT_VERSION = "0.9.302"
INIT_BUILD = "v2789-audio-query-module"
BUILD_TAG = "v2789-audio-query-module"
...
REPORT_PATH = (
    ...
    / "docs"
    / "reports"
    / "NATIVE_INIT_V2789_AUDIO_QUERY_MODULE_SOURCE_BUILD_2026-06-19.md"
)
BOOT_IMAGE = workspace_private_input_path(
    "boot_images", "boot_linux_v2789_audio_query_module.img", legacy_fallback=False
)
BASE_BOOT = workspace_private_input_path(
    "boot_images", "boot_linux_v2334_audio_snd_nodes_preflight.img", legacy_fallback=False
)
INIT_BINARY = OUT_DIR / "init_v2789_audio_query_module"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2789_audio_query_module.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v444_audio_query_module"
...
def configure() -> tuple[str, ...]:
    ...
    replacements = {
        ...
        "--wifi-test-klog-prefix": "A90v2789",
        "--wifi-test-disable": "/cache/native-init-wifi-test-boot-v2789.disable",
        "--wifi-test-log": "/cache/native-init-wifi-test-boot-v2789.log",
        "--wifi-test-summary": "/cache/native-init-wifi-test-boot-v2789.summary",
        "--wifi-test-helper-result": "/cache/native-init-wifi-test-boot-v2789-helper.result",
        "--wifi-test-pid": "/cache/native-init-wifi-test-boot-v2789.pid",
        "--wifi-test-watcher-pid": "/cache/native-init-wifi-test-boot-v2789-supervisor.pid",
    }
...
def main() -> int:
    ...
    manifest.update({
        ...
        "parent_baseline": "v2788-audio-speaker-descriptor-api-device-pass",
        ...
        "audio_query_module_source_validation": {
            "query_module_compiled": True,
            ...
            "known_source_boundary": "read-only query command implementations are owned by a90_audio_query.{h,c}; profile data and lookup are owned by a90_audio_profile.{h,c}; route descriptors remain in a90_audio_route.{h,c}; execution and IO orchestration remain in a90_audio.c",
        },
    ...
    (OUT_DIR / "promotion-candidate.json").write_text(json.dumps({
        ...
        "rollback_baseline": "v2321-usb-clean-identity-rodata",
        "note": "V2789 is a test image for the audio query module split, not a promoted rollback baseline.",
