#!/usr/bin/env python3
"""Bind P3.15 semantics to the unchanged Carrier-v2 byte ABI."""
...
SCHEMA = "s22plus_fyg8_p315_carrier_model_v1"
...
@contextmanager
def _p315_semantics() -> Iterator[None]:
...
def apply_request(*args: Any, **kwargs: Any) -> bytes:
    ...
    if (
        ...
        raise carrier.DesignError("P3.15 legacy 0x6712 is decode-only")
