#!/usr/bin/env python3
"""Promote one checked P3.07 EUD/QSCRATCH candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p307_candidate_static_checker as static_checker


SCHEMA = "s22plus_fyg8_p307_process_v2_promotion_v1"
VERDICT = base.VERDICT
TARGET = static_checker.TARGET
DEFAULT_STATIC = Path(
    "workspace/private/outputs/s22plus_fyg8_p307/static-check-result.json"
)
DEFAULT_CANDIDATE_AP = Path(
    "workspace/private/outputs/s22plus_fyg8_p307/candidate-a/odin4/AP.tar.md5"
)
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p307/process-v2")
