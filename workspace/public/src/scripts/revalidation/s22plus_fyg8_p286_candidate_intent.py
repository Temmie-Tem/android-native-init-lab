...
import s22plus_fyg8_p286_source_contracts as source_contracts  # noqa: E402
import s22plus_fyg8_r4w1b_patch_check as source_base  # noqa: E402


SCHEMA = p286.INTENT_SCHEMA
PREIMAGE_SCHEMA = p286.PREIMAGE_SCHEMA
VERDICT = p286.INTENT_VERDICT
TARGET = p233.TARGET
PROFILE = "E1A"
PROFILE_NUMBER = decoder.model.PROFILE_NUMBERS[PROFILE]
RUN_ID_DOMAIN = p286.RUN_ID_DOMAIN
SUPPORTED_PROFILES = ("E1A", "E1B", "E2")
RUN_ID_DOMAINS = {
    "E1A": RUN_ID_DOMAIN,
    "E1B": b"S22PLUS-FYG8-P239-E1B-RUN-ID-V1\0",
    "E2": p286.RUN_ID_DOMAIN,
}
DEFAULT_SOURCE = p233.DEFAULT_SOURCE
DEFAULT_BASE_PATCH = p233.DEFAULT_PATCH
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p286/intent")
...
SUPERSEDED_FOR_NEW_CANDIDATES = {
    p282.CONTRACT_ID: p286.CONTRACT_ID,
    p284.CONTRACT_ID: p286.CONTRACT_ID,
}
