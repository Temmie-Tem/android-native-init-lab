#!/usr/bin/env python3
"""Promote one checked P3.08 loss-resistant candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p304_e2_stock_closure as e2_closure_selector
import s22plus_fyg8_p308_candidate_static_checker as static_checker


SCHEMA = "s22plus_fyg8_p308_process_v2_promotion_v1"
VERDICT = base.VERDICT
TARGET = static_checker.TARGET
DEFAULT_STATIC = Path(
    "workspace/private/outputs/s22plus_fyg8_p308/static-check-result.json"
)
DEFAULT_CANDIDATE_AP = Path(
    "workspace/private/outputs/s22plus_fyg8_p308/candidate-a/odin4/AP.tar.md5"
)
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p308/process-v2")
_CONFIGURATION_FIELDS = (
    "static_checker", "e2_closure_selector", "SCHEMA", "VERDICT", "TARGET",
    "DEFAULT_STATIC", "DEFAULT_CANDIDATE_AP", "DEFAULT_OUT",
)
_INDIRECT_MODULE_NAMES = (
    "build_s22plus_fyg8_p286_candidate",
    "build_s22plus_fyg8_p304_candidate",
    "build_s22plus_fyg8_p307_candidate",
    "build_s22plus_fyg8_p308_candidate",
    ...
    "s22plus_fyg8_p301_candidate_static_checker",
    "s22plus_fyg8_p303_candidate_static_checker",
    "s22plus_fyg8_p304_candidate_static_checker",
    "s22plus_fyg8_p305_candidate_static_checker",
    "s22plus_fyg8_p307_candidate_static_checker",
    "s22plus_fyg8_p308_candidate_static_checker",
)
...
def _snapshot_indirect_modules() -> dict[ModuleType, dict[str, Any]]:
    return {
        ...
        for module in (importlib.import_module(name) for name in _INDIRECT_MODULE_NAMES)
    }


def _restore_indirect_modules(snapshots: dict[ModuleType, dict[str, Any]]) -> None:
