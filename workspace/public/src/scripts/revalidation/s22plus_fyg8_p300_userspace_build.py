#!/usr/bin/env python3
"""Build the exact P3.00 userspace reproducibly."""
...
SCHEMA = "s22plus_fyg8_p300_userspace_build_v1"
VERDICT = p300.USERSPACE_VERDICT
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p300/userspace")
