#!/usr/bin/env python3
"""Verify one exact P2.90 candidate identity and patch."""
...
import s22plus_fyg8_p290_candidate_intent as intent
import s22plus_fyg8_p290_source_contract as p290


SCHEMA = p290.CONTRACT_SCHEMA
VERDICT = p290.CONTRACT_VERDICT
