#!/usr/bin/env python3
"""Promote one checked P3.15 candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p315_e2_stock_closure as e2_closure_selector
import s22plus_fyg8_p315_candidate_static_checker as static_checker


SCHEMA = "s22plus_fyg8_p315_process_v2_promotion_v1"
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p315/process-v2")
