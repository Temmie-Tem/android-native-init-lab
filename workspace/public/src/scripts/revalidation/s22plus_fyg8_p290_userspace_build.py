#!/usr/bin/env python3
"""Build the exact P2.90 userspace reproducibly."""
...
SCHEMA = "s22plus_fyg8_p290_userspace_build_v1"
VERDICT = p290.USERSPACE_VERDICT
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p290/userspace")
