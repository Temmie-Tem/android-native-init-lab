#!/usr/bin/env python3
"""Promote one independently checked P2.92 candidate into offline evidence."""
...
import s22plus_fyg8_p292_candidate_static_checker as static_checker
import s22plus_fyg8_p292_e2_stock_closure as e2_closure_selector


SCHEMA = "s22plus_fyg8_p292_process_v2_promotion_v1"
VERDICT = base.VERDICT
TARGET = static_checker.TARGET
DEFAULT_STATIC = Path(
    "workspace/private/outputs/s22plus_fyg8_p292/static-check-result.json"
)
...
DEFAULT_OUT = Path(
    "workspace/private/outputs/s22plus_fyg8_p292/process-v2"
)
