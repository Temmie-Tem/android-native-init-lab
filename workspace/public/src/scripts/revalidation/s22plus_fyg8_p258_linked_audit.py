#!/usr/bin/env python3
"""CFG-aware linked audit adapter for the P2.58A source contract."""
...
TARGET = repro.TARGET
ADAPTER_ID = "s22plus-fyg8-p258-linked-audit-v1"
EXPECTED_SOURCE_CONTRACT_ID = p258.CONTRACT_ID
...
def check(args) -> dict[str, Any]:
    ...
    if (
        ...
        raise AuditError("P2.58A linked validator adapter was not applied")
    return result
