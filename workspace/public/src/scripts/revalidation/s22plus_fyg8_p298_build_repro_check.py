#!/usr/bin/env python3
"""Verify P2.98 Full-LTO A/B with the inherited path-leak gate."""
...
import s22plus_fyg8_p298_linked_audit as linked_audit
import s22plus_fyg8_p298_source_contract as p298


SCHEMA = "s22plus_fyg8_p298_build_repro_check_v1"
VERDICT = "PASS_P298_TWO_CLEAN_BUILD_REPRO_AND_LINKED_AUDIT_HOST_ONLY"
PATH_GATE_SCHEMA = "s22plus_fyg8_p298_full_lto_a_path_gate_v1"
PATH_GATE_VERDICT = "PASS_P298_FULL_LTO_A_PATH_LEAK_GATE_HOST_ONLY"
TARGET = candidate_contract.TARGET
P298_SOURCE_CONTRACT_ID = p298.CONTRACT_ID
P286_SOURCE_CONTRACT_ID = P298_SOURCE_CONTRACT_ID
P298_QUALIFICATION_MODULE = "s22plus_fyg8_p298_pre_lto_qualification"
P298_QUALIFICATION_PROVENANCE_KEY = "p298_pre_lto_qualification"
P286_QUALIFICATION_MODULE = P298_QUALIFICATION_MODULE
P286_QUALIFICATION_PROVENANCE_KEY = P298_QUALIFICATION_PROVENANCE_KEY
DEFAULT_BUILD_A = Path("workspace/private/outputs/s22plus_fyg8_p298/artifacts-a")
DEFAULT_BUILD_B = Path("workspace/private/outputs/s22plus_fyg8_p298/artifacts-b")
...
LINKED_VALIDATOR_ADAPTERS = {
    **base.LINKED_VALIDATOR_ADAPTERS,
    P298_SOURCE_CONTRACT_ID: "s22plus_fyg8_p298_postbuild_linked_audit",
}
...
def _configure() -> None:
    ...
    base.TARGET = TARGET
    base.P290_SOURCE_CONTRACT_ID = P298_SOURCE_CONTRACT_ID
    base.P286_SOURCE_CONTRACT_ID = P298_SOURCE_CONTRACT_ID
    base.P290_QUALIFICATION_MODULE = P298_QUALIFICATION_MODULE
    base.P290_QUALIFICATION_PROVENANCE_KEY = P298_QUALIFICATION_PROVENANCE_KEY
    base.P286_QUALIFICATION_MODULE = P298_QUALIFICATION_MODULE
    base.P286_QUALIFICATION_PROVENANCE_KEY = P298_QUALIFICATION_PROVENANCE_KEY
...
def verify_p298_qualification_file(*args, **kwargs):  # noqa: ANN002, ANN003, ANN201
    _configure()
