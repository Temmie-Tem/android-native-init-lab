#!/usr/bin/env python3
"""Create one verified Process-v2 ready manifest for P3.06."""
...
SCHEMA = "s22plus_fyg8_p306_ready_manifest_builder_v1"
VERDICT = "PASS_P306_PROCESS_V2_READY_MANIFEST_HOST_ONLY"
REHEARSAL_VERDICT = "PASS_P306_PROCESS_V2_READY_MANIFEST_REHEARSAL_HOST_ONLY"
...
DEFAULT_CANDIDATE_STATIC = Path(
    "workspace/private/device-action/s22plus_fyg8_p306_ready_1/evidence/candidate-static.json"
)
DEFAULT_RUN_MANIFEST = Path(
    "workspace/private/device-action/s22plus_fyg8_p306_ready_1/evidence/run-manifest.json"
)
DEFAULT_STATIC_CHECK = Path(
    "workspace/private/device-action/s22plus_fyg8_p306_ready_1/evidence/static-check-result.json"
)
DEFAULT_CANDIDATE_AP = Path(
    "workspace/private/device-action/s22plus_fyg8_p306_ready_1/candidate/AP.tar.md5"
)
DEFAULT_ROLLBACK_AP = base.DEFAULT_ROLLBACK_AP
DEFAULT_OUT = Path(
    "workspace/public/src/device-action/manifests/s22plus_fyg8_p306_process_v2_ready_1.json"
)
DEFAULT_TARGET_PROFILE = base.DEFAULT_TARGET_PROFILE
DEFAULT_MANIFEST_ID = "s22plus-fyg8-p306-campaign-1"
DEFAULT_LIVE_RUN_ID = "s22plus-fyg8-p306-attempt-1"
