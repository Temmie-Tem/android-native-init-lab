#!/usr/bin/env python3
"""P2.96 stock-closure adapter over the unchanged P2.86 authority."""
...
import s22plus_fyg8_p296_source_contract as source_contract
import s22plus_fyg8_p296_telemetry_spec as spec


SCHEMA = "s22plus_fyg8_p296_stock_closure_h0_v1"
VERDICT = "PASS_P296_STOCK_CLOSURE_HOST_ONLY"
...
def _validate_p296_authority_strings(data: bytes) -> None:
    p286._validate_p286_authority_strings(data)


_validate_p286_authority_strings = _validate_p296_authority_strings
_validate_p282_authority_strings = _validate_p296_authority_strings
