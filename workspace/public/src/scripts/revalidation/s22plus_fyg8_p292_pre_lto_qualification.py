#!/usr/bin/env python3
"""Pre-Full-LTO qualification for the P2.92 checkpoint repair."""
...
import build_s22plus_fyg8_p292_candidate as candidate_builder
...
import s22plus_fyg8_p292_e2_stock_closure as closure
import s22plus_fyg8_p292_source_contract as p292
import s22plus_fyg8_p292_userspace_build as userspace


p286 = p292
SCHEMA = "s22plus_fyg8_p292_pre_lto_qualification_v1"
VERDICT = "PASS_P292_PRE_FULL_LTO_QUALIFICATION_HOST_ONLY"
LINKED_META_SCHEMA = "s22plus_fyg8_p292_linked_audit_meta_v1"
LINKED_META_VERDICT = "PASS_P292_LINKED_AUDIT_META_HOST_ONLY"
LINKED_AUDIT_MODULE_NAME = "s22plus_fyg8_p292_linked_audit"
LINKED_AUDIT_TEST = Path("tests/test_s22plus_fyg8_p292_contract.py")
...
FOCUSED_TESTS = (
    *tuple(
    ...
    Path("tests/test_s22plus_fyg8_p292_contract.py"),
    Path(
        "workspace/public/src/scripts/revalidation/"
...
P292_GATE_NAME = "21-resumable-checkpoint-state-and-errno"
GATE_IMPLEMENTATION_SOURCES = {
    **base.GATE_IMPLEMENTATION_SOURCES,
    "closure": (
        base.inherited.base.base.SCRIPT_DIR
        / "s22plus_fyg8_p292_e2_stock_closure.py"
    ),
    "p292_qualification": Path(__file__).resolve(),
    "p292_source_contract": (
        base.inherited.base.base.SCRIPT_DIR
    ...
    "p292_candidate_builder": (
        base.inherited.base.base.SCRIPT_DIR
        / "build_s22plus_fyg8_p292_candidate.py"
    ),
    "p292_userspace_builder": (
        base.inherited.base.base.SCRIPT_DIR
...
class _QualificationSourceContractAdapter:
    DEFAULT_DWC3_MSM_MODULE = (
        base.QUALIFICATION_SOURCE_CONTRACT.DEFAULT_DWC3_MSM_MODULE
    )
    DEFAULT_HSPHY_MODULE = (
        base.QUALIFICATION_SOURCE_CONTRACT.DEFAULT_HSPHY_MODULE
    )

    def __getattr__(self, name: str):
        return getattr(p292, name)
...
def _load_linked_audit_module():
    try:
        ...
        raise QualificationError(
            "P2.92 linked-audit module is unavailable"
        ) from exc
    if (
        ...
        raise QualificationError("P2.92 linked-audit identity drifted")
    return module
...
def _configure() -> None:
    ...
    base.P290_GATE_NAME = P292_GATE_NAME
