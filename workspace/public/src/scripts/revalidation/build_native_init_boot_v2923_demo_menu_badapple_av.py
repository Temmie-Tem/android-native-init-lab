#!/usr/bin/env python3
"""Build V2923 native-init candidate with the DEMO > Bad Apple A/V menu entry."""
...
CYCLE = "V2923"
INIT_VERSION = "0.10.40"
INIT_BUILD = "v2923-demo-menu-badapple-av"
BUILD_TAG = INIT_BUILD
DECISION = "v2923-demo-menu-badapple-av-source-build-pass"

OUT_DIR = workspace_private_build_path("native-init", BUILD_TAG)
REPORT_PATH = REPO_ROOT / "docs/reports/NATIVE_INIT_V2923_DEMO_MENU_BADAPPLE_AV_SOURCE_BUILD_2026-06-20.md"
BOOT_IMAGE = workspace_private_input_path("boot_images", "boot_linux_v2923_demo_menu_badapple_av.img", legacy_fallback=False)
INIT_BINARY = OUT_DIR / "init_v2923_demo_menu_badapple_av"
RAMDISK_CPIO = OUT_DIR / "ramdisk_v2923_demo_menu_badapple_av.cpio"
HELPER_BINARY = OUT_DIR / "a90_android_execns_probe_v468_demo_menu_badapple_av"

REQUIRED_STRINGS = (
    b"A90 Linux init 0.10.40 (v2923-demo-menu-badapple-av)",
...
def main() -> int:
    ...
    manifest.update({
        ...
        "candidate_type": "demo-menu-badapple-av-candidate",
        "parent_test_artifact": "v2922-demo-menu-badapple-flash-live",
        "badapple_player_hud": {
            "version": 1,
            "source_unit": "V2923",
            "parent_unit": "V2922",
            ...
            "commands": [
                ...
                "DEMO > BAD APPLE HUD A/V menu preview: audio play --pcm-file /cache/a90-runtime/pkg/av/v2920/audio/badapple.s16le --duration-ms 4000 --execute; video demo badapple play --trust-cache --frames 120 --present pageflip --layout player-hud --sync-audio-status /cache/a90-audio-play/status.txt",
            ],
    ...
    (OUT_DIR / "demo-menu-badapple-av-candidate.json").write_text(json.dumps({
        "candidate_tag": INIT_BUILD,
        "candidate_type": "demo-menu-badapple-av-candidate",
