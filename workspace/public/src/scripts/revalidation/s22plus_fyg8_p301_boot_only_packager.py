#!/usr/bin/env python3
"""Deterministic boot-only packaging primitive for P3.01."""
...
SCHEMA = "s22plus_fyg8_p301_boot_only_package_v1"
VERDICT = "PASS_P301_DETERMINISTIC_BOOT_ONLY_PACKAGE_HOST_ONLY"
