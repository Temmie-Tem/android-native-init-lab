#!/usr/bin/env python3
"""Promote one checked P3.10 Carrier v2 candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p310_candidate_static_checker as static_checker
import s22plus_fyg8_p310_e2_stock_closure as e2_closure_selector


SCHEMA = "s22plus_fyg8_p310_process_v2_promotion_v1"
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p310/process-v2")
