#!/usr/bin/env python3
"""Build the exact P2.92 userspace reproducibly."""
...
SCHEMA = "s22plus_fyg8_p292_userspace_build_v1"
VERDICT = p292.USERSPACE_VERDICT
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p292/userspace")
