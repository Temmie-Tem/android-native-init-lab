#!/usr/bin/env python3
"""Build a P3.08 fixed-Image candidate with loss-resistant telemetry."""
...
SCHEMA = "s22plus_fyg8_p308_candidate_artifact_result_v1"
VERDICT = "PASS_P308_DETERMINISTIC_BOOT_ONLY_CANDIDATE_HOST_ONLY"
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p308/candidate-a")
...
def verify_repro_result(*args, **kwargs):  # noqa: ANN002, ANN003, ANN201
    ...
    value["kernel_rebuilt_for_p308"] = False
    return value
...
def artifact_safety(exact_contract: dict) -> dict:
    ...
    result.update({
        "p308_kernel_rebuild": False,
        "p308_full_lto_ab": False,
        "p308_observer": exact_contract["observer"],
        "p308_cross_gate_audit": exact_contract["cross_gate_audit"],
