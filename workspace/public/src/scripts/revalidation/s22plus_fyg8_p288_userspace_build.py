#!/usr/bin/env python3
"""Build the exact P2.88 candidate userspace reproducibly."""
...
SCHEMA = "s22plus_fyg8_p288_userspace_build_v1"
VERDICT = p288.USERSPACE_VERDICT
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p288/userspace")
