#!/usr/bin/env python3
"""Verify one exact P2.94 candidate identity and patch."""
...
import s22plus_fyg8_p294_candidate_intent as intent
import s22plus_fyg8_p294_source_contract as p294


SCHEMA = p294.CONTRACT_SCHEMA
VERDICT = p294.CONTRACT_VERDICT
