#!/usr/bin/env python3
"""Verify one exact P3.00 candidate identity and patch."""
...
SCHEMA = p300.CONTRACT_SCHEMA
VERDICT = p300.CONTRACT_VERDICT
...
def _configure() -> None:
    ...
    # exact P3.00 selector for reopen/build verification; the original
