...
import s22plus_fyg8_p286_candidate_intent as intent  # noqa: E402
import s22plus_fyg8_p286_source_contract as p286  # noqa: E402


SCHEMA = p286.CONTRACT_SCHEMA
VERDICT = p286.CONTRACT_VERDICT
...
def verify(
    ...
    intent_bytes = stable_read(intent_path, "P2.86 candidate intent")
    patch = stable_read(patch_path, "P2.86 candidate patch")
    try:
