#!/usr/bin/env python3
"""Promote one checked P3.17 candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p317_e2_stock_closure as e2_closure_selector


SCHEMA = "s22plus_fyg8_p317_process_v2_promotion_v1"
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p317/process-v2")
