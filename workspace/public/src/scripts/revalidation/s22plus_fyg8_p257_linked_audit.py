#!/usr/bin/env python3
"""CFG-aware linked audit adapter for the P2.57 source contract."""
...
TARGET = repro.TARGET
ADAPTER_ID = "s22plus-fyg8-p257-linked-audit-v1"
EXPECTED_SOURCE_CONTRACT_ID = p257.CONTRACT_ID
...
def check(args) -> dict[str, Any]:
    ...
    if (
        ...
        raise AuditError("P2.57 linked validator adapter was not applied")
    return result
