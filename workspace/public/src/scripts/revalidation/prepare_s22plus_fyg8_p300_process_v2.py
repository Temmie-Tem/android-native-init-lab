#!/usr/bin/env python3
"""Promote one independently checked P3.00 candidate into offline evidence."""
...
import s22plus_fyg8_p300_candidate_static_checker as static_checker
import s22plus_fyg8_p300_e2_stock_closure as e2_closure_selector


SCHEMA = "s22plus_fyg8_p300_process_v2_promotion_v1"
...
DEFAULT_OUT = Path(
    "workspace/private/outputs/s22plus_fyg8_p300/process-v2"
)
