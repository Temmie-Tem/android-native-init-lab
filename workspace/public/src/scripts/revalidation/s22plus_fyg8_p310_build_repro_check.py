#!/usr/bin/env python3
"""Verify P3.10 Full-LTO A/B and linked Carrier v2 closure."""
...
import s22plus_fyg8_p310_build as build
import s22plus_fyg8_p310_candidate_contract as candidate_contract
import s22plus_fyg8_p310_linked_audit as linked_audit
import s22plus_fyg8_p310_source_contract as p310


SCHEMA = "s22plus_fyg8_p310_build_repro_check_v1"
VERDICT = "PASS_P310_TWO_CLEAN_BUILD_REPRO_AND_LINKED_AUDIT_HOST_ONLY"
PATH_GATE_SCHEMA = "s22plus_fyg8_p310_full_lto_a_path_gate_v1"
PATH_GATE_VERDICT = "PASS_P310_FULL_LTO_A_PATH_LEAK_GATE_HOST_ONLY"
TARGET = candidate_contract.TARGET
P310_SOURCE_CONTRACT_ID = p310.CONTRACT_ID
P286_SOURCE_CONTRACT_ID = P310_SOURCE_CONTRACT_ID
P310_QUALIFICATION_MODULE = "s22plus_fyg8_p310_pre_lto_qualification"
P310_QUALIFICATION_PROVENANCE_KEY = "p310_pre_lto_qualification"
P286_QUALIFICATION_MODULE = P310_QUALIFICATION_MODULE
P286_QUALIFICATION_PROVENANCE_KEY = P310_QUALIFICATION_PROVENANCE_KEY
DEFAULT_BUILD_A = Path("workspace/private/outputs/s22plus_fyg8_p310/artifacts-a")
DEFAULT_BUILD_B = Path("workspace/private/outputs/s22plus_fyg8_p310/artifacts-b")
...
LINKED_VALIDATOR_ADAPTERS = {
    **base.LINKED_VALIDATOR_ADAPTERS,
    P310_SOURCE_CONTRACT_ID: "s22plus_fyg8_p310_postbuild_linked_audit",
}
...
def _configure() -> None:
    ...
    base.TARGET = TARGET
    base.P290_SOURCE_CONTRACT_ID = P310_SOURCE_CONTRACT_ID
    base.P286_SOURCE_CONTRACT_ID = P310_SOURCE_CONTRACT_ID
    base.P290_QUALIFICATION_MODULE = P310_QUALIFICATION_MODULE
    base.P290_QUALIFICATION_PROVENANCE_KEY = P310_QUALIFICATION_PROVENANCE_KEY
    base.P286_QUALIFICATION_MODULE = P310_QUALIFICATION_MODULE
    base.P286_QUALIFICATION_PROVENANCE_KEY = P310_QUALIFICATION_PROVENANCE_KEY
...
def verify_p310_qualification_file(*args, **kwargs):  # noqa: ANN002, ANN003, ANN201
    _configure()
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(json.dumps({"schema": PATH_GATE_SCHEMA if args.a_only_path_leak_gate else SCHEMA, "verdict": "FAIL_CLOSED", "error": str(exc)}, sort_keys=True))
        return 1
