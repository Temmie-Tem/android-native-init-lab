#!/usr/bin/env python3
"""P2.84 stock-closure adapter over the unchanged P2.82 module plan."""
...
import s22plus_fyg8_p284_source_contract as source_contract


SCHEMA = "s22plus_fyg8_p284_stock_closure_h0_v1"
VERDICT = "PASS_P284_STOCK_CLOSURE_HOST_ONLY"
...
def _validate_p284_authority_strings(data: bytes) -> None:
    p282._validate_p282_authority_strings(data)


_validate_p282_authority_strings = _validate_p284_authority_strings
