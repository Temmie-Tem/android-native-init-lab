#!/usr/bin/env python3
"""Promote one checked P3.13 candidate into Process-v2 evidence."""
...
import s22plus_fyg8_p313_candidate_static_checker as static_checker
import s22plus_fyg8_p313_e2_stock_closure as e2_closure_selector


SCHEMA = "s22plus_fyg8_p313_process_v2_promotion_v1"
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p313/process-v2")
