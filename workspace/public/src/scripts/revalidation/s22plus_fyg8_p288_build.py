#!/usr/bin/env python3
"""Build one candidate-bound P2.88 FYG8 kernel host-only."""
...
SCHEMA = "s22plus_fyg8_p288_build_v1"
DEFAULT_RESULT_DIR = Path(
    "workspace/private/outputs/s22plus_fyg8_p288/build-a"
)
...
P288_KERNEL_DEBUG_PATH_REPRODUCIBLE = (
...
QUALIFICATION_MODULES = {
    P288_SOURCE_CONTRACT_ID: (
        "s22plus_fyg8_p288_pre_lto_qualification",
        "p288_pre_lto_qualification",
        "P2.88",
    ),
}
