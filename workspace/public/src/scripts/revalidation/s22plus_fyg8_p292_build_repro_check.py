#!/usr/bin/env python3
"""Verify P2.92 Full-LTO A/B with the inherited path-leak gate."""
...
import s22plus_fyg8_p292_build as build
import s22plus_fyg8_p292_candidate_contract as candidate_contract
import s22plus_fyg8_p292_source_contract as p292


SCHEMA = "s22plus_fyg8_p292_build_repro_check_v1"
VERDICT = "PASS_P292_TWO_CLEAN_BUILD_REPRO_AND_LINKED_AUDIT_HOST_ONLY"
PATH_GATE_SCHEMA = "s22plus_fyg8_p292_full_lto_a_path_gate_v1"
PATH_GATE_VERDICT = "PASS_P292_FULL_LTO_A_PATH_LEAK_GATE_HOST_ONLY"
TARGET = candidate_contract.TARGET
P292_SOURCE_CONTRACT_ID = p292.CONTRACT_ID
P286_SOURCE_CONTRACT_ID = P292_SOURCE_CONTRACT_ID
P292_QUALIFICATION_MODULE = "s22plus_fyg8_p292_pre_lto_qualification"
P292_QUALIFICATION_PROVENANCE_KEY = "p292_pre_lto_qualification"
P286_QUALIFICATION_MODULE = P292_QUALIFICATION_MODULE
P286_QUALIFICATION_PROVENANCE_KEY = P292_QUALIFICATION_PROVENANCE_KEY
DEFAULT_BUILD_A = Path(
    "workspace/private/outputs/s22plus_fyg8_p292/artifacts-a"
)
DEFAULT_BUILD_B = Path(
    "workspace/private/outputs/s22plus_fyg8_p292/artifacts-b"
)
...
LINKED_VALIDATOR_ADAPTERS = {
    **base.LINKED_VALIDATOR_ADAPTERS,
    P292_SOURCE_CONTRACT_ID: "s22plus_fyg8_p292_postbuild_linked_audit",
}
...
def _configure() -> None:
    ...
    base.TARGET = TARGET
    base.P290_SOURCE_CONTRACT_ID = P292_SOURCE_CONTRACT_ID
    base.P286_SOURCE_CONTRACT_ID = P292_SOURCE_CONTRACT_ID
    base.P290_QUALIFICATION_MODULE = P292_QUALIFICATION_MODULE
    base.P290_QUALIFICATION_PROVENANCE_KEY = (
        P292_QUALIFICATION_PROVENANCE_KEY
    )
    base.P286_QUALIFICATION_MODULE = P292_QUALIFICATION_MODULE
...
def verify_p292_qualification_file(*args, **kwargs):  # noqa: ANN002, ANN003, ANN201
