#!/usr/bin/env python3
"""Verify P2.94 Full-LTO A/B with the inherited path-leak gate."""
...
VERDICT = "PASS_P294_TWO_CLEAN_BUILD_REPRO_AND_LINKED_AUDIT_HOST_ONLY"
PATH_GATE_SCHEMA = "s22plus_fyg8_p294_full_lto_a_path_gate_v1"
PATH_GATE_VERDICT = "PASS_P294_FULL_LTO_A_PATH_LEAK_GATE_HOST_ONLY"
TARGET = candidate_contract.TARGET
P294_SOURCE_CONTRACT_ID = p294.CONTRACT_ID
P286_SOURCE_CONTRACT_ID = P294_SOURCE_CONTRACT_ID
P294_QUALIFICATION_MODULE = "s22plus_fyg8_p294_pre_lto_qualification"
P294_QUALIFICATION_PROVENANCE_KEY = "p294_pre_lto_qualification"
P286_QUALIFICATION_MODULE = P294_QUALIFICATION_MODULE
P286_QUALIFICATION_PROVENANCE_KEY = P294_QUALIFICATION_PROVENANCE_KEY
DEFAULT_BUILD_A = Path("workspace/private/outputs/s22plus_fyg8_p294/artifacts-a")
DEFAULT_BUILD_B = Path("workspace/private/outputs/s22plus_fyg8_p294/artifacts-b")
...
def _configure() -> None:
    ...
    base.TARGET = TARGET
    base.P290_SOURCE_CONTRACT_ID = P294_SOURCE_CONTRACT_ID
    base.P286_SOURCE_CONTRACT_ID = P294_SOURCE_CONTRACT_ID
    base.P290_QUALIFICATION_MODULE = P294_QUALIFICATION_MODULE
    base.P290_QUALIFICATION_PROVENANCE_KEY = P294_QUALIFICATION_PROVENANCE_KEY
    base.P286_QUALIFICATION_MODULE = P294_QUALIFICATION_MODULE
    base.P286_QUALIFICATION_PROVENANCE_KEY = P294_QUALIFICATION_PROVENANCE_KEY
