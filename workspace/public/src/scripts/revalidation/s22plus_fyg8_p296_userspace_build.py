#!/usr/bin/env python3
"""Build the exact P2.96 userspace reproducibly."""
...
SCHEMA = "s22plus_fyg8_p296_userspace_build_v1"
VERDICT = p296.USERSPACE_VERDICT
...
DEFAULT_OUT = Path("workspace/private/outputs/s22plus_fyg8_p296/userspace")
