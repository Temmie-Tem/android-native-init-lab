...
RESEARCH_PROFILES = {
    ...
    'thermal-v3-reconnect-ufs-drain-v1': (drain_source, thermal_observer_v3.Observer,
        ('qcom-vadc-common.ko', 'qcom-spmi-adc5.ko', 's22plus_thermal_telemetry.ko')),
    'thermal-v3-reconnect-ufs-drain-gpt-v1': (gpt_source, thermal_observer_v3.Observer,
        ('qcom-vadc-common.ko', 'qcom-spmi-adc5.ko', 's22plus_thermal_telemetry.ko')),
}
...
def research_profile(declared):
    ...
    if getattr(declared,'GPT_PROFILE',None) is not None:
        if (declared.GPT_PROFILE==gpt_source.GPT_PROFILE
            ...
            return 'thermal-v3-reconnect-ufs-drain-gpt-v1'
        raise ValueError('unreviewed GPT composition')
