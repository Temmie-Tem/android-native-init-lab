#!/usr/bin/env python3
"""Verify one exact P2.92 candidate identity and patch."""
...
import s22plus_fyg8_p292_candidate_intent as intent
import s22plus_fyg8_p292_source_contract as p292


SCHEMA = p292.CONTRACT_SCHEMA
VERDICT = p292.CONTRACT_VERDICT
