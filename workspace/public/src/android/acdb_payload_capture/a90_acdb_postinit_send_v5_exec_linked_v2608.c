/*
 * V2608 ARM32 own-process ACDB post-init send_audio_cal_v5 driver.
 *
 ...
 * helper then arms capture only after init_v3 returns and calls
 * acdb_loader_send_audio_cal_v5() outside the init-time hook/mutex window.
 */
...
#define A90_EVENTS_PATH "/data/local/tmp/a90-acdb-ownget/acdb-v2608-postinit-send-v5-events.jsonl"
